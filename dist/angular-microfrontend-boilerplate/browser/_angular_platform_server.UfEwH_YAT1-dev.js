import { __async } from "@nf-internal/chunk-3QVZCVE3";
...
function requireFilteredElementList() {
    if (hasRequiredFilteredElementList)
...
function requireNonDocumentTypeChildNode() {
    if (hasRequiredNonDocumentTypeChildNode)
...
function requireDocumentFragment() {
    if (hasRequiredDocumentFragment)
...
function requireProcessingInstruction() {
    if (hasRequiredProcessingInstruction)
...
function requireCSSStyleDeclaration() {
    if (hasRequiredCSSStyleDeclaration)
...
function requireMutationConstants() {
    if (hasRequiredMutationConstants)
            ...
            switch (t) {
                ...
                case 3:
                    switch (value) {
                        ...
                        case "h5":
                        case "h6":
                            if (!stack.elementTypeInScope(impl2.HTMLHeadingElement))
                                return;
                            stack.generateImpliedEndTags();
...
function requireDOMImplementation() {
    if (hasRequiredDOMImplementation)
...
var DominoAdapter = class _DominoAdapter extends _BrowserDomAdapter {
    static makeCurrent() {
        setDomTypes();
...
var ServerXhr = class _ServerXhr {
    ...
    \u0275loadImpl() {
        return __async(this, null, function* () {
            if (!this.xhrImpl) {
                const { default: xhr } = yield import("@nf-internal/xhr2-6R4TS5IX");
                this.xhrImpl = xhr;
            }
        });
    }
...
var SERVER_CONTEXT = new InjectionToken2("SERVER_CONTEXT");
...
function renderApplication(bootstrap, options) {
    return __async(this, null, function* () {
        ...
        _startMeasuring2(renderAppLabel);
        const platformRef = createServerPlatform(options);
        try {
            _startMeasuring2(bootstrapLabel);
            const applicationRef = yield bootstrap({ platformRef });
            _stopMeasuring2(bootstrapLabel);
            _startMeasuring2(_renderLabel);
            const measuringLabel = "whenStable";
            _startMeasuring2(measuringLabel);
            yield applicationRef.whenStable();
            _stopMeasuring2(measuringLabel);
            const rendered = yield renderInternal(platformRef, applicationRef);
            _stopMeasuring2(_renderLabel);
            return rendered;
        }
        finally {
            yield asyncDestroyPlatform(platformRef);
            _stopMeasuring2(renderAppLabel);
        }
    });
}
...
@angular/platform-server/fesm2022/platform-server.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_platform_server.UfEwH_YAT1-dev.js.map
