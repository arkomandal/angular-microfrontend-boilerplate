import { a as Rt, b as Bt } from "@nf-internal/chunk-Y4IBH5F6";
import { a as Y, b as K } from "@nf-internal/chunk-VDCRBLM6";
...
var mr = new ii("20.3.18"), Cr = (() => { class e {
...
function he(e, i) { return function (n) { return Tt(n) || Fi(n, i || []), n = Ci(n), [{ provide: Re, useValue: s => (Mt(s.src) && Ei(n, s.src), e(n, K(Y({}, s), { src: yi(s.src) }))) }]; }; }
...
var Er = he(Si, void 0);
function Si(e, i) { let { src: t, width: n } = i, r = []; n && r.push(`w-${n}`), i.isPlaceholder && r.push(`q-${fe}`); let o = r.length ? [e, `tr:${r.join(",")}`, t] : [e, t]; return new URL(o.join("/")).href; }
var wr = he(_i, void 0);
...
function Ar(e) { if (e && !Tt(e))
    throw new Oe(2959, !1); return e && (e = new URL(e).origin), [{ provide: Re, useValue: n => bi(n, e) }]; }
...
var Sr = new Te("");
var vi = new Te("", { providedIn: "root", factory: () => new Set }), Ii = (() => { class e {
    preloadedImages = O(vi);
    document = O(Lt);
    errorShown = !1;
...
var _r = (() => { class e {
    ...
    getResponsiveSrcset() { let { breakpoints: t } = this.config, n = t; return this.sizes?.trim() === "100vw" && (n = t.filter(o => o >= Mi)), n.map(o => `${this.callImageLoader({ src: this.ngSrc, width: o })} ${o}w`).join(", "); }
    ...
    shouldGenerateAutomaticSrcset() { let t = !1; return this.sizes || (t = this.width > Ti || this.height > Oi), !this.disableOptimizedSrcset && !this.srcset && this.imageLoader !== Ot && !t; }
