...
makeParamDecorator("Inject", (token) => ({ token })), -1
...
function retrieveHydrationInfoImpl(rNode, injector, isRootView2 = false) {
    ...
    ngDevMode && markRNodeAsClaimedByHydration(rNode, 
...
var SENSITIVE_ATTRS = merge(URI_ATTRS, 
...
function afterEveryRender(callbackOrSpec, options) {
    ...
    return afterEveryRenderImpl(callbackOrSpec, injector, options, 
    /* once */
    false);
}
...
var areAnimationSupported = (typeof ngServerMode === "undefined" || !ngServerMode) && typeof document !== "undefined" && // tslint:disable-next-line:no-toplevel-property-access
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=_angular_core.f6ajjNtssb-dev.js.map
