...
import { intervalProvider, observeNotification } from "@nf-internal/chunk-SFNMW4FL";
import "@nf-internal/chunk-KZ4KTAEI";
import "@nf-internal/chunk-HOTUKA44";
import "@nf-internal/chunk-M5X7A4V7";
import { Subject, dateTimestampProvider } from "@nf-internal/chunk-ECC66M4B";
import { COMPLETE_NOTIFICATION, Observable, Subscription, errorNotification, nextNotification, timeoutProvider } from "@nf-internal/chunk-PA6ZQ4YT";
import "@nf-internal/chunk-WXPTAMPH";
// node_modules/rxjs/dist/esm/internal/testing/SubscriptionLog.js
var SubscriptionLog = class {
...
var SubscriptionLoggable = class {
    constructor() {
        this.subscriptions = [];
    }
    logSubscribedFrame() {
...
var ColdObservable = class extends Observable {
...
var HotObservable = class extends Subject {
    constructor(messages, scheduler) {
        super();
        this.messages = messages;
        this.subscriptions = [];
...
var TestScheduler = class _TestScheduler extends VirtualTimeScheduler {
    ...
    createTime(marbles) {
        ...
        return indexOf * _TestScheduler.frameTimeFactor;
    }
    createColdObservable(marbles, values, error) {
        ...
        const messages = _TestScheduler.parseMarbles(marbles, values, error, void 0, this.runMode);
    ...
    expectObservable(observable, subscriptionMarbles = null) {
        ...
        const subscriptionParsed = _TestScheduler.parseMarblesAsSubscriptions(subscriptionMarbles, this.runMode);
        ...
        return {
            toBe(marbles, values, errorValue) {
                ...
                flushTest.expected = _TestScheduler.parseMarbles(marbles, values, errorValue, true, runMode);
            },
            toEqual: (other) => {
                flushTest.ready = true;
                flushTest.expected = [];
    ...
    expectSubscriptions(actualSubscriptionLogs) {
        ...
        return {
            toBe(marblesOrMarblesArray) {
                ...
                flushTest.ready = true;
                flushTest.expected = marblesArray.map((marbles) => _TestScheduler.parseMarblesAsSubscriptions(marbles, runMode)).filter((marbles) => marbles.subscribedFrame !== Infinity);
            }
        };
    }
    flush() {
    ...
    createAnimator() {
        ...
        const animate = (marbles) => {
            ...
            const messages = _TestScheduler.parseMarbles(marbles, void 0, void 0, void 0, true);
    ...
    createDelegates() {
        let lastHandle = 0;
        const scheduleLookup = /* @__PURE__ */ new Map();
        const run = () => {
            const now = this.now();
    ...
    run(callback) {
        const prevFrameTimeFactor = _TestScheduler.frameTimeFactor;
        const prevMaxFrames = this.maxFrames;
        _TestScheduler.frameTimeFactor = 1;
        ...
        try {
            ...
            _TestScheduler.frameTimeFactor = prevFrameTimeFactor;
...
//# sourceMappingURL=rxjs_testing.btPlXVrtsz-dev.js.map
