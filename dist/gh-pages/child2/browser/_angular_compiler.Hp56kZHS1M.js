import { a as S, b as ue } from "@nf-internal/chunk-VDCRBLM6";
var eu = new RegExp(`(\\:not\\()|(([\\.\\#]?)[-\\w]+)|(?:\\[([-.\\w*\\\\$]+)(?:=(["']?)([^\\]"']*)\\5)?\\])|(\\))|(\\s*,\\s*)`, "g"), Jn = class n {
    element = null;
    classNames = [];
    attrs = [];
    notSelectors = [];
    ...
    finalize(e, t) { let s = !0; return this.notSelectors.length > 0 && (!this.listContext || !this.listContext.alreadyMatched) && (s = !Cr.createNotMatcher(this.notSelectors).match(e, null)), s && t && (!this.listContext || !this.listContext.alreadyMatched) && (this.listContext && (this.listContext.alreadyMatched = !0), t(this.selector, this.cbContext)), s; }
}, zi = class {
    registry;
    constructor(e) { this.registry = e; }
    match(e) { return this.registry.has(e) ? this.registry.get(e) : []; }
}, md = !0, xt = (function (n) { return n[n.Emulated = 0] = "Emulated", n[n.None = 2] = "None", n[n.ShadowDom = 3] = "ShadowDom", n; })(xt || {}), Si = (function (n) { return n[n.OnPush = 0] = "OnPush", n[n.Default = 1] = "Default", n; })(Si || {}), Ss = (function (n) { return n[n.None = 0] = "None", n[n.SignalBased = 1] = "SignalBased", n[n.HasDecoratorInputTransform = 2] = "HasDecoratorInputTransform", n; })(Ss || {}), $o = { name: "custom-elements" }, Oo = { name: "no-errors-schema" }, gd = Function, Z = (function (n) { return n[n.NONE = 0] = "NONE", n[n.HTML = 1] = "HTML", n[n.STYLE = 2] = "STYLE", n[n.SCRIPT = 3] = "SCRIPT", n[n.URL = 4] = "URL", n[n.RESOURCE_URL = 5] = "RESOURCE_URL", n[n.ATTRIBUTE_NO_BINDING = 6] = "ATTRIBUTE_NO_BINDING", n; })(Z || {}), Ns = (function (n) { return n[n.Error = 0] = "Error", n[n.Warning = 1] = "Warning", n[n.Ignore = 2] = "Ignore", n; })(Ns || {});
...
var AA = Object.freeze({ __proto__: null, CUSTOM_ELEMENTS_SCHEMA: $o, get ChangeDetectionStrategy() { return Si; }, get InputFlags() { return Ss; }, get MissingTranslationStrategy() { return Ns; }, NO_ERRORS_SCHEMA: Oo, get SecurityContext() { return Z; }, Type: gd, get ViewEncapsulation() { return xt; }, emitDistinctChangesOnlyDefaultValue: md, parseSelectorToR3Selector: so }), Bt = (function (n) { return n[n.Directive = 0] = "Directive", n[n.Component = 1] = "Component", n[n.Injectable = 2] = "Injectable", n[n.Pipe = 3] = "Pipe", n[n.NgModule = 4] = "NgModule", n; })(Bt || {});
var Gi;
function tp(n) { return n.id || np(n); }
function np(n) { return yd(xd(n.nodes).join("") + `[${n.meaning}]`); }
function bc(n) { return n.id || sp(n); }
function sp(n) { let e = new Vo, t = n.nodes.map(s => s.visit(e, null)); return rp(t.join(""), n.meaning); }
var Xi = class {
...
function yd(n) { Gi ??= new TextEncoder; let e = [...Gi.encode(n)], t = _d(e, Tc.Big), s = e.length * 8, r = new Uint32Array(80), i = 1732584193, a = 4023233417, o = 2562383102, l = 271733878, c = 3285377520; t[s >> 5] |= 128 << 24 - s % 32, t[(s + 64 >> 9 << 4) + 15] = s; for (let h = 0; h < t.length; h += 16) {
    let p = i, g = a, v = o, E = l, C = c;
    for (let T = 0; T < 80; T++) {
        T < 16 ? r[T] = t[h + T] : r[T] = mo(r[T - 3] ^ r[T - 8] ^ r[T - 14] ^ r[T - 16], 1);
        let A = Cd(T, a, o, l), F = A[0], te = A[1], V = [mo(i, 5), F, c, te, r[T]].reduce(ps);
...
function tu(n) { Gi ??= new TextEncoder; let e = Gi.encode(n), t = new DataView(e.buffer, e.byteOffset, e.byteLength), s = nu(t, e.length, 0), r = nu(t, e.length, 102072); return s == 0 && (r == 0 || r == 1) && (s = s ^ 319790063, r = r ^ -1801410264), BigInt.asUintN(32, BigInt(s)) << BigInt(32) | BigInt.asUintN(32, BigInt(r)); }
function rp(n, e = "") { let t = tu(n); return e && (t = BigInt.asUintN(64, t << BigInt(1)) | t >> BigInt(63) & BigInt(1), t += tu(e)), BigInt.asUintN(63, t).toString(); }
function nu(n, e, t) { let s = 2654435769, r = 2654435769, i = 0, a = e - 12; for (; i <= a; i += 12) {
    s += n.getUint32(i, !0), r += n.getUint32(i + 4, !0), t += n.getUint32(i + 8, !0);
    let l = su(s, r, t);
    s = l[0], r = l[1], t = l[2];
} let o = e - i; return t += e, o >= 4 ? (s += n.getUint32(i, !0), i += 4, o >= 8 ? (r += n.getUint32(i, !0), i += 4, o >= 9 && (t += n.getUint8(i++) << 8), o >= 10 && (t += n.getUint8(i++) << 16), o === 11 && (t += n.getUint8(i++) << 24)) : (o >= 5 && (r += n.getUint8(i++)), o >= 6 && (r += n.getUint8(i++) << 8), o === 7 && (r += n.getUint8(i++) << 16))) : (o >= 1 && (s += n.getUint8(i++)), o >= 2 && (s += n.getUint8(i++) << 8), o === 3 && (s += n.getUint8(i++) << 16)), su(s, r, t)[2]; }
function su(n, e, t) { return n -= e, n -= t, n ^= t >>> 13, e -= t, e -= n, e ^= n << 8, t -= n, t -= e, t ^= e >>> 13, n -= e, n -= t, n ^= t >>> 12, e -= t, e -= n, e ^= n << 16, t -= n, t -= e, t ^= e >>> 5, n -= e, n -= t, n ^= t >>> 3, e -= t, e -= n, e ^= n << 10, t -= n, t -= e, t ^= e >>> 15, [n, e, t]; }
var Tc = (function (n) { return n[n.Little = 0] = "Little", n[n.Big = 1] = "Big", n; })(Tc || {});
...
function ru(n, e) { return e >= n.length ? 0 : n[e]; }
function kd(n, e, t) { let s = 0; if (t === Tc.Big)
    for (let r = 0; r < 4; r++)
        s += ru(n, e + r) << 24 - 8 * r;
else
    for (let r = 0; r < 4; r++)
        s += ru(n, e + r) << 8 * r; return s; }
var Ic = (function (n) { return n[n.None = 0] = "None", n[n.Const = 1] = "Const", n; })(Ic || {}), En = class {
    modifiers;
    constructor(e = Ic.None) { this.modifiers = e; }
    hasModifier(e) { return (this.modifiers & e) !== 0; }
}, jt = (function (n) { return n[n.Dynamic = 0] = "Dynamic", n[n.Bool = 1] = "Bool", n[n.String = 2] = "String", n[n.Int = 3] = "Int", n[n.Number = 4] = "Number", n[n.Function = 5] = "Function", n[n.Inferred = 6] = "Inferred", n[n.None = 7] = "None", n; })(jt || {}), _t = class extends En {
    name;
...
var Y = class {
    ...
    isBlank(e) { return this.equals(lp, e); }
    ...
    isEquivalent(e) { return e instanceof n && op(this.elements, e.elements, (t, s) => t.text === s.text) && Re(this.expressions, e.expressions); }
    isConstant() { return !1; }
    ...
    serializeI18nHead() { let e = this.metaBlock.description || ""; return this.metaBlock.meaning && (e = `${this.metaBlock.meaning}${Id}${e}`), this.metaBlock.customId && (e = `${e}${iu}${this.metaBlock.customId}`), this.metaBlock.legacyIds && this.metaBlock.legacyIds.forEach(t => { e = `${e}${Nd}${t}`; }), au(e, this.messageParts[0].text, this.getMessagePartSourceSpan(0)); }
    ...
    serializeI18nTemplatePart(e) { let t = this.placeHolderNames[e - 1], s = this.messageParts[e], r = t.text; return t.associatedMessage?.legacyIds.length === 0 && (r += `${iu}${rp(t.associatedMessage.messageString, t.associatedMessage.meaning)}`), au(r, s.text, this.getMessagePartSourceSpan(e)); }
}, Oi = n => n.replace(/\\/g, "\\\\"), Dd = n => n.replace(/^:/, "\\:"), Pd = n => n.replace(/:/g, "\\:"), Ho = n => n.replace(/`/g, "\\`").replace(/\${/g, "$\\{");
function au(n, e, t) { return n === "" ? { cooked: e, raw: Ho(Dd(Oi(e))), range: t } : { cooked: `:${n}:${e}`, raw: Ho(`:${Pd(Oi(n))}:${Oi(e)}`), range: t }; }
var tn = class n extends Y {
    ...
    isEquivalent(e) { return e instanceof n && this.condition.isEquivalent(e.condition) && this.trueCase.isEquivalent(e.trueCase) && ap(this.falseCase, e.falseCase); }
    isConstant() { return !1; }
    ...
    isEquivalent(e) { return (e instanceof n || e instanceof Cn) && Re(this.params, e.params) && Re(this.statements, e.statements); }
    isConstant() { return !1; }
    visitExpression(e, t) { return e.visitFunctionExpr(this, t); }
    toDeclStmt(e, t) { return new Cn(e, this.params, this.statements, this.type, t, this.sourceSpan); }
    clone() { return new n(this.params.map(e => e.clone()), this.statements, this.type, this.sourceSpan, this.name); }
}, Sn = class n extends Y {
    params;
    body;
...
}, xn = new Ee(null, null, null), lp = new Ee(null, qe, null), le = (function (n) { return n[n.None = 0] = "None", n[n.Final = 1] = "Final", n[n.Private = 2] = "Private", n[n.Exported = 4] = "Exported", n[n.Static = 8] = "Static", n; })(le || {}), br = class {
    text;
    multiline;
    trailingNewline;
...
function Bd(n, e = !1, t = !0) { return new br(n, e, t); }
function cp(n = []) { return new Tr(n); }
...
function he(n, e = null) { return new Tt(n.map(t => new ts(t.key, t.value, t.quoted)), e, null); }
function Fd(n, e, t, s) { return new nn(n, e, t, s); }
function up(n, e) { return new Ms(n, e); }
function sn(n, e, t, s, r) { return new Zt(n, e, t, s, r); }
function ie(n, e, t, s) { return new Sn(n, e, t, s); }
function xi(n, e, t, s, r) { return new Ir(n, e, t, s, r); }
function hp(n, e, t, s) { return new Ps(n, e, t, s); }
function d(n, e, t) { return new Ee(n, e, t); }
function pp(n, e, t, s, r) { return new kr(n, e, t, s, r); }
function $d(n) { return n instanceof Ee && n.value === null; }
function ou(n) { let e = ""; if (n.tagName && (e += ` @${n.tagName}`), n.text) {
    if (n.text.match(/\/\*|\*\//))
...
var kA = Object.freeze({ __proto__: null, ArrayType: qo, ArrowFunctionExpr: Sn, BOOL_TYPE: ip, get BinaryOperator() { return x; }, BinaryOperatorExpr: W, BuiltinType: _t, get BuiltinTypeName() { return jt; }, CommaExpr: jo, ConditionalExpr: bt, DYNAMIC_TYPE: He, DeclareFunctionStmt: Cn, DeclareVarStmt: ce, DynamicImportExpr: es, Expression: Y, ExpressionStatement: nt, ExpressionType: Je, ExternalExpr: tn, ExternalReference: Wo, FUNCTION_TYPE: Td, FnParam: K, FunctionExpr: Zt, INFERRED_TYPE: qe, INT_TYPE: bd, IfStmt: Ir, InstantiateExpr: Ls, InvokeFunctionExpr: Fe, JSDocComment: Tr, LeadingComment: br, LiteralArrayExpr: dt, LiteralExpr: Ee, LiteralMapEntry: ts, LiteralMapExpr: Tt, LiteralPiece: mn, LocalizedString: kr, MapType: Uo, NONE_TYPE: kt, NULL_EXPR: xn, NUMBER_TYPE: ro, NotExpr: Ms, ParenthesizedExpr: ft, PlaceholderPiece: zn, ReadKeyExpr: Ft, ReadPropExpr: We, ReadVarExpr: tt, RecursiveAstVisitor: Ld, ReturnStatement: xe, STRING_TYPE: io, Statement: yn, get StmtModifier() { return le; }, TYPED_NULL_EXPR: lp, TaggedTemplateLiteralExpr: Ps, TemplateLiteralElementExpr: _r, TemplateLiteralExpr: Bs, TransplantedType: Yi, Type: En, get TypeModifier() { return Ic; }, TypeofExpr: Kn, get UnaryOperator() { return Ds; }, UnaryOperatorExpr: nn, VoidExpr: Ar, WrappedNodeExpr: H, areAllEquivalent: Re, arrowFn: ie, expressionType: we, fn: sn, ifStmt: xi, importExpr: y, importType: Md, isNull: $d, jsDocComment: cp, leadingComment: Bd, literal: d, literalArr: R, literalMap: he, localizedString: pp, not: up, nullSafeIsEquivalent: ap, taggedTemplate: hp, transplantedType: Rd, typeofExpr: Js, unary: Fd, variable: D }), Vd = "_c", lu = D("<unknown>"), qd = {}, Ud = 50, Qi = class n extends Y {
    resolved;
    original;
    shared = !1;
    ...
    getConstLiteral(e, t) { if (e instanceof Ee && !cu(e) || e instanceof Qi)
        ...
        this.isClosureCompilerEnabled && cu(e) ? (o = new Zt([], [new xe(e)]), l = D(a).callFn([])) : (o = e, l = D(a)), this.statements.push(new ce(a, o, qe, le.Final)), r.fixup(l);
    } return r; }
    ...
    getLiteralFactory(e) { if (e instanceof dt) {
        let t = e.entries.map(r => r.isConstant() ? r : lu), s = ks.INSTANCE.keyOf(R(t));
        return this._getLiteralFactory(s, e.entries, r => R(r));
    }
    else {
        let t = he(e.entries.map(r => ({ key: r.key, value: r.value.isConstant() ? r.value : lu, quoted: r.quoted }))), s = ks.INSTANCE.keyOf(t);
    ...
    getSharedFunctionReference(e, t, s = !0) { let r = e instanceof Sn; for (let a of this.statements)
        if (r && a instanceof ce && a.value?.isEquivalent(e) || !r && a instanceof Cn && e instanceof Zt && e.isEquivalent(a))
    ...
    _getLiteralFactory(e, t, s) { let r = this.literalFactories.get(e), i = t.filter(a => !a.isConstant()); if (!r) {
        let a = t.map((h, p) => h.isConstant() ? this.getConstLiteral(h, !0) : D(`a${p}`)), o = a.filter(Hd).map(h => new K(h.name, He)), l = ie(o, s(a), qe), c = this.freshName();
...
function cu(n) { return n instanceof Ee && typeof n.value == "string" && n.value.length >= Ud; }
var m = "@angular/core", f = (() => { class n {
    ...
    static validateAttribute = { name: "\u0275\u0275validateAttribute", moduleName: m };
...
function mp(n) { return n.startsWith("0.") ? !0 : !Qd.test(n); }
var Zd = 3, Jd = "# sourceMappingURL=data:application/json;base64,", Go = class {
    ...
    toJSON() { if (!this.hasMappings)
        return null; let e = new Map, t = [], s = []; Array.from(this.sourcesContent.keys()).forEach((c, h) => { e.set(c, h), t.push(c), s.push(this.sourcesContent.get(c) || null); }); let r = "", i = 0, a = 0, o = 0, l = 0; return this.lines.forEach(c => { i = 0, r += c.map(h => { let p = _i(h.col0 - i); return i = h.col0, h.sourceUrl != null && (p += _i(e.get(h.sourceUrl) - a), a = e.get(h.sourceUrl), p += _i(h.sourceLine0 - o), o = h.sourceLine0, p += _i(h.sourceCol0 - l), l = h.sourceCol0), p; }).join(","), r += ";"; }), r = r.slice(0, -1), { file: this.file || "", version: Zd, sourceRoot: "", sources: t, sourcesContent: s, mappings: r }; }
...
function Kd(n) { let e = "", t = Yd(n); for (let s = 0; s < t.length;) {
    ...
    e += pr(r >> 2), e += pr((r & 3) << 4 | (i === null ? 0 : i >> 4)), e += i === null ? "=" : pr((i & 15) << 2 | (a === null ? 0 : a >> 6)), e += i === null || a === null ? "=" : pr(a & 63);
} return e; }
function _i(n) { n = n < 0 ? (-n << 1) + 1 : n << 1; let e = ""; do {
    let t = n & 31;
    n = n >> 5, n > 0 && (t = t | 32), e += pr(t);
} while (n > 0); return e; }
var em = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
function pr(n) { if (n < 0 || n >= 64)
...
var tm = /'|\\|\n|\r|\$/g, nm = /^[$A-Z_][0-9A-Z_$]*$/i, Xo = "  ", Ji = class {
    ...
    toSource() {
        return this.sourceLines.map(e => e.parts.length > 0 ? uu(e.indent) + e.parts.join("") : "").join(`
`);
    }
...
`).forEach(r => { t.println(e, `// ${r}`); });
    ...
    visitInvokeFunctionExpr(e, t) { let s = e.fn instanceof Sn; return s && t.print(e.fn, "("), e.fn.visitExpression(this, t), s && t.print(e.fn, ")"), t.print(e, "("), this.visitAllExpressions(e.args, t, ","), t.print(e, ")"), null; }
...
function uu(n) { let e = ""; for (let t = 0; t < n; t++)
    e += Xo; return e; }
...
function im(n) { return gp("ngJitMode", n); }
function Nr(n) { return gp("ngDevMode", n); }
function gp(n, e) { let t = new tn({ name: n, moduleName: null }), s = new W(x.Identical, new Kn(t), d("undefined")), r = new W(x.Or, s, t, void 0, void 0); return new W(x.And, r, e); }
...
function $n(n) { let e = D("__ngFactoryType__"), t = null, s = pu(n) ? e : new W(x.Or, e, n.type.value), r = null; n.deps !== null ? n.deps !== "invalid" && (r = new Ls(s, hu(n.deps, n.target))) : (t = D(`\u0275${n.name}_BaseFactory`), r = t.callFn([s])); let i = [], a = null; function o(c) { let h = D("__ngConditionalFactory__"); i.push(new ce(h.name, xn, qe)); let p = r !== null ? h.set(r).toStmt() : y(f.invalidFactory).callFn([]).toStmt(); return i.push(xi(e, [p], [h.set(c).toStmt()])), h; } if (pu(n)) {
    let c = hu(n.delegateDeps, n.target), h = new (n.delegateType === Ki.Class ? Ls : Fe)(n.delegate, c);
    a = o(h);
}
else
    ...
    i.push(new xe(a)); let l = sn([new K(e.name, He)], i, qe, void 0, `${n.name}_Factory`); return t !== null && (l = ie([], [new ce(t.name), new xe(l)]).callFn([], void 0, !0)), { expression: l, statements: [], type: vp(n) }; }
function vp(n) { let e = n.deps !== null && n.deps !== "invalid" ? om(n.deps) : kt; return we(y(f.FactoryDeclaration, [ao(n.type.type, n.typeArgumentCount), e])); }
function hu(n, e) { return n.map((t, s) => am(t, e, s)); }
...
function pu(n) { return n.delegateType !== void 0; }
...
}, qi = (function (n) { return n[n.ReferencedByName = 0] = "ReferencedByName", n[n.ReferencedDirectly = 1] = "ReferencedDirectly", n; })(qi || {}), ta = class extends Dr {
    exp;
    name;
    args;
    type;
...
function fu(n) { return It(n)[1] === "ng-container"; }
...
var Ie = class {
    ...
    visitIcu(e, t) { let s = {}; return Object.keys(e.cases).forEach(i => s[i] = e.cases[i].visit(this, t)), new _n(e.expression, e.type, s, e.sourceSpan, e.expressionPlaceholder); }
    ...
    visitIcuPlaceholder(e, t) { return new kn(e.value, e.name, e.sourceSpan); }
...
var vm = "angular", du = "messagebundle", wm = "msg", Rn = "ph", Fn = "ex", Em = "source", Sm = `<!ELEMENT messagebundle (msg)*>
...
<!ELEMENT ex (#PCDATA)>`, hl = class extends Us {
    write(e, t) { let s = new pl, r = new xm, i = new M(du); return i.attrs.handler = vm, e.forEach(a => { let o = { id: a.id }; a.description && (o.desc = a.description), a.meaning && (o.meaning = a.meaning); let l = []; a.sources.forEach(c => { l.push(new M(Em, {}, [new Q(`${c.filePath}:${c.startLine}${c.endLine !== c.startLine ? "," + c.endLine : ""}`)])); }), i.children.push(new j(2), new M(wm, o, [...l, ...r.serialize(a.nodes)])); }), i.children.push(new j), Lc([new Qr({ version: "1.0", encoding: "UTF-8" }), new j, new ul(du, Sm), new j, s.addDefaultExamples(i), new j]); }
    load(e, t) { throw new Error("Unsupported"); }
    digest(e) { return Sp(e); }
...
var xp = "i18n", fl = "i18n-", ym = "VAR_";
function yp(n) { return n === xp || n.startsWith(fl); }
function Cm(n) { return n.attrs.some(e => yp(e.name)); }
function Cp(n) { return n.nodes[0]; }
function Mc(n = {}, e) { let t = {}; return n && Object.keys(n).length && Object.keys(n).forEach(s => t[Ci(s, e)] = n[s]), t; }
function Ci(n, e = !0) { let t = Bc(n); if (!e)
...
var Rc = /[-.]/, Fc = "_t", Zr = "ctx", $c = "rf";
function Ap(n, e) { let t = null; return () => (t || (n(new ce(Fc, void 0, He)), t = D(e)), t); }
...
function _m(n) { let e = {}; return n instanceof Ke && n.tagName !== "ng-template" ? n.templateAttrs.forEach(t => e[t.name] = "") : (n.attributes.forEach(t => { yp(t.name) || (e[t.name] = t.value); }), n.inputs.forEach(t => { (t.type === G.Property || t.type === G.TwoWay) && (e[t.name] = ""); }), n.outputs.forEach(t => { e[t.name] = ""; })), e; }
function mu(n, e) { let t = null, s = { name: n.name, type: n.type, typeArgumentCount: n.typeArgumentCount, deps: [], target: Bt.Injectable }; if (n.useClass !== void 0) {
    let o = n.useClass.expression.isEquivalent(n.type.value), l;
    n.deps !== void 0 && (l = n.deps), l !== void 0 ? t = $n(ue(S({}, s), { delegate: n.useClass.expression, delegateDeps: l, delegateType: Ki.Class })) : o ? t = $n(s) : t = { statements: [], expression: gu(n.type.value, n.useClass.expression, e) };
}
else
    n.useFactory !== void 0 ? n.deps !== void 0 ? t = $n(ue(S({}, s), { delegate: n.useFactory, delegateDeps: n.deps || [], delegateType: Ki.Function })) : t = { statements: [], expression: ie([], n.useFactory.callFn([])) } : n.useValue !== void 0 ? t = $n(ue(S({}, s), { expression: n.useValue.expression })) : n.useExisting !== void 0 ? t = $n(ue(S({}, s), { expression: y(f.inject).callFn([n.useExisting.expression]) })) : t = { statements: [], expression: gu(n.type.value, n.type.value, e) }; let r = n.type.value, i = new ae; return i.set("token", r), i.set("factory", t.expression), n.providedIn.expression.value !== null && i.set("providedIn", xs(n.providedIn)), { expression: y(f.\u0275\u0275defineInjectable).callFn([i.toLiteralMap()], void 0, !0), type: _p(n), statements: t.statements }; }
function _p(n) { return new Je(y(f.InjectableDeclaration, [ao(n.type.type, n.typeArgumentCount)])); }
function gu(n, e, t) { if (n.node === e.node)
    return e.prop("\u0275fac"); if (!t)
    return vu(e); let s = y(f.resolveForwardRef).callFn([e]); return vu(s); }
function vu(n) { let e = new K("__ngFactoryType__", He); return ie([e], n.prop("\u0275fac").callFn([D(e.name)])); }
var km = [/@/, /^\s*$/, /[<>]/, /^[{}]$/, /&(#|[a-z])/i, /^\/\//];
function bm(n, e) { if (e != null && !(Array.isArray(e) && e.length == 2))
...
var ga = class n {
    ...
    static fromArray(e) { return e ? (bm("interpolation", e), new n(e[0], e[1])) : ot; }
    constructor(e, t) { this.start = e, this.end = t; }
}, ot = new ga("{{", "}}"), kp = new Set(["switch"]), _e = 0, Tm = 8, Oc = 9, Xn = 10, bp = 11, Tp = 12, Vc = 13, Ip = 32, ml = 33, Jr = 34, Np = 35, co = 36, Im = 37, va = 38, Kr = 39, At = 40, Pe = 41, wu = 42, Dp = 43, ht = 44, wa = 45, fr = 46, Et = 47, Gt = 58, Ye = 59, Ts = 60, be = 61, it = 62, Eu = 63, qc = 48, Nm = 55, Pp = 57, Pn = 65, Dm = 69, Pm = 70, Lm = 88, Ks = 90, gn = 91, Is = 92, Hn = 93, Bm = 94, Ln = 95, as = 97, Mm = 98, Rm = 101, Uc = 102, Lp = 110, Bp = 114, Mp = 116, Rp = 117, Fp = 118, $p = 120, Ai = 122, yt = 123, Su = 124, Le = 125, Op = 160, fs = 64, gl = 96;
function ei(n) { return n >= Oc && n <= Ip || n == Op; }
function St(n) { return qc <= n && n <= Pp; }
function Hs(n) { return n >= as && n <= Ai || n >= Pn && n <= Ks; }
function Fm(n) { return n >= as && n <= Uc || n >= Pn && n <= Pm || St(n); }
function Ea(n) { return n === Xn || n === Vc; }
function xu(n) { return qc <= n && n <= Nm; }
function Er(n) { return n === Kr || n === Jr || n === gl; }
var os = class n {
    file;
    offset;
    line;
...
}, dn = (function (n) { return n[n.WARNING = 0] = "WARNING", n[n.ERROR = 1] = "ERROR", n; })(dn || {}), N = class extends Error {
    span;
    msg;
    level;
    relatedError;
    constructor(e, t, s = dn.ERROR, r) { super(t), this.span = e, this.msg = t, this.level = s, this.relatedError = r, Object.setPrototypeOf(this, new.target.prototype); }
    contextualMessage() { let e = this.span.start.getContext(100, 3); return e ? `${this.msg} ("${e.before}[${dn[this.level]} ->]${e.after}")` : this.msg; }
    toString() { let e = this.span.details ? `, ${this.span.details}` : ""; return `${this.contextualMessage()}: ${this.span.start}${e}`; }
};
function $m(n, e, t) { let s = `in ${n} ${e} in ${t}`, r = new ti("", s); return new L(new os(r, -1, -1, -1), new os(r, -1, -1, -1)); }
var Om = 0;
function Vm(n) { if (!n || !n.reference)
    ...
    return "__forward_ref__"; let t = dp(e); return t.indexOf("(") >= 0 ? (t = `anonymous_${Om++}`, e.__anonymousType = t) : t = On(t), t; }
function On(n) { return n.replace(/\W/g, "_"); }
var yu = '(this&&this.__makeTemplateObject||function(e,t){return Object.defineProperty?Object.defineProperty(e,"raw",{value:t}):e.raw=t,e})', vl = class extends Qo {
    constructor() { super(!1); }
    ...
    visitTaggedTemplateLiteralExpr(e, t) { let s = e.template.elements; return e.tag.visitExpression(this, t), t.print(e, `(${yu}(`), t.print(e, `[${s.map(r => qn(r.text, !1)).join(", ")}], `), t.print(e, `[${s.map(r => qn(r.rawText, !1)).join(", ")}])`), e.template.expressions.forEach(r => { t.print(e, ", "), r.visitExpression(this, t); }), t.print(e, ")"), null; }
    visitTemplateLiteralExpr(e, t) { t.print(e, "`"); for (let s = 0; s < e.elements.length; s++) {
        e.elements[s].visitExpression(this, t);
        let r = s < e.expressions.length ? e.expressions[s] : null;
        r !== null && (t.print(r, "${"), r.visitExpression(this, t), t.print(r, "}"));
    ...
    visitLocalizedString(e, t) { t.print(e, `$localize(${yu}(`); let s = [e.serializeI18nHead()]; for (let r = 1; r < e.messageParts.length; r++)
...
function qm() { if (ki === void 0) {
    let n = Vi.trustedTypes;
    if (ki = null, n)
        try {
            ki = n.createPolicy("angular#unsafe-jit", { createScript: e => e });
        }
        catch { }
} return ki; }
...
//# sourceURL=${e}`, a = [], o = [];
        for (let c in s)
            o.push(s[c]), a.push(c);
        if (r) {
            let c = Cu(...a.concat("return null;")).toString(), h = c.slice(0, c.indexOf("return null;")).split(`
`).length - 1;
            i += `
${t.toSourceMapGenerator(e, h).toJsComment()}`;
    ...
    createReturnStmt(e) { new xe(new Tt(this._evalExportedVars.map(s => new ts(s, D(s), !1)))).visitStatement(this, e); }
...
function Au(n) { let e = new ae; n.providers !== null && e.set("providers", n.providers), n.imports.length > 0 && e.set("imports", R(n.imports)); let t = y(f.defineInjector).callFn([e.toLiteralMap()], void 0, !0), s = Vp(n); return { expression: t, type: s, statements: [] }; }
function Vp(n) { return new Je(y(f.InjectorDeclaration, [new Je(n.type.type)])); }
var Sl = class {
    context;
...
function Wm(n) { let e = [], t = new ae; if (t.set("type", n.type.value), n.kind === Yt.Global && n.bootstrap.length > 0 && t.set("bootstrap", Ct(n.bootstrap, n.containsForwardDecls)), n.selectorScopeMode === Sa.Inline)
    ...
    let i = zm(n);
    i !== null && e.push(i);
} n.schemas !== null && n.schemas.length > 0 && t.set("schemas", R(n.schemas.map(i => i.value))), n.id !== null && (t.set("id", n.id), e.push(y(f.registerNgModuleType).callFn([n.type.value, n.id]).toStmt())); let s = y(f.defineNgModule).callFn([t.toLiteralMap()], void 0, !0), r = qp(n); return { expression: s, type: r, statements: e }; }
...
function qp(n) { if (n.kind === Yt.Local)
...
function _u(n) { let e = []; e.push({ key: "name", value: d(n.pipeName ?? n.name), quoted: !1 }), e.push({ key: "type", value: n.type.value, quoted: !1 }), e.push({ key: "pure", value: d(n.pure), quoted: !1 }), n.isStandalone === !1 && e.push({ key: "standalone", value: d(!1), quoted: !1 }); let t = y(f.definePipe).callFn([he(e)], void 0, !0), s = Up(n); return { expression: t, type: s, statements: [] }; }
function Up(n) { return new Je(y(f.PipeDeclaration, [ao(n.type.type, n.typeArgumentCount), new Je(new Ee(n.pipeName)), new Je(new Ee(n.isStandalone))])); }
...
`);
    ...
    _scopeKeyframesRelatedCss(e, t) { let s = new Set, r = bi(e, i => this._scopeLocalKeyframeDeclarations(i, t, s)); return bi(r, i => this._scopeAnimationRule(i, t, s)); }
    _scopeLocalKeyframeDeclarations(e, t, s) { return ue(S({}, e), { selector: e.selector.replace(/(^@(?:-webkit-)?keyframes(?:\s+))(['"]?)(.+)\2(\s*)$/, (r, i, a, o, l) => (s.add(Tu(o, a)), `${i}${a}${t}_${o}${a}${l}`)) }); }
    _scopeAnimationKeyframe(e, t, s) { return e.replace(/^(\s*)(['"]?)(.+?)\2(\s*)$/, (r, i, a, o, l) => (o = `${s.has(Tu(o, a)) ? t + "_" : ""}${o}`, `${i}${a}${o}${a}${l}`)); }
...
` + r, e.trim();
    ...
    _extractUnscopedRulesFromCssText(e) {
        let t = "", s;
        for (ku.lastIndex = 0; (s = ku.exec(e)) !== null;) {
...
`;
    ...
    _scopeSelectors(e, t, s) { return bi(e, r => { let i = r.selector, a = r.content; return r.selector[0] !== "@" ? i = this._scopeSelector({ selector: i, scopeSelector: t, hostSelector: s, isParentSelector: !0 }) : Ym.some(o => r.selector.startsWith(o)) ? a = this._scopeSelectors(r.content, t, s) : (r.selector.startsWith("@font-face") || r.selector.startsWith("@page")) && (a = this._stripScopingSelectors(r.content)), new ni(i, a); }); }
    _stripScopingSelectors(e) { return bi(e, t => { let s = t.selector.replace(bu, " ").replace(vo, " "); return new ni(s, t.content); }); }
    _safeSelector;
    ...
    _applySelectorScope({ selector: e, scopeSelector: t, hostSelector: s, isParentSelector: r }) { let i = /\[is=([^\]]*)\]/g; t = t.replace(i, (C, ...T) => T[0]); let a = `[${t}]`, o = C => { let T = C.trim(); if (!T)
        return C; if (C.includes(hn)) {
        if (T = this._applySimpleSelectorScope(C, t, s), !C.match(ng)) {
            let [A, F, te, V] = T.match(/([^:]*)(:*)([\s\S]*)/);
            T = F + a + te + V;
        }
    }
    else {
    ...
    } return T; }, l = C => { let T = "", A = [], F; for (; (F = ar.exec(C)) !== null;) {
        let te = 1, V = ar.lastIndex;
        for (; V < C.length;) {
            let de = C[V];
            if (V++, de === "(") {
                te++;
    ...
    } return A.join("") === C ? T = A.map(te => { let [V] = te.match(ar) ?? [], de = te.slice(V?.length, -1); de.includes(hn) && (this._shouldScopeIndicator = !0); let rr = this._scopeSelector({ selector: de, scopeSelector: t, hostSelector: s }); return `${V}${rr})`; }).join("") : (this._shouldScopeIndicator = this._shouldScopeIndicator || C.includes(hn), T = this._shouldScopeIndicator ? o(C) : C), T; }; r && (this._safeSelector = new xl(e), e = this._safeSelector.content()); let c = "", h = 0, p, g = /( |>|\+|~(?!=))(?!([^)(]*(?:\([^)(]*(?:\([^)(]*(?:\([^)(]*\)[^)(]*)*\)[^)(]*)*\)[^)(]*)*\)))\s*/g, v = e.includes(hn); for ((r || this._shouldScopeIndicator) && (this._shouldScopeIndicator = !v); (p = g.exec(e)) !== null;) {
    ...
    _insertPolyfillHostInCssText(e) { return e.replace(ag, Hp).replace(ig, ya); }
}, xl = class {
    placeholders = [];
    index = 0;
    _content;
...
}, Qm = "(:(where|is)\\()?", ar = /:(where|is)\(/gi, Zm = /polyfill-next-selector[^}]*content:[\s]*?(['"])(.*?)\1[;\s]*}([^{]*?){/gim, Jm = /(polyfill-rule)[^}]*(content:[\s]*(['"])(.*?)\3)[;\s]*[^}]*}/gim, ku = /(polyfill-unscoped-rule)[^}]*(content:[\s]*(['"])(.*?)\3)[;\s]*[^}]*}/gim, ya = "-shadowcsshost", Hp = "-shadowcsscontext", Wp = "(?:\\(((?:\\([^)(]*\\)|[^)(]*)+?)\\))", Km = new RegExp(ya + Wp + "?([^,{]*)", "gim"), jp = Hp + Wp + "?([^{]*)", eg = new RegExp(`${Qm}(${jp})`, "gim"), tg = new RegExp(jp, "im"), hn = ya + "-no-combinator", ng = new RegExp(`${hn}(?![^(]*\\))`, "g"), vo = /-shadowcsshost-no-combinator([^\s,]*)/, sg = [/::shadow/g, /::content/g, /\/shadow-deep\//g, /\/shadow\//g], bu = /(?:>>>)|(?:\/deep\/)|(?:::ng-deep)/g, rg = "([>\\s~+[.,{:][\\s\\S]*)?$", Cs = /-shadowcsshost/gim, ig = /:host/gim, ag = /:host-context/gim, og = /\r?\n/g, lg = /\/\*[\s\S]*?\*\//g, cg = /\/\*\s*#\s*source(Mapping)?URL=/g, Hc = "%COMMENT%", ug = new RegExp(Hc, "g"), wo = "%BLOCK%", hg = new RegExp(`(\\s*(?:${Hc}\\s*)*)([^;\\{\\}]+?)(\\s*)((?:{%BLOCK%}?\\s*;?)|(?:\\s*;))`, "g"), pg = new Map([["{", "}"]]), zp = "%COMMA_IN_PLACEHOLDER%", Gp = "%SEMI_IN_PLACEHOLDER%", Xp = "%COLON_IN_PLACEHOLDER%", fg = new RegExp(zp, "g"), dg = new RegExp(Gp, "g"), mg = new RegExp(Xp, "g"), ni = class {
    selector;
    content;
    constructor(e, t) { this.selector = e, this.content = t; }
};
function bi(n, e) { let t = wg(n), s = gg(t, pg, wo), r = 0, i = s.escapedString.replace(hg, (...a) => { let o = a[2], l = "", c = a[4], h = ""; c && c.startsWith("{" + wo) && (l = s.blocks[r++], c = c.substring(wo.length + 1), h = "{"); let p = e(new ni(o, l)); return `${a[1]}${p.selector}${a[3]}${h}${p.content}${c}`; }); return Eg(i); }
var yl = class {
    escapedString;
    blocks;
...
function Tu(n, e) { return e ? n.replace(/((?:^|[^\\])(?:\\\\)*)\\(?=['"])/g, "$1") : n; }
function Sg(n, e, t = "") { let s = hn; Cs.lastIndex = 0; let r = Cs.test(e); if (n.length === 0)
...
function bg(n, e, t) { return S(S(S({ kind: u.StyleMap, target: n, expression: e, sourceSpan: t }, rt), je), B); }
function Tg(n, e, t) { return S(S(S({ kind: u.ClassMap, target: n, expression: e, sourceSpan: t }, rt), je), B); }
function Nu(n, e, t, s, r, i, a, o, l, c) { return S(S(S({ kind: u.Attribute, target: n, namespace: e, name: t, expression: s, securityContext: r, sanitizer: null, isTextAttribute: i, isStructuralTemplateAttribute: a, templateKind: o, i18nContext: null, i18nMessage: l, sourceSpan: c }, rt), je), B); }
function Ig(n, e) { return S({ kind: u.Advance, delta: n, sourceSpan: e }, B); }
function Qp(n, e, t, s) { return S(S(S({ kind: u.Conditional, target: n, test: e, conditions: t, processed: null, sourceSpan: s, contextValue: null }, B), rt), je); }
function Ng(n, e, t, s) { return S(S({ kind: u.Repeater, target: n, targetSlot: e, collection: t, sourceSpan: s }, B), rt); }
function Du(n, e, t, s, r, i, a) { return S({ kind: u.AnimationBinding, name: n, target: e, animationKind: t, expression: s, i18nMessage: null, securityContext: r, sanitizer: null, sourceSpan: i, animationBindingKind: a }, B); }
function Dg(n, e, t, s) { return S(S(S({ kind: u.DeferWhen, target: n, expr: e, modifier: t, sourceSpan: s }, B), rt), je); }
function Zp(n, e, t, s, r, i, a, o, l, c, h) { return S(S(S({ kind: u.I18nExpression, context: n, target: e, i18nOwner: t, handle: s, expression: r, icuPlaceholder: i, i18nPlaceholder: a, resolutionTime: o, usage: l, name: c, sourceSpan: h }, B), je), rt); }
...
function Ht(n) { return n instanceof ee; }
var ee = class extends Y {
    constructor(e = null) { super(null, e); }
}, Ae = class n extends ee {
    name;
    kind = I.LexicalRead;
...
function k(n, e, t) { if (n instanceof ee)
...
function Jp(n) { return n instanceof Ee && typeof n.value == "string"; }
var w = (() => { class n {
    static nextListId = 0;
...
function In(n) { return Bg.has(n.kind); }
...
function Kp(n, e, t, s, r, i, a, o) { return S(S({ kind: u.Template, xref: n, templateKind: e, attributes: null, tag: t, handle: new ke, functionNameSuffix: s, decls: null, vars: null, localRefs: [], nonBindable: !1, namespace: r, i18nPlaceholder: i, startSourceSpan: a, wholeSourceSpan: o }, vt), B); }
function ef(n, e, t, s, r, i, a, o) { return S(S({ kind: u.ConditionalCreate, xref: n, templateKind: e, attributes: null, tag: t, handle: new ke, functionNameSuffix: s, decls: null, vars: null, localRefs: [], nonBindable: !1, namespace: r, i18nPlaceholder: i, startSourceSpan: a, wholeSourceSpan: o }, vt), B); }
function tf(n, e, t, s, r, i, a, o) { return S(S({ kind: u.ConditionalBranchCreate, xref: n, templateKind: e, attributes: null, tag: t, handle: new ke, functionNameSuffix: s, decls: null, vars: null, localRefs: [], nonBindable: !1, namespace: r, i18nPlaceholder: i, startSourceSpan: a, wholeSourceSpan: o }, vt), B); }
function Rg(n, e, t, s, r, i, a, o, l, c) { return ue(S(S(S({ kind: u.RepeaterCreate, attributes: null, xref: n, handle: new ke, emptyView: e, track: s, trackByFn: null, trackByOps: null, tag: t, emptyTag: i, emptyAttributes: null, functionNameSuffix: "For", namespace: Te.HTML, nonBindable: !1, localRefs: [], decls: null, vars: null, varNames: r, usesComponentInstance: !1, i18nPlaceholder: a, emptyI18nPlaceholder: o, startSourceSpan: l, wholeSourceSpan: c }, vt), B), je), { numSlotsUsed: e === null ? 2 : 3 }); }
...
function nf(n, e, t, s) { return S(S({ kind: u.Text, xref: n, handle: new ke, initialValue: e, icuPlaceholder: t, sourceSpan: s }, vt), B); }
...
function sf(n, e, t, s, r, i, a, o, l) { let c = new w; return c.push(r), S({ kind: u.AnimationListener, target: n, targetSlot: e, tag: s, hostListener: o, name: t, animationKind: i, handlerOps: c, handlerFnName: null, consumesDollarEvent: !1, eventTarget: a, sourceSpan: l }, B); }
function rf(n, e, t, s, r, i) { let a = new w; return a.push(r), S({ kind: u.TwoWayListener, target: n, targetSlot: e, tag: s, name: t, handlerOps: a, handlerFnName: null, sourceSpan: i }, B); }
function af(n, e, t) { return S(S({ kind: u.Pipe, xref: n, handle: e, name: t }, B), vt); }
...
function un(n, e, t, s) { return S({ kind: u.DeferOn, defer: n, trigger: e, modifier: t, sourceSpan: s }, B); }
...
function of(n, e, t) { return S(S({ kind: u.I18nAttributes, xref: n, handle: e, target: t, i18nAttributesConfig: null }, B), vt); }
...
var lf = "CTX_REF_MARKER", _ = (function (n) { return n[n.Tmpl = 0] = "Tmpl", n[n.Host = 1] = "Host", n[n.Both = 2] = "Both", n; })(_ || {}), Oe = (function (n) { return n[n.Full = 0] = "Full", n[n.DomOnly = 1] = "DomOnly", n; })(Oe || {}), Na = class {
    componentName;
    pool;
    compatibility;
    mode;
    ...
    for (let i of e.create) {
        ...
        if (nr(i))
            for (r !== null && (r.lastSlotConsumer = i.xref); t.next !== null;) {
                ...
                let a = !1;
                if (ri(t) && t.target !== i.xref ? a = !0 : (t.kind === u.Statement || t.kind === u.Variable) && ye(t, o => { !a && ri(o) && o.target !== i.xref && (a = !0); }), a)
                    break;
                t = t.next;
            }
    }
...
function cf(n) { let e = new Map; for (let t of n.create)
        ...
        switch (s.kind) {
            ...
            case u.Property:
                if (s.bindingKind !== b.LegacyAnimation && s.bindingKind !== b.Animation) {
                    let r;
                    s.i18nMessage !== null && s.templateKind === null ? r = b.I18n : s.isStructuralTemplateAttribute ? r = b.Template : r = b.Property, w.insertBefore(ct(s.target, r, null, s.name, null, null, null, s.securityContext), Es(t, s.target));
                }
                break;
            case u.TwoWayProperty:
                w.insertBefore(ct(s.target, b.TwoWayProperty, null, s.name, null, null, null, s.securityContext), Es(t, s.target));
                break;
            case u.StyleProp:
            case u.ClassProp:
                e.job.compatibility === st.TemplateDefinitionBuilder && s.expression instanceof li && w.insertBefore(ct(s.target, b.Property, null, s.name, null, null, null, Z.STYLE), Es(t, s.target));
                break;
            case u.Listener:
                if (!s.isLegacyAnimationListener) {
                    let r = ct(s.target, b.Property, null, s.name, null, null, null, Z.NONE);
                    if (n.kind === _.Host) {
                        if (n.compatibility)
                            break;
                        e.create.push(r);
...
function av(n, e, t) { if (e.expression instanceof oe)
    ...
    let r = ct(e.target, e.isStructuralTemplateAttribute ? b.Template : b.Attribute, e.namespace, e.name, e.expression, e.i18nContext, e.i18nMessage, e.securityContext);
...
var Pu = "aria-";
function uf(n) { return n.startsWith(Pu) && n.length > Pu.length; }
function ov(n, e) { let t = n.get(e); if (t === void 0)
    throw new Error("All attributes should have an element-like target."); return t; }
function lv(n) { let e = new Map; for (let t of n.units)
    for (let s of t.create)
        In(s) && e.set(s.xref, s); for (let t of n.units)
    for (let s of t.ops())
        if (s.kind === u.Binding)
            switch (s.bindingKind) {
                case b.Attribute:
                    if (s.name === "ngNonBindable") {
                        ...
                        w.replace(s, Du(s.name, s.target, s.name === "animate.enter" ? "enter" : "leave", s.expression, s.securityContext, s.sourceSpan, 0));
                    else {
                        let [r, i] = It(s.name);
                        w.replace(s, Nu(s.target, r, i, s.expression, s.securityContext, s.isTextAttribute, s.isStructuralTemplateAttribute, s.templateKind, s.i18nMessage, s.sourceSpan));
                    }
                    break;
                case b.Animation:
                    w.replace(s, Du(s.name, s.target, s.name === "animate.enter" ? "enter" : "leave", s.expression, s.securityContext, s.sourceSpan, 1));
                    break;
                case b.Property:
                case b.LegacyAnimation:
                    n.mode === Oe.DomOnly && uf(s.name) ? w.replace(s, Nu(s.target, null, s.name, s.expression, s.securityContext, !1, s.isStructuralTemplateAttribute, s.templateKind, s.i18nMessage, s.sourceSpan)) : n.kind === _.Host ? w.replace(s, Jg(s.name, s.expression, s.bindingKind, s.i18nContext, s.securityContext, s.sourceSpan)) : w.replace(s, Cg(s.target, s.name, s.expression, s.bindingKind, s.securityContext, s.isStructuralTemplateAttribute, s.templateKind, s.i18nContext, s.i18nMessage, s.sourceSpan));
                    break;
...
var Lu = new Map([[f.ariaProperty, f.ariaProperty], [f.attribute, f.attribute], [f.classProp, f.classProp], [f.element, f.element], [f.elementContainer, f.elementContainer], [f.elementContainerEnd, f.elementContainerEnd], [f.elementContainerStart, f.elementContainerStart], [f.elementEnd, f.elementEnd], [f.elementStart, f.elementStart], [f.domProperty, f.domProperty], [f.i18nExp, f.i18nExp], [f.listener, f.listener], [f.listener, f.listener], [f.property, f.property], [f.styleProp, f.styleProp], [f.syntheticHostListener, f.syntheticHostListener], [f.syntheticHostProperty, f.syntheticHostProperty], [f.templateCreate, f.templateCreate], [f.twoWayProperty, f.twoWayProperty], [f.twoWayListener, f.twoWayListener], [f.declareLet, f.declareLet], [f.conditionalCreate, f.conditionalBranchCreate], [f.conditionalBranchCreate, f.conditionalBranchCreate], [f.domElement, f.domElement], [f.domElementStart, f.domElementStart], [f.domElementEnd, f.domElementEnd], [f.domElementContainer, f.domElementContainer], [f.domElementContainerStart, f.domElementContainerStart], [f.domElementContainerEnd, f.domElementContainerEnd], [f.domListener, f.domListener], [f.domTemplate, f.domTemplate], [f.animationEnter, f.animationEnter], [f.animationLeave, f.animationLeave], [f.animationEnterListener, f.animationEnterListener], [f.animationLeaveListener, f.animationLeaveListener]]), cv = 256;
function uv(n) { for (let e of n.units)
    Bu(e.create), Bu(e.update); }
function Bu(n) { let e = null; for (let t of n) {
    ...
    if (e !== null && Lu.get(e.instruction) === s && e.length < cv) {
...
function pv(n) { for (let e of n.units)
    for (let t of e.ops()) {
        ...
        for (let o = t.conditions.length - 1; o >= 0; o--) {
            ...
            if (l.expr !== null) {
                if (i !== null) {
                    let c = o === 0 ? i : new Tn(i.xref);
                    l.expr = new W(x.Identical, c, l.expr);
                }
                else
                    l.alias !== null && (a ??= n.allocateXrefId(), l.expr = new Wt(l.expr, a), t.contextValue = new Tn(a));
                s = new bt(l.expr, new ba(l.targetSlot), s);
            }
        }
...
function hf(n) { let e = new Map([["svg", Te.SVG], ["math", Te.Math]]); return n === null ? Te.HTML : e.get(n) ?? Te.HTML; }
function dv(n) { let e = new Map([["svg", Te.SVG], ["math", Te.Math]]); for (let [t, s] of e.entries())
    if (s === n)
        return t; return null; }
function mv(n, e) { return e === Te.HTML ? n : `:${dv(e)}:${n}`; }
...
function gv(n) { let e = new Map; for (let t of n.units)
    for (let s of t.create)
        if (s.kind === u.ExtractedAttribute) {
            let r = e.get(s.target) || new bl(n.compatibility);
    ...
    for (let t of n.units)
        for (let s of t.create)
            if (s.kind == u.Projection) {
                ...
                In(s) && (s.attributes = Mu(n, e, s.xref), s.kind === u.RepeaterCreate && s.emptyView !== null && (s.emptyAttributes = Mu(n, e, s.emptyView)));
...
function Mu(n, e, t) { let s = e.get(t); if (s !== void 0) {
    let r = Tl(s);
    if (r.entries.length > 0)
        return n.addConst(r);
} return null; }
var ds = Object.freeze([]), bl = class {
    compatibility;
    known = new Map;
    byKind = new Map;
    propertyBindings = null;
    projectAs = null;
    get attributes() { return this.byKind.get(b.Attribute) ?? ds; }
    get classes() { return this.byKind.get(b.ClassName) ?? ds; }
    get styles() { return this.byKind.get(b.StyleProperty) ?? ds; }
    get bindings() { return this.propertyBindings ?? ds; }
    get template() { return this.byKind.get(b.Template) ?? ds; }
    get i18n() { return this.byKind.get(b.I18n) ?? ds; }
    ...
    add(e, t, s, r, i) { if (!(this.compatibility === st.TemplateDefinitionBuilder && (e === b.Attribute || e === b.ClassName || e === b.StyleProperty)) && this.isKnown(e, t))
        ...
        if (i !== null) {
            ...
            o.push(hp(i, new Bs([new _r(s.value)], []), void 0, s.sourceSpan));
        }
        else
            o.push(s);
    } }
...
function Tl({ attributes: n, bindings: e, classes: t, i18n: s, projectAs: r, styles: i, template: a }) { let o = [...n]; if (r !== null) {
    let l = so(r)[0];
    o.push(d(5), Xs(l));
        ...
        switch (s.kind) {
            ...
            case u.Attribute:
                ...
                for (let a = 0; a < s.expression.expressions.length; a++) {
                    ...
                    i.push(Zp(s.i18nContext, r.target, r.xref, r.handle, o, null, s.expression.i18nPlaceholders[a], si.Creation, er.I18nAttribute, s.name, s.sourceSpan));
                }
...
function Av(n) { for (let e of n.units)
    for (let t of e.create)
        t.kind === u.Defer && (t.placeholderMinimumTime !== null && (t.placeholderConfig = new ci(Xs([t.placeholderMinimumTime]))), (t.loadingMinimumTime !== null || t.loadingAfterTime !== null) && (t.loadingConfig = new ci(Xs([t.loadingMinimumTime, t.loadingAfterTime])))); }
function _v(n) { let e = new Map; function t(r) { if (e.has(r.xref))
    return e.get(r.xref); let i = new kv; for (let a of r.create)
    if (!(!In(a) || a.localRefs === null)) {
    ...
    case J.Viewport:
        if (i.trigger.targetName === null) {
            ...
            for (let h of c.create)
                if (nr(h) && (In(h) || h.kind === u.Projection)) {
...
var kv = class {
    targets = new Map;
}, bv = new Map([[u.ElementEnd, [u.ElementStart, u.Element]], [u.ContainerEnd, [u.ContainerStart, u.Container]], [u.I18nEnd, [u.I18nStart, u.I18n]]]), Tv = new Set([u.Pipe]);
function Iv(n) { for (let e of n.units)
    for (let t of e.create) {
        let s = bv.get(t.kind);
        if (s === void 0)
...
function ze(n) { return n instanceof nn ? ze(n.expr) : n instanceof W ? ze(n.lhs) || ze(n.rhs) : n instanceof bt ? n.falseCase && ze(n.falseCase) ? !0 : ze(n.condition) || ze(n.trueCase) : n instanceof Ms ? ze(n.condition) : n instanceof Wt ? ze(n.expr) : n instanceof We ? ze(n.receiver) : n instanceof Ft ? ze(n.receiver) || ze(n.index) : n instanceof ft ? ze(n.expr) : n instanceof Fe || n instanceof dt || n instanceof Tt || n instanceof hs || n instanceof us; }
...
function Fv(n) { return n instanceof Gs ? new ft(new bt(new W(x.Equals, n.guard, xn), xn, n.expr)) : n; }
var Ru = "\uFFFD", $v = "#", Ov = "*", Vv = "/", qv = ":", Uv = "[", Hv = "]", Wv = "|";
...
function zv(n, e, t) { let s = Fu(e.params), r = Fu(e.postprocessingParams), i = [...e.params.values()].some(a => a.length > 1); return Gg(n.allocateXrefId(), e.xref, e.i18nBlock, e.message, null, s, r, i); }
...
function Fu(n) { let e = new Map; for (let [t, s] of n) {
    let r = Xv(s);
    r !== null && e.set(t, d(r));
} return e; }
function Xv(n) { if (n.length === 0)
    return null; let e = n.map(t => As(t)); return e.length === 1 ? e[0] : `${Uv}${e.join(Wv)}${Hv}`; }
function As(n) { if (n.flags & ne.ElementTag && n.flags & ne.TemplateTag) {
    if (typeof n.value != "object")
        throw Error("AssertionError: Expected i18n param value to have an element and template slot");
    let r = As(ue(S({}, n), { value: n.value.element, flags: n.flags & ~ne.TemplateTag })), i = As(ue(S({}, n), { value: n.value.template, flags: n.flags & ~ne.ElementTag }));
    return n.flags & ne.OpenTag && n.flags & ne.CloseTag ? `${i}${r}${i}` : n.flags & ne.CloseTag ? `${r}${i}` : `${i}${r}`;
} if (n.flags & ne.OpenTag && n.flags & ne.CloseTag)
    return `${As(ue(S({}, n), { flags: n.flags & ~ne.CloseTag }))}${As(ue(S({}, n), { flags: n.flags & ~ne.OpenTag }))}`; if (n.flags === ne.None)
    return `${n.value}`; let e = "", t = ""; n.flags & ne.ElementTag ? e = $v : n.flags & ne.TemplateTag && (e = Ov), e !== "" && (t = n.flags & ne.CloseTag ? Vv : ""); let s = n.subTemplateIndex === null ? "" : `${qv}${n.subTemplateIndex}`; return `${Ru}${t}${e}${n.value}${s}${Ru}`; }
function Yv(n) { for (let e of n.units) {
    ...
    for (let r of e.update) {
        let i = null;
        if (ri(r) ? i = r : ye(r, o => { i === null && ri(o) && (i = o); }), i === null)
            continue;
        if (!t.has(i.target))
...
function Qv(n) { for (let e of n.units)
    for (let t of e.update) {
        ...
        w.replace(t, fn(n.allocateXrefId(), s, new ii(t.target, t.value, t.sourceSpan), lt.None));
    } }
...
function Jv(n) { dr(n.root, null); }
function dr(n, e) { let t = Kv(n, e); for (let s of n.create)
    switch (s.kind) {
        case u.ConditionalCreate:
        case u.ConditionalBranchCreate:
        case u.Template:
            dr(n.job.views.get(s.xref), t);
            break;
        case u.Projection:
            s.fallbackView !== null && dr(n.job.views.get(s.fallbackView), t);
            break;
        case u.RepeaterCreate:
            dr(n.job.views.get(s.xref), t), s.emptyView && dr(n.job.views.get(s.emptyView), t), s.trackByOps !== null && s.trackByOps.prepend(Hi(n, t, !1));
            break;
        case u.Animation:
        case u.AnimationListener:
        case u.Listener:
...
function Hi(n, e, t) { let s = []; e.view !== n.xref && s.push(fn(n.job.allocateXrefId(), e.viewContextVariable, new Aa, lt.None)); let r = n.job.views.get(e.view); for (let [i, a] of r.contextVariables) {
    let o = new bn(e.view), l = a === lf ? o : new We(o, a);
    s.push(fn(n.job.allocateXrefId(), e.contextVariables.get(i), l, lt.None));
} for (let i of r.aliases)
    s.push(fn(n.job.allocateXrefId(), i, i.expression.clone(), lt.AlwaysInline)); for (let i of e.references)
    s.push(fn(n.job.allocateXrefId(), i.variable, new Ca(i.targetId, i.targetSlot, i.offset), lt.None)); if (e.view !== n.xref || t)
    for (let i of e.letDeclarations)
        s.push(fn(n.job.allocateXrefId(), i.variable, new ai(i.targetId, i.targetSlot), lt.None)); return e.parent !== null && s.push(...Hi(n, e.parent, !1)), s; }
function ew(n) { for (let e of n.units)
    for (let t of e.ops())
        fe(t, s => s instanceof ci ? d(n.addConst(s.expr)) : s, X.None); }
var $u = "style.", Ou = "class.", tw = "style!", Vu = "class!", qu = "!important";
function nw(n) { for (let e of n.root.update)
    if (e.kind === u.Binding && e.bindingKind === b.Property)
        if (e.name.endsWith(qu) && (e.name = e.name.substring(0, e.name.length - qu.length)), e.name.startsWith($u)) {
            e.bindingKind = b.StyleProperty, e.name = e.name.substring($u.length), sw(e.name) || (e.name = rw(e.name));
            let { property: t, suffix: s } = yo(e.name);
            e.name = t, e.unit = s;
        }
        else
            e.name.startsWith(tw) ? (e.bindingKind = b.StyleProperty, e.name = "style") : e.name.startsWith(Ou) ? (e.bindingKind = b.ClassName, e.name = yo(e.name.substring(Ou.length)).property) : e.name.startsWith(Vu) && (e.bindingKind = b.ClassName, e.name = yo(e.name.substring(Vu.length)).property); }
...
function aw(n, e, t, s = {}) { let r = new Pl(new ti(n, e), t, s); return r.tokenize(), new Nl(gw(r.tokens), r.errors, r.nonNormalizedIcuExpressions); }
var ow = /\r\n?/g;
function gs(n) { return `Unexpected character "${n === _e ? "EOF" : String.fromCharCode(n)}"`; }
function Hu(n) { return `Unknown entity "${n}" - use the "&#<decimal>;" or  "&#x<hex>;" syntax`; }
...
`);
    ...
    _consumeBlockParameters() { for (this._attemptCharCodeUntilFn(ju); this._cursor.peek() !== Pe && this._cursor.peek() !== _e;) {
        this._beginToken(27);
        ...
        this._endToken([this._cursor.getChars(e)]), this._attemptCharCodeUntilFn(ju);
    } }
    _consumeLetDeclaration(e) { if (this._requireStr("@let"), this._beginToken(29, e), ei(this._cursor.peek()))
        this._attemptCharCodeUntilFn(re);
    else {
        let r = this._endToken([this._cursor.getChars(e)]);
        r.type = 32;
        return;
    } let t = this._endToken([this._getLetDeclarationName()]); if (this._attemptCharCodeUntilFn(re), !this._attemptCharCode(be)) {
        t.type = 32;
        return;
    ...
    _consumeLetDeclarationValue() { let e = this._cursor.clone(); for (this._beginToken(30, e); this._cursor.peek() !== _e;) {
        ...
        if (t === Ye)
            break;
        Er(t) && (this._cursor.advance(), this._attemptCharCodeUntilFn(s => s === Is ? (this._cursor.advance(), !1) : s === t)), this._cursor.advance();
    ...
    handleError(e) { if (e instanceof fi && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof N)
        this.errors.push(e);
    else
        throw e; }
    ...
    _consumeEntity(e) { this._beginToken(9); let t = this._cursor.clone(); if (this._cursor.advance(), this._attemptCharCode(Np)) {
        let s = this._attemptCharCode($p) || this._attemptCharCode(Lm), r = this._cursor.clone();
        ...
        try {
            ...
            throw this._createError(Hu(this._cursor.getChars(t)), this._cursor.getSpan());
        }
    }
    else {
        ...
        if (this._attemptCharCodeUntilFn(pw), this._cursor.peek() != Ye)
            ...
            this._cursor.advance();
            let i = pi.hasOwnProperty(r) && pi[r];
            if (!i)
                throw this._createError(Hu(r), this._cursor.getSpan(t));
            this._endToken([i, `&${r};`]);
        }
    } }
    ...
    _consumeComponentName() { let e = this._cursor.clone(); for (; zu(this._cursor.peek());)
    ...
    _consumeAttribute() { this._consumeAttributeName(), this._attemptCharCodeUntilFn(re), this._attemptCharCode(be) && (this._attemptCharCodeUntilFn(re), this._consumeAttributeValue()), this._attemptCharCodeUntilFn(re); }
    _consumeAttributeName() { let e = this._cursor.peek(); if (e === Kr || e === Jr)
        ...
        let r = 0;
        t = i => (i === gn ? r++ : i === Hn && r--, r <= 0 ? Mn(i) : Ea(i));
    }
    else
        t = Mn; let s = this._consumePrefixAndName(t); this._endToken(s); }
    _consumeAttributeValue() { if (this._cursor.peek() === Kr || this._cursor.peek() === Jr) {
    ...
    _consumeInterpolation(e, t, s) { let r = []; this._beginToken(e, t), r.push(this._interpolationConfig.start); let i = this._cursor.clone(), a = null, o = !1; for (; this._cursor.peek() !== _e && (s === null || !s());) {
        ...
        this._cursor.advance(), c === Is ? this._cursor.advance() : c === a ? a = null : !o && a === null && Er(c) && (a = c);
    } r.push(this._getProcessedChars(i, this._cursor)), this._endToken(r); }
    _consumeDirective(e, t) { for (this._requireCharCode(fs), this._cursor.advance(); zu(this._cursor.peek());)
        ...
        for (this._openDirectiveCount++, this._beginToken(39), this._cursor.advance(), this._endToken([]), this._attemptCharCodeUntilFn(re); !Gu(this._cursor.peek()) && this._cursor.peek() !== Pe;)
            this._consumeAttribute();
    ...
    _isTagStart() { if (this._cursor.peek() === Ts) {
        let e = this._cursor.clone();
        e.advance();
        let t = e.peek();
        if (as <= t && t <= Ai || Pn <= t && t <= Ks || t === Et || t === ml)
            return !0;
    } return !1; }
...
function re(n) { return !ei(n) || n === _e; }
function Mn(n) { return ei(n) || n === it || n === Ts || n === Et || n === Kr || n === Jr || n === be || n === _e; }
function uw(n) { return (n < as || Ai < n) && (n < Pn || Ks < n) && (n < qc || n > Pp); }
function hw(n) { return n === Ye || n === _e || !Fm(n); }
function pw(n) { return n === Ye || n === _e || !Hs(n); }
function fw(n) { return n !== Le; }
function dw(n, e) { return Wu(n) === Wu(e); }
function Wu(n) { return n >= as && n <= Ai ? n - as + Pn : n; }
function mw(n) { return Hs(n) || St(n) || n === Ln; }
function ju(n) { return n !== Ye && re(n); }
function Ti(n) { return n === Ln || n >= Pn && n <= Ks; }
function zu(n) { return Hs(n) || St(n) || n === Ln; }
function Gu(n) { return n === Et || n === it || n === Ts || n === _e; }
...
var Fa = class n {
    ...
    advanceState(e) { if (e.offset >= this.end)
        throw this.state = e, new fi('Unexpected character "EOF"', this); let t = this.charAt(e.offset); t === Xn ? (e.line++, e.column = 0) : Ea(t) || e.column++, e.offset++, this.updatePeek(e); }
    ...
    processEscapeSequence() { let e = () => this.internalState.peek; if (e() === Is)
        if (this.internalState = S({}, this.state), this.advanceState(this.internalState), e() === Lp)
            this.state.peek = Xn;
        else if (e() === Bp)
            this.state.peek = Vc;
        else if (e() === Fp)
    ...
    decodeHexDigits(e, t) { let s = this.input.slice(e.internalState.offset, e.internalState.offset + t), r = parseInt(s, 16); if (isNaN(r))
        throw e.state = e.internalState, new fi("Invalid hexadecimal escape sequence", e); return r; }
    ...
    _consumeExpansion(e) { let t = this._advance(), s = this._advance(), r = []; for (; this._peek.type === 20;) {
        ...
        return;
    } let i = new L(e.sourceSpan.start, this._peek.sourceSpan.end, e.sourceSpan.fullStart); this._addToParent(new vn(t.parts[0], s.parts[0], r, i, t.sourceSpan)), this._advance(); }
    _parseExpansionCase() { let e = this._advance(); if (this._peek.type !== 21)
        ...
        return this.errors = this.errors.concat(i.errors), null; let a = new L(e.sourceSpan.start, r.sourceSpan.end, e.sourceSpan.fullStart), o = new L(t.sourceSpan.start, r.sourceSpan.end, t.sourceSpan.fullStart); return new hi(e.parts[0], i.rootNodes, a, e.sourceSpan, o); }
...
`) {
        ...
        for (; this._peek.type === 8 || this._peek.type === 5 || this._peek.type === 9;)
            e = this._advance(), t.push(e), e.type === 8 ? r += e.parts.join("").replace(/&([^;]+);/g, Yu) : e.type === 9 ? r += e.parts[0] : r += e.parts.join("");
        if (r.length > 0) {
            let i = e.sourceSpan;
            this._addToParent(new an(r, new L(s.start, i.end, s.fullStart, s.details), t));
        }
    }
    ...
    _consumeAttr(e) { let t = Ui(e.parts[0], e.parts[1]), s = e.sourceSpan.end; this._peek.type === 15 && this._advance(); let r = "", i = [], a, o; if (this._peek.type === 16)
        for (a = this._peek.sourceSpan, o = this._peek.sourceSpan.end; this._peek.type === 16 || this._peek.type === 17 || this._peek.type === 9;) {
            let h = this._advance();
            i.push(h), h.type === 17 ? r += h.parts.join("").replace(/&([^;]+);/g, Yu) : h.type === 9 ? r += h.parts[0] : r += h.parts.join(""), o = s = h.sourceSpan.end;
        } this._peek.type === 15 && (s = this._advance().sourceSpan.end); let c = a && o && new L(a.start, o, a.fullStart); return new wn(t, r, new L(e.sourceSpan.start, s, e.sourceSpan.fullStart), e.sourceSpan, c, i.length > 0 ? i : void 0, void 0); }
...
function Xu(n, e) { return n.length > 0 && n[n.length - 1] === e; }
function Yu(n, e) { return pi[e] !== void 0 ? pi[e] || n : /^#x[a-f0-9]+$/i.test(e) ? String.fromCodePoint(parseInt(e.slice(2), 16)) : /^#\d+$/.test(e) ? String.fromCodePoint(parseInt(e.slice(1), 10)) : n; }
var gf = "ngPreserveWhitespaces", Qu = new Set(["pre", "template", "textarea", "script", "style"]), vf = ` \f
\r	\v\u1680\u180E\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF`, vw = new RegExp(`[^${vf}]`), ww = new RegExp(`[${vf}]{2,}`, "g");
function Zu(n) { return n.some(e => e.name === gf); }
...
var di = class {
    ...
    visitElement(e, t) { if (Qu.has(e.name) || Zu(e.attrs)) {
    ...
    visitText(e, t) { let s = e.value.match(vw), r = t && (t.prev instanceof vn || t.next instanceof vn); if (this.icuExpansionDepth > 0 && this.preserveSignificantWhitespace)
        return e; if (s || r) {
        ...
        let o = Sf(e.value), l = this.preserveSignificantWhitespace ? o : xw(o, t), c = new an(l, e.sourceSpan, a, e.i18n);
        return this.originalNodeMap?.set(c, e), c;
    } return null; }
    visitComment(e, t) { return e; }
    visitExpansion(e, t) { this.icuExpansionDepth++; let s; try {
        s = new vn(e.switchValue, e.type, wt(this, e.cases), e.sourceSpan, e.switchValueSourceSpan, e.i18n);
    }
    finally {
        this.icuExpansionDepth--;
    } return this.originalNodeMap?.set(s, e), s; }
    visitExpansionCase(e, t) { let s = new hi(e.value, wt(this, e.expression), e.sourceSpan, e.valueSourceSpan, e.expSourceSpan); return this.originalNodeMap?.set(s, e), s; }
    ...
    visitComponent(e, t) { if (e.tagName && Qu.has(e.tagName) || Zu(e.attrs)) {
...
function bw(n, e, t) { return new Nt(n, e, O.Number, t, ""); }
function Tw(n, e, t) { return new Nt(n, e, O.Error, 0, t); }
var Ii = new Nt(-1, -1, O.Character, 0, ""), Ml = class {
    input;
    tokens = [];
    length;
    peek = 0;
    ...
    scanToken() { let e = this.input, t = this.length, s = this.peek, r = this.index; for (; s <= Ip;)
        if (++r >= t) {
            s = _e;
            break;
        }
        ...
        case fr: return this.advance(), St(this.peek) ? this.scanNumber(i) : or(i, this.index, fr);
        case At:
        case Pe:
        case gn:
        case Hn:
        ...
        case Kr:
        case Jr: return this.scanString();
        case gl: return this.advance(), this.scanTemplateLiteralPart(i);
        case Np: return this.scanPrivateIdentifier();
        case Dp: return this.scanComplexOperator(i, "+", be, "=");
        case wa: return this.scanComplexOperator(i, "-", be, "=");
        case Et: return this.scanComplexOperator(i, "/", be, "=");
        case Im: return this.scanComplexOperator(i, "%", be, "=");
        case Bm: return this.scanOperator(i, "^");
        case wu: return this.scanStar(i);
        case Eu: return this.scanQuestion(i);
        case Ts:
        case it: return this.scanComplexOperator(i, String.fromCharCode(s), be, "=");
        case ml:
        case be: return this.scanComplexOperator(i, String.fromCharCode(s), be, "=", be, "=");
        case va: return this.scanComplexOperator(i, "&", va, "&", be, "=");
        case Su: return this.scanComplexOperator(i, "|", Su, "|", be, "=");
        case Op:
            for (; ei(this.peek);)
                this.advance();
    ...
    scanIdentifier() { let e = this.index; for (this.advance(); Ku(this.peek);)
        this.advance(); let t = this.input.substring(e, this.index); return Cw.indexOf(t) > -1 ? kw(e, this.index, t) : Aw(e, this.index, t); }
    scanPrivateIdentifier() { let e = this.index; if (this.advance(), !Ju(this.peek))
        return this.error("Invalid character [#]", -1); for (; Ku(this.peek);)
    ...
    scanNumber(e) { let t = this.index === e, s = !1; for (this.advance();;) {
        if (!St(this.peek))
            if (this.peek === Ln) {
                ...
                break;
        this.advance();
    } let r = this.input.substring(e, this.index); s && (r = r.replace(/_/g, "")); let i = t ? Pw(r) : parseFloat(r); return bw(e, this.index, i); }
    scanString() { let e = this.index, t = this.peek; this.advance(); let s = "", r = this.index, i = this.input; for (; this.peek != t;)
        if (this.peek == Is) {
            ...
            this.advance();
        } let a = i.substring(r, this.index); return this.advance(), new Sr(e, this.index, s + a, Yn.Plain); }
    scanQuestion(e) { this.advance(); let t = "?"; return this.peek === Eu ? (t += "?", this.advance(), this.peek === be && (t += "=", this.advance())) : this.peek === fr && (t += ".", this.advance()), lr(e, this.index, t); }
    scanTemplateLiteralPart(e) { let t = "", s = this.index; for (; this.peek !== gl;)
        if (this.peek === Is) {
            ...
            if (this.advance(), this.peek === yt)
                return this.braceStack.push("interpolation"), this.tokens.push(new Sr(e, i, t + this.input.substring(s, i), Yn.TemplateLiteralPart)), this.advance(), lr(i, this.index, this.input.substring(i, this.index));
        }
        else {
            if (this.peek === _e)
                return this.error("Unterminated template literal", 0);
            this.advance();
        } let r = this.input.substring(s, this.index); return this.advance(), new Sr(e, this.index, t + r, Yn.TemplateLiteralEnd); }
    error(e, t) { let s = this.index + t; return Tw(s, this.index, `Lexer Error: ${e} at column ${s} in expression [${this.input}]`); }
    scanStringBackslash(e, t) { e += this.input.substring(t, this.index); let s; if (this.advance(), this.peek === Rp) {
    ...
    scanStar(e) { this.advance(); let t = "*"; return this.peek === wu ? (t += "*", this.advance(), this.peek === be && (t += "=", this.advance())) : this.peek === be && (t += "=", this.advance()), lr(e, this.index, t); }
};
function Ju(n) { return as <= n && n <= Ai || Pn <= n && n <= Ks || n == Ln || n == co; }
function Ku(n) { return Hs(n) || St(n) || n == Ln || n == co; }
function Iw(n) { return n == Rm || n == Dm; }
function Nw(n) { return n == wa || n == Dp; }
...
function pn(n) { return n.start.toString() || "(unknown)"; }
var $a = class {
    _lexer;
    _supportsDirectPipeReferences;
    constructor(e, t = !1) { this._lexer = e, this._supportsDirectPipeReferences = t; }
    parseAction(e, t, s, r = ot) { let i = []; this._checkNoInterpolation(i, e, t, r); let { stripped: a } = this._stripComments(e), o = this._lexer.tokenize(a), l = new Vn(e, t, s, o, 1, i, 0, this._supportsDirectPipeReferences).parseChain(); return new Xe(l, e, pn(t), s, i); }
    parseBinding(e, t, s, r = ot) { let i = [], a = this._parseBindingAst(e, t, s, r, i); return new Xe(a, e, pn(t), s, i); }
    checkSimpleExpression(e) { let t = new $l; return e.visit(t), t.errors; }
    parseSimpleBinding(e, t, s, r = ot) { let i = [], a = this._parseBindingAst(e, t, s, r, i), o = this.checkSimpleExpression(a); return o.length > 0 && i.push(_s(`Host binding expression cannot contain ${o.join(" ")}`, e, "", t)), new Xe(a, e, pn(t), s, i); }
    ...
    parseInterpolation(e, t, s, r, i = ot) { let a = [], { strings: o, expressions: l, offsets: c } = this.splitInterpolation(e, t, a, r, i); if (l.length === 0)
        ...
        let g = r?.[p * 2 + 1]?.sourceSpan, v = l[p].text, { stripped: E, hasComments: C } = this._stripComments(v), T = this._lexer.tokenize(E);
        if (C && E.trim().length === 0 && T.length === 0) {
            a.push(_s("Interpolation expression cannot only contain a comment", e, `at column ${l[p].start} in`, t));
            continue;
        }
        let A = new Vn(g ? v : e, g || t, s, T, 0, a, c[p], this._supportsDirectPipeReferences).parseChain();
        h.push(A);
    } return this.createInterpolationAst(o.map(p => p.text), h, e, pn(t), s, a); }
    parseInterpolationExpression(e, t, s) { let { stripped: r } = this._stripComments(e), i = this._lexer.tokenize(r), a = [], o = new Vn(e, t, s, i, 0, a, 0, this._supportsDirectPipeReferences).parseChain(), l = ["", ""]; return this.createInterpolationAst(l, [o], e, pn(t), s, a); }
    createInterpolationAst(e, t, s, r, i, a) { let o = new ns(0, s.length), l = new yi(o, o.toAbsolute(i), e, t); return new Xe(l, s, r, i, a); }
    splitInterpolation(e, t, s, r, i = ot) { let a = [], o = [], l = [], c = r ? Lw(r) : null, h = 0, p = !1, g = !1, { start: v, end: E } = i; for (; h < e.length;)
        if (p) {
            let C = h, T = C + v.length, A = this._getInterpolationEndIndex(e, E, T);
            if (A === -1) {
                p = !1, g = !0;
                break;
            }
            let F = A + E.length, te = e.substring(T, A);
            te.trim().length === 0 && s.push(_s("Blank expressions are not allowed in interpolated strings", e, `at column ${h} in`, t)), o.push({ text: te, start: C, end: F });
            ...
            let T = e.substring(C, h);
            a.push({ text: T, start: C, end: h }), p = !0;
        } if (!p)
        if (g) {
            let C = a[a.length - 1];
    ...
    wrapLiteralPrimitive(e, t, s) { let r = new ns(0, e == null ? 0 : e.length); return new Xe(new Ge(r, r.toAbsolute(s), e), e, typeof t == "string" ? t : pn(t), s, []); }
    ...
    *_forEachUnquotedChar(e, t) { let s = null, r = 0; for (let i = t; i < e.length; i++) {
        let a = e[i];
        Er(e.charCodeAt(i)) && (s === null || s === a) && r % 2 === 0 ? s = s === null ? a : null : s === null && (yield i), r = a === "\\" ? r + 1 : 0;
    } }
}, mr = (function (n) { return n[n.None = 0] = "None", n[n.Writable = 1] = "Writable", n; })(mr || {}), Vn = class {
    input;
    parseSourceSpan;
    absoluteOffset;
    tokens;
    ...
    peek(e) { let t = this.index + e; return t < this.tokens.length ? this.tokens[t] : Ii; }
    ...
    prettyPrintToken(e) { return e === Ii ? "end of input" : `token ${e}`; }
    ...
    parseExponentiation() { let e = this.inputIndex, t = this.parsePrefix(); for (; this.next.type == O.Operator && this.next.strValue === "**";) {
        (t instanceof bs || t instanceof Br || t instanceof Mr || t instanceof Rr) && this.error("Unary operator used immediately before exponentiation expression. Parenthesis must be used to disambiguate operator precedence"), this.advance();
    ...
    parsePrefix() { if (this.next.type == O.Operator) {
        ...
        switch (t) {
            case "+": return this.advance(), s = this.parsePrefix(), bs.createPlus(this.span(e), this.sourceSpan(e), s);
            case "-": return this.advance(), s = this.parsePrefix(), bs.createMinus(this.span(e), this.sourceSpan(e), s);
        ...
        this.advance();
        let e = this.inputIndex, t = this.parsePrefix();
        return new Rr(this.span(e), this.sourceSpan(e), t);
    } return this.parseCallChain(); }
    parseCallChain() { let e = this.inputIndex, t = this.parsePrimary(); for (;;)
        if (this.consumeOptionalCharacter(fr))
            t = this.parseAccessMember(t, e, !1);
        else if (this.consumeOptionalOperator("?."))
            this.consumeOptionalCharacter(At) ? t = this.parseCall(t, e, !0) : t = this.consumeOptionalCharacter(gn) ? this.parseKeyedReadOrWrite(t, e, !0) : this.parseAccessMember(t, e, !0);
        else if (this.consumeOptionalCharacter(gn))
            t = this.parseKeyedReadOrWrite(t, e, !1);
        else if (this.consumeOptionalCharacter(At))
            t = this.parseCall(t, e, !1);
        else if (this.consumeOptionalOperator("!"))
            t = new Fr(this.span(e), this.sourceSpan(e), t);
    ...
    parsePrimary() { let e = this.inputIndex; if (this.consumeOptionalCharacter(At)) {
        ...
        return this.consumeOptionalCharacter(Pe) || (this.error("Missing closing parentheses"), this.consumeOptionalCharacter(Pe)), this.rparensExpected--, new Vr(this.span(e), this.sourceSpan(e), t);
    }
    else {
        ...
        if (this.consumeOptionalCharacter(gn)) {
    ...
    parseAccessMember(e, t, s) { let r = this.inputIndex, i = this.withContext(mr.Writable, () => { let o = this.expectIdentifierOrKeyword() ?? ""; return o.length === 0 && this.error("Expected identifier for property access", e.span.end), o; }), a = this.sourceSpan(r); if (s)
        return this.isAssignmentOperator(this.next) ? (this.advance(), this.error("The '?.' operator cannot be used in the assignment"), new $e(this.span(t), this.sourceSpan(t))) : new Pr(this.span(t), this.sourceSpan(t), a, e, i); if (this.isAssignmentOperator(this.next)) {
    ...
    parseKeyedReadOrWrite(e, t, s) { return this.withContext(mr.Writable, () => { this.rbracketsExpected++; let r = this.parsePipe(); if (r instanceof $e && this.error("Key access cannot be empty"), this.rbracketsExpected--, this.expectCharacter(Hn), this.isAssignmentOperator(this.next)) {
        ...
        return s ? new Lr(this.span(t), this.sourceSpan(t), e, r) : new rs(this.span(t), this.sourceSpan(t), e, r); return new $e(this.span(t), this.sourceSpan(t)); }); }
    ...
    getDirectiveBoundTarget() { if (this.next === Ii || this.peekKeywordAs() || this.peekKeywordLet())
        return null; let e = this.parsePipe(), { start: t, end: s } = e.span, r = this.input.substring(t, s); return new Xe(e, r, pn(this.parseSourceSpan), this.absoluteOffset + t, this.errors); }
    parseAsBinding(e) { if (!this.peekKeywordAs())
        return null; this.advance(); let t = this.expectTemplateBindingKey(); this.consumeStatementTerminator(); let s = new Ze(e.span.start, this.currentAbsoluteOffset); return new qr(s, t, e); }
    parseLetBinding() { if (!this.peekKeywordLet())
        return null; let e = this.currentAbsoluteOffset; this.advance(); let t = this.expectTemplateBindingKey(), s = null; this.consumeOptionalOperator("=") && (s = this.expectTemplateBindingKey()), this.consumeStatementTerminator(); let r = new Ze(e, this.currentAbsoluteOffset); return new qr(r, t, s); }
    parseNoInterpolationTaggedTemplateLiteral(e, t) { let s = this.parseNoInterpolationTemplateLiteral(); return new $r(this.span(t), this.sourceSpan(t), e, s); }
    parseNoInterpolationTemplateLiteral() { let e = this.next.strValue, t = this.inputIndex; this.advance(); let s = this.span(t), r = this.sourceSpan(t); return new Or(s, r, [new ia(s, r, e)], []); }
    parseTaggedTemplateLiteral(e, t) { let s = this.parseTemplateLiteral(); return new $r(this.span(t), this.sourceSpan(t), e, s); }
    parseTemplateLiteral() { let e = [], t = [], s = this.inputIndex; for (; this.next !== Ii;) {
        let r = this.next;
        if (r.isTemplateLiteralPart() || r.isTemplateLiteralEnd()) {
            ...
            this.advance();
    } return new Or(this.span(s), this.sourceSpan(s), e, t); }
    ...
    skip() { let e = this.next; for (; this.index < this.tokens.length && !e.isCharacter(Ye) && !e.isOperator("|") && (this.rparensExpected <= 0 || !e.isCharacter(Pe)) && (this.rbracesExpected <= 0 || !e.isCharacter(Le)) && (this.rbracketsExpected <= 0 || !e.isCharacter(Hn)) && (!(this.context & mr.Writable) || !this.isAssignmentOperator(e));)
...
function _s(n, e, t, s) { t.length > 0 && (t = ` ${t} `); let r = pn(s), i = `Parser Error: ${n}${t}[${e}] in ${r}`; return new N(s, i); }
var $l = class extends Ur {
    errors = [];
...
var Vl = class {
    ...
    constructor() { super(), qw.forEach(e => { let t = new Map, s = new Set, [r, i] = e.split("|"), a = i.split(","), [o, l] = r.split("^"); o.split(",").forEach(h => { this._schema.set(h.toLowerCase(), t), this._eventSchema.set(h.toLowerCase(), s); }); let c = l && this._schema.get(l.toLowerCase()); if (c) {
        ...
        switch (h[0]) {
            case "*":
                ...
                break;
            case "!":
                t.set(h.substring(1), Fw);
                break;
            case "#":
                t.set(h.substring(1), $w);
                break;
            case "%":
    ...
    hasElement(e, t) { return t.some(s => s.name === Oo.name) || e.indexOf("-") > -1 && (fu(e) || Ko(e) || t.some(s => s.name === $o.name)) ? !0 : this._schema.has(e.toLowerCase()); }
    securityContext(e, t, s) { s && (t = this.getMappedPropName(t)), e = e.toLowerCase(), t = t.toLowerCase(); let r = eh()[e + "|" + t]; return r || (r = eh()["*|" + t], r || Z.NONE); }
...
If '${e}' is a directive input, make sure the directive is imported by the current module.` } : { error: !1 };
    ...
    allKnownAttributesOfElement(e) { let t = this._schema.get(e.toLowerCase()) || this._schema.get("unknown"); return Array.from(t.keys()).map(s => Uw.get(s) ?? s); }
    ...
    normalizeAnimationStyleValue(e, t, s) { let r = "", i = s.toString().trim(), a = null; if (Hw(e) && s !== 0 && s !== "0")
        if (typeof s == "number")
            r = "px";
        else {
            let o = s.match(/^[+-]?[\d\.]+([a-z]*)$/);
...
function yf(n, e, t, s) { let r = new Hl(Ww, n, e, t, s); return (i, a, o, l, c) => r.toI18nMessage(i, a, o, l, c); }
function jw(n, e) { return e; }
var Hl = class {
    _expressionParser;
    _interpolationConfig;
    _containerBlocks;
    ...
    toI18nMessage(e, t = "", s = "", r = "", i) { let a = { isIcu: e.length == 1 && e[0] instanceof vn, icuDepth: 0, placeholderRegistry: new Ul, placeholderToContent: {}, placeholderToMessage: {}, visitNodeFn: i || jw }, o = P(this, e, a); return new Ie(o, a.placeholderToContent, a.placeholderToMessage, t, s, r); }
    ...
    visitExpansion(e, t) { t.icuDepth++; let s = {}, r = new _n(e.switchValue, e.type, s, e.sourceSpan); if (e.cases.forEach(o => { s[o.value] = new et(o.expression.map(l => l.visit(this, t)), o.expSourceSpan); }), t.icuDepth--, t.isIcu || t.icuDepth > 0) {
    ...
    } let i = t.placeholderRegistry.getPlaceholderName("ICU", e.sourceSpan.toString()); t.placeholderToMessage[i] = this.toI18nMessage([e], "", "", "", void 0); let a = new kn(r, i, e.sourceSpan); return t.visitNodeFn(e, a); }
    ...
    _visitTextWithInterpolation(e, t, s, r) { let i = [], a = !1; for (let o of e)
        switch (o.type) {
            ...
            case 17:
                a = !0;
                let [l, c, h] = o.parts, p = Qw(c) || "INTERPOLATION", g = s.placeholderRegistry.getPlaceholderName(p, c);
            ...
            default:
                ...
                break;
        } return a ? (zw(i, r), new et(i, t)) : i[0]; }
...
function zw(n, e) { if (e instanceof Ie && (Gw(e), e = e.nodes[0]), e instanceof et) {
    Xw(e.children, n);
    for (let t = 0; t < n.length; t++)
        n[t].sourceSpan = e.children[t].sourceSpan;
} }
function Gw(n) { let e = n.nodes; if (e.length !== 1 || !(e[0] instanceof et))
...
var Yw = /\/\/[\s\S]*i18n[\s\S]*\([\s\S]*ph[\s\S]*=[\s\S]*("|')([\s\S]*?)\1[\s\S]*\)/g;
function Qw(n) { return n.split(Yw)[2]; }
var sh = new Set(["iframe|srcdoc", "*|innerhtml", "*|outerhtml", "embed|src", "iframe|src", "object|codebase", "object|data"]);
function rh(n, e) { return n = n.toLowerCase(), e = e.toLowerCase(), sh.has(n + "|" + e) || sh.has("*|" + e); }
var Zw = n => (e, t) => { let s = n.get(e) ?? e; return s instanceof rn && (t instanceof kn && s.i18n instanceof Ie && (t.previousMessage = s.i18n), s.i18n = t), t; }, Oa = class {
    interpolationConfig;
    keepI18nAttrs;
    ...
    hasI18nMeta = !1;
    _errors = [];
    constructor(e = ot, t = !1, s = !1, r = kp, i = !0, a = !i) { this.interpolationConfig = e, this.keepI18nAttrs = t, this.enableI18nLegacyMessageIdFormat = s, this.containerBlocks = r, this.preserveSignificantWhitespace = i, this.retainEmptyTokens = a; }
    ...
    visitExpansion(e, t) { let s, r = e.i18n; if (this.hasI18nMeta = !0, r instanceof kn) {
        let i = r.name;
    ...
    _visitElementLike(e) { let t; if (Cm(e)) {
        ...
        for (let i of e.attrs)
            if (i.name === xp) {
                let a = e.i18n || i.value, o = new Map, l = this.preserveSignificantWhitespace ? e.children : wt(new di(!1, o), e.children);
                t = this._generateI18nMessage(l, a, Zw(o)), t.nodes.length === 0 && (t = void 0), e.i18n = t;
            }
            else if (i.name.startsWith(fl)) {
                let a = i.name.slice(fl.length), o;
                e instanceof Ce ? o = e.tagName === null ? !1 : rh(e.tagName, a) : o = rh(e.name, a), o ? this._reportError(i, `Translating attribute '${a}' is disallowed for security reasons.`) : r[a] = i.value;
            }
            else
                s.push(i);
    ...
    _parseMetadata(e) { return typeof e == "string" ? eE(e) : e instanceof Ie ? e : {}; }
    _setMessageId(e, t) { e.id || (e.id = t instanceof Ie && t.id || bc(e)); }
    _setLegacyIds(e, t) { if (this.enableI18nLegacyMessageIdFormat)
        e.legacyIds = [np(e), sp(e)];
    else if (typeof t != "string") {
        let s = t instanceof Ie ? t : t instanceof kn ? t.previousMessage : void 0;
        e.legacyIds = s ? s.legacyIds : [];
    } }
    _reportError(e, t) { this._errors.push(new N(e.sourceSpan, t)); }
}, Jw = "|", Kw = "@@";
function eE(n = "") { let e, t, s; if (n = n.trim(), n) {
    let r = n.indexOf(Kw), i = n.indexOf(Jw), a;
    [a, e] = r > -1 ? [n.slice(0, r), n.slice(r + 2)] : [n, ""], [t, s] = i > -1 ? [a.slice(0, i), a.slice(i + 1)] : ["", a];
} return { customId: e, meaning: t, description: s }; }
function tE(n) { let e = []; return n.description ? e.push({ tagName: "desc", text: n.description }) : e.push({ tagName: "suppress", text: "{msgDescriptions}" }), n.meaning && e.push({ tagName: "meaning", text: n.meaning }), cp(e); }
var nE = "goog.getMsg";
function sE(n, e, t, s) { let r = iE(e), i = [d(r)]; Object.keys(s).length && (i.push(La(Mc(s, !0), !0)), i.push(La({ original_code: he(Object.keys(s).map(l => ({ key: Ci(l), quoted: !0, value: e.placeholders[l] ? d(e.placeholders[l].sourceSpan.toString()) : d(e.placeholderToMessage[l].nodes.map(c => c.sourceSpan.toString()).join("")) }))) }))); let a = new ce(t.name, D(nE).callFn(i), qe, le.Final); a.addLeadingComment(tE(e)); let o = new nt(n.set(t)); return [a, o]; }
var Wl = class {
    formatPh(e) { return `{$${Ci(e)}}`; }
    visitText(e) { return e.value; }
    visitContainer(e) { return e.children.map(t => t.visit(this)).join(""); }
...
function iE(n) { return n.nodes.map(e => e.visit(rE, null)).join(""); }
function aE(n, e, t) { let { messageParts: s, placeHolders: r } = oE(e), i = lE(e), a = r.map(c => t[c.text]), o = pp(e, s, r, a, i), l = n.set(o); return [new nt(l)]; }
var jl = class {
    placeholderToMessage;
    pieces;
    constructor(e, t) { this.placeholderToMessage = e, this.pieces = t; }
    visitText(e) { if (this.pieces[this.pieces.length - 1] instanceof mn)
        ...
        this.pieces.push(new mn(e.value, t));
    } }
    visitContainer(e) { e.children.forEach(t => t.visit(this)); }
    visitIcu(e) { this.pieces.push(new mn(ff(e), e.sourceSpan)); }
    ...
    createPlaceholderPiece(e, t, s) { return new zn(Ci(e, !1), t, s); }
};
function oE(n) { let e = [], t = new jl(n.placeholderToMessage, e); return n.nodes.forEach(s => s.visit(t)), cE(e); }
function lE(n) { let e = n.nodes[0], t = n.nodes[n.nodes.length - 1]; return new L(e.sourceSpan.fullStart, t.sourceSpan.end, e.sourceSpan.fullStart, e.sourceSpan.details); }
function cE(n) { let e = [], t = []; n[0] instanceof zn && e.push(Co(n[0].sourceSpan.start)); for (let s = 0; s < n.length; s++) {
    let r = n[s];
    r instanceof mn ? e.push(r) : (t.push(r), n[s - 1] instanceof zn && e.push(Co(n[s - 1].sourceSpan.end)));
} return n[n.length - 1] instanceof zn && e.push(Co(n[n.length - 1].sourceSpan.end)), { messageParts: e, placeHolders: t }; }
function Co(n) { return new mn("", new L(n, n)); }
var ih = "ngI18nClosureMode", uE = "i18n_", hE = "I18N_EXP_", ah = "\uFFFD", pE = "MSG_";
function oh(n) { return `${pE}${n}`.toUpperCase(); }
function fE(n) { return new ce(n.name, void 0, qe, void 0, n.sourceSpan); }
function dE(n) { let e = n.relativeContextFilePath.replace(/[^A-Za-z0-9]/g, "_").toUpperCase() + "_", t = new Map, s = new Map, r = new Map, i = new Map; for (let l of n.units)
    for (let c of l.ops())
...
} mE(s, i), s.params = new Map([...s.params.entries()].sort()); let a = D(n.pool.uniqueName(uE)), o = wE(n.pool, s.message.id, e, n.i18nUseExternalIds), l; if (s.needsPostprocessing || s.postprocessingParams.size > 0) {
...
} return r.push(...gE(s.message, a, o, s.params, l)), { mainVar: a, statements: r }; }
function mE(n, e) { for (let [t, s] of e)
    s.length === 1 ? n.params.set(t, s[0]) : (n.params.set(t, d(`${ah}${hE}${t}${ah}`)), n.postprocessingParams.set(t, R(s))); }
function gE(n, e, t, s, r) { let i = Object.fromEntries(s), a = [fE(e), xi(vE(), sE(e, n, t, i), aE(e, n, Mc(i, !1)))]; return r && a.push(new nt(e.set(r(e)))), a; }
function vE() { return Js(D(ih)).notIdentical(d("undefined", io)).and(D(ih)); }
function wE(n, e, t, s) { let r, i = t; if (s) {
    let a = oh("EXTERNAL_"), o = n.uniqueName(i);
    r = `${a}${On(e)}$$${o}`;
}
else {
    let a = oh(i);
    ...
    for (let o of e.update)
        switch (o.kind) {
            case u.InterpolateText:
                if (!r.has(o.target))
                    continue;
                let l = r.get(o.target), c = i.get(o.target), h = a.get(o.target), p = c ? c.context : l.context, g = c ? si.Postproccessing : si.Creation, v = [];
                for (let E = 0; E < o.interpolation.expressions.length; E++) {
                    let C = o.interpolation.expressions[E];
                    v.push(Zp(p, l.xref, l.xref, l.handle, C, h?.xref ?? null, o.interpolation.i18nPlaceholders[E] ?? null, g, er.I18nText, "", C.sourceSpan ?? o.sourceSpan));
                }
...
function xE(n) { let e = []; for (let t of n)
...
function CE(n) { let e = [], t = 0, s = 0, r = 0, i = 0, a = 0, o = null; for (; t < n.length;)
...
function AE(n) { let e = new Map; for (let t of n.units)
    for (let s of t.create)
        In(s) && e.set(s.xref, s); for (let t of n.units)
    for (let s of t.create)
        if (s.kind === u.ExtractedAttribute && s.bindingKind === b.Attribute && Jp(s.expression)) {
            let r = e.get(s.target);
            if (r !== void 0 && (r.kind === u.Template || r.kind === u.ConditionalCreate || r.kind === u.ConditionalBranchCreate) && r.templateKind === Ue.Structural)
                continue;
            if (s.name === "style") {
                let i = CE(s.expression.value);
                for (let a = 0; a < i.length - 1; a += 2)
                    w.insertBefore(ct(s.target, b.StyleProperty, null, i[a], d(i[a + 1]), null, null, Z.STYLE), s);
                w.remove(s);
            }
            else if (s.name === "class") {
                let i = s.expression.value.trim().split(/\s+/g);
                for (let a of i)
                    w.insertBefore(ct(s.target, b.ClassName, null, a, null, null, null, Z.NONE), s);
                w.remove(s);
            }
        } }
function _E(n) { gr(n.root, n.componentName, { index: 0 }, n.compatibility === st.TemplateDefinitionBuilder); }
function gr(n, e, t, s) { n.fnName === null && (n.fnName = n.job.pool.uniqueName(On(`${e}_${n.job.fnSuffix}`), !1)); let r = new Map; for (let i of n.ops())
    switch (i.kind) {
        case u.Property:
        case u.DomProperty:
            i.bindingKind === b.LegacyAnimation && (i.name = "@" + i.name);
            break;
        case u.Animation:
        ...
        case u.TwoWayListener:
            ...
            break;
        case u.Variable:
            r.set(i.xref, kE(n, i.variable, t));
            break;
        case u.RepeaterCreate:
            if (!(n instanceof ut))
            ...
            if (i.emptyView !== null) {
                ...
                gr(h, `${e}_${i.functionNameSuffix}Empty_${i.handle.slot + 2}`, t, s);
            }
            gr(n.job.views.get(i.xref), `${e}_${i.functionNameSuffix}_${i.handle.slot + 1}`, t, s);
            break;
        case u.Projection:
            if (!(n instanceof ut))
                throw new Error("AssertionError: must be compiling a component");
            ...
            if (i.fallbackView !== null) {
                ...
                gr(h, `${e}_ProjectionFallback_${i.handle.slot}`, t, s);
            }
            break;
        case u.ConditionalCreate:
        case u.ConditionalBranchCreate:
        case u.Template:
            ...
            gr(l, `${e}${c}_${i.handle.slot}`, t, s);
            break;
        case u.StyleProp:
            i.name = bE(i.name), s && (i.name = lh(i.name));
            break;
        case u.ClassProp:
            s && (i.name = lh(i.name));
            break;
...
function kE(n, e, t) { if (e.name === null)
    switch (e.kind) {
        case Se.Context:
...
function bE(n) { return n.startsWith("--") ? n : Af(n); }
function lh(n) { let e = n.indexOf("!important"); return e > -1 ? n.substring(0, e) : n; }
function TE(n) { for (let e of n.units) {
    for (let t of e.create)
        (t.kind === u.Listener || t.kind === u.Animation || t.kind === u.AnimationListener || t.kind === u.TwoWayListener) && ch(t.handlerOps);
    ch(e.update);
} }
function ch(n) { for (let e of n) {
...
function NE(n) { for (let e of n.units) {
    let t = new Set;
    for (let s of e.create)
        s.kind === u.ElementStart && s.tag === IE && (s.kind = u.ContainerStart, t.add(s.xref)), s.kind === u.ElementEnd && t.has(s.xref) && (s.kind = u.ContainerEnd);
} }
function DE(n, e) { let t = n.get(e); if (t === void 0)
    throw new Error("All attributes should have an element-like target."); return t; }
function PE(n) { let e = new Map; for (let t of n.units)
    for (let s of t.create)
        In(s) && e.set(s.xref, s); for (let t of n.units)
    for (let s of t.create)
        (s.kind === u.ElementStart || s.kind === u.ContainerStart) && s.nonBindable && w.insertAfter($g(s.xref), s), (s.kind === u.ElementEnd || s.kind === u.ContainerEnd) && DE(e, s.xref).nonBindable && w.insertBefore(Og(s.xref), s); }
function Xt(n) { return e => e.kind === n; }
function xr(n, e) { return t => t.kind === n && e === t.expression instanceof oe; }
function LE(n) { return n.kind === u.Listener && !(n.hostListener && n.isLegacyAnimationListener) || n.kind === u.TwoWayListener || n.kind === u.Animation || n.kind === u.AnimationListener; }
function BE(n) { return (n.kind === u.Property || n.kind === u.TwoWayProperty) && !(n.expression instanceof oe); }
var ME = [{ test: n => n.kind === u.Listener && n.hostListener && n.isLegacyAnimationListener }, { test: LE }], RE = [{ test: Xt(u.StyleMap), transform: Va }, { test: Xt(u.ClassMap), transform: Va }, { test: Xt(u.StyleProp) }, { test: Xt(u.ClassProp) }, { test: xr(u.Attribute, !0) }, { test: xr(u.Property, !0) }, { test: BE }, { test: xr(u.Attribute, !1) }], FE = [{ test: xr(u.DomProperty, !0) }, { test: xr(u.DomProperty, !1) }, { test: Xt(u.Attribute) }, { test: Xt(u.StyleMap), transform: Va }, { test: Xt(u.ClassMap), transform: Va }, { test: Xt(u.StyleProp) }, { test: Xt(u.ClassProp) }], uh = new Set([u.Listener, u.TwoWayListener, u.AnimationListener, u.StyleMap, u.ClassMap, u.StyleProp, u.ClassProp, u.Property, u.TwoWayProperty, u.DomProperty, u.Attribute, u.Animation]);
function $E(n) { for (let e of n.units) {
    hh(e.create, ME);
    let t = e.job.kind === _.Host ? FE : RE;
    hh(e.update, t);
} }
function hh(n, e) { let t = [], s = null; for (let r of n) {
    let i = ri(r) ? r.target : null;
    (!uh.has(r.kind) || i !== s && s !== null && i !== null) && (w.insertBefore(ph(t, e), r), t = [], s = null), uh.has(r.kind) && (t.push(r), w.remove(r), s = i ?? s);
} n.push(ph(t, e)); }
function ph(n, e) { let t = Array.from(e, () => new Array); for (let s of n) {
...
function OE(n) { for (let e of n.units) {
    ...
    for (let s of e.ops())
        switch (s.kind) {
            case u.Binding:
                let r = qE(t, s.target);
                VE(s.name) && r.kind === u.Projection && w.remove(s);
                break;
        }
} }
function VE(n) { return n.toLowerCase() === "select"; }
...
function UE(n) { for (let e of n.units)
    HE(e); }
function HE(n) { for (let e of n.update)
    ye(e, (t, s) => { if (Ht(t) && t.kind === I.PipeBinding) {
        ...
        if (n.job.compatibility) {
            ...
            n.create.push(af(t.target, t.targetSlot, t.name));
    } }); }
function WE(n, e, t) { for (let s = n.create.head.next; s.kind !== u.ListEnd; s = s.next) {
    if (!nr(s) || s.xref !== e)
        continue;
    for (; s.next.kind === u.Pipe;)
        s = s.next;
    let r = af(t.target, t.targetSlot, t.name);
...
function jE(n) { for (let e of n.units)
    for (let t of e.update)
        fe(t, s => !(s instanceof us) || s.args.length <= 4 ? s : new oi(s.target, s.targetSlot, s.name, R(s.args), s.args.length), X.None); }
function zE(n) { _f(n.root, 0); }
...
function GE(n, e) { if (n.create.head.next?.kind !== u.I18nStart) {
...
var zl = class extends ks {
    ...
    toSharedConstantDeclaration(e, t) { let s = []; for (let i = 0; i < this.numArgs; i++)
        s.push(new K("a" + i)); let r = k(t, i => i instanceof Ws ? D("a" + i.index) : i, X.None); return new ce(e, new Sn(s, r), void 0, le.Final); }
};
function YE(n) { for (let e of n.units)
    for (let t of e.update)
        fe(t, (s, r) => r & X.InChildOperation ? s : s instanceof dt ? QE(s) : s instanceof Tt ? ZE(s) : s, X.None); }
function QE(n) { let e = [], t = []; for (let s of n.entries)
    if (s.isConstant())
        e.push(s);
    else {
        let r = t.length;
...
function ZE(n) { let e = [], t = []; for (let s of n.entries)
...
function JE(n, e, t, s, r) { return Bn(f.element, n, e, t, s, r); }
function KE(n, e, t, s, r) { return Bn(f.elementStart, n, e, t, s, r); }
function Bn(n, e, t, s, r, i) { let a = [d(e)]; return t !== null && a.push(d(t)), r !== null ? a.push(d(s), d(r)) : s !== null && a.push(d(s)), $(n, a, i); }
function kf(n, e, t, s, r, i, a, o, l) { let c = [d(e), t, d(s), d(r), d(i), d(a)]; for (o !== null && (c.push(d(o)), c.push(y(f.templateRefExtractor))); c[c.length - 1].isEquivalent(xn);)
    c.pop(); return $(n, c, l); }
function zc(n, e, t, s, r) { let i = [d(e)]; return t instanceof oe ? i.push(sr(t, r)) : i.push(t), s !== null && i.push(s), $(n, i, r); }
function eS(n) { return $(f.elementEnd, [], n); }
function tS(n, e, t, s) { return Bn(f.elementContainerStart, n, null, e, t, s); }
function nS(n, e, t, s) { return Bn(f.elementContainer, n, null, e, t, s); }
function sS() { return $(f.elementContainerEnd, [], null); }
function rS(n, e, t, s, r, i, a, o) { return kf(f.templateCreate, n, e, t, s, r, i, a, o); }
function iS() { return $(f.disableBindings, [], null); }
function aS() { return $(f.enableBindings, [], null); }
function oS(n, e, t, s, r) { let i = [d(n), e]; return t !== null && i.push(y(t)), $(s ? f.syntheticHostListener : f.listener, i, r); }
function fh(n, e) { return y(f.twoWayBindingSet).callFn([n, e]); }
function lS(n, e, t) { return $(f.twoWayListener, [d(n), e], t); }
function cS(n, e) { return $(f.pipe, [d(n), d(e)], null); }
function uS() { return $(f.namespaceHTML, [], null); }
function hS() { return $(f.namespaceSVG, [], null); }
function pS() { return $(f.namespaceMathML, [], null); }
function fS(n, e) { return $(f.advance, n > 1 ? [d(n)] : [], e); }
function dS(n) { return y(f.reference).callFn([d(n)]); }
function mS(n) { return y(f.nextContext).callFn(n === 1 ? [] : [d(n)]); }
function gS() { return y(f.getCurrentView).callFn([]); }
function vS(n) { return y(f.restoreView).callFn([n]); }
function wS(n) { return y(f.resetView).callFn([n]); }
function ES(n, e, t) { let s = [d(n, null)]; return e !== "" && s.push(d(e)), $(f.text, s, t); }
function SS(n, e, t, s, r, i, a, o, l, c, h) { let p = [d(n), d(e), t ?? d(null), d(s), d(r), d(i), a ?? d(null), o ?? d(null), l ? y(f.deferEnableTimerScheduling) : d(null), d(h)], g; for (; (g = p[p.length - 1]) !== null && g instanceof Ee && g.value === null;)
    p.pop(); return $(f.defer, p, c); }
var xS = new Map([[J.Idle, { none: f.deferOnIdle, prefetch: f.deferPrefetchOnIdle, hydrate: f.deferHydrateOnIdle }], [J.Immediate, { none: f.deferOnImmediate, prefetch: f.deferPrefetchOnImmediate, hydrate: f.deferHydrateOnImmediate }], [J.Timer, { none: f.deferOnTimer, prefetch: f.deferPrefetchOnTimer, hydrate: f.deferHydrateOnTimer }], [J.Hover, { none: f.deferOnHover, prefetch: f.deferPrefetchOnHover, hydrate: f.deferHydrateOnHover }], [J.Interaction, { none: f.deferOnInteraction, prefetch: f.deferPrefetchOnInteraction, hydrate: f.deferHydrateOnInteraction }], [J.Viewport, { none: f.deferOnViewport, prefetch: f.deferPrefetchOnViewport, hydrate: f.deferHydrateOnViewport }], [J.Never, { none: f.deferHydrateNever, prefetch: f.deferHydrateNever, hydrate: f.deferHydrateNever }]]);
function yS(n, e, t, s) { let r = xS.get(n)?.[t]; if (r === void 0)
    throw new Error(`Unable to determine instruction for trigger ${n}`); return $(r, e.map(i => d(i)), s); }
function CS(n) { return $(f.projectionDef, n ? [n] : [], null); }
function AS(n, e, t, s, r, i, a) { let o = [d(n)]; return (e !== 0 || t !== null || s !== null) && (o.push(d(e)), t !== null && o.push(t), s !== null && (t === null && o.push(d(null)), o.push(D(s), d(r), d(i)))), $(f.projection, o, a); }
function _S(n, e, t, s) { let r = [d(n), d(e)]; return t !== null && r.push(d(t)), $(f.i18nStart, r, s); }
function kS(n, e, t, s, r, i, a, o) { let l = [d(n), e, d(t), d(s), d(r), d(i)]; for (a !== null && (l.push(d(a)), l.push(y(f.templateRefExtractor))); l[l.length - 1].isEquivalent(xn);)
    l.pop(); return $(f.conditionalCreate, l, o); }
function bS(n, e, t, s, r, i, a, o) { let l = [d(n), e, d(t), d(s), d(r), d(i)]; for (a !== null && (l.push(d(a)), l.push(y(f.templateRefExtractor))); l[l.length - 1].isEquivalent(xn);)
    l.pop(); return $(f.conditionalBranchCreate, l, o); }
function TS(n, e, t, s, r, i, a, o, l, c, h, p, g, v) { let E = [d(n), D(e), d(t), d(s), d(r), d(i), a]; return (o || l !== null) && (E.push(d(o)), l !== null && (E.push(D(l), d(c), d(h)), (p !== null || g !== null) && E.push(d(p)), g !== null && E.push(d(g)))), $(f.repeaterCreate, E, v); }
function IS(n, e) { return $(f.repeater, [n], e); }
function NS(n, e, t) { return n === "prefetch" ? $(f.deferPrefetchWhen, [e], t) : n === "hydrate" ? $(f.deferHydrateWhen, [e], t) : $(f.deferWhen, [e], t); }
function DS(n, e) { return $(f.declareLet, [d(n)], e); }
function PS(n, e) { return y(f.storeLet).callFn([n], e); }
function LS(n) { return y(f.readContextLet).callFn([d(n)]); }
function BS(n, e, t, s) { let r = [d(n), d(e)]; return t && r.push(d(t)), $(f.i18n, r, s); }
function MS(n) { return $(f.i18nEnd, [], n); }
function RS(n, e) { let t = [d(n), d(e)]; return $(f.i18nAttributes, t, null); }
function FS(n, e, t) { return zc(f.ariaProperty, n, e, null, t); }
function $S(n, e, t, s) { return zc(f.property, n, e, t, s); }
function OS(n, e, t, s) { let r = [d(n), e]; return t !== null && r.push(t), $(f.twoWayProperty, r, s); }
function VS(n, e, t, s, r) { let i = [d(n)]; return e instanceof oe ? i.push(sr(e, r)) : i.push(e), (t !== null || s !== null) && i.push(t ?? d(null)), s !== null && i.push(d(s)), $(f.attribute, i, null); }
function qS(n, e, t, s) { let r = [d(n)]; return e instanceof oe ? r.push(sr(e, s)) : r.push(e), t !== null && r.push(d(t)), $(f.styleProp, r, s); }
function US(n, e, t) { return $(f.classProp, [d(n), e], t); }
function HS(n, e) { let t = n instanceof oe ? sr(n, e) : n; return $(f.styleMap, [t], e); }
function WS(n, e) { let t = n instanceof oe ? sr(n, e) : n; return $(f.classMap, [t], e); }
function jS(n, e, t, s, r) { return Bn(f.domElement, n, e, t, s, r); }
function zS(n, e, t, s, r) { return Bn(f.domElementStart, n, e, t, s, r); }
function GS(n) { return $(f.domElementEnd, [], n); }
function XS(n, e, t, s) { return Bn(f.domElementContainerStart, n, null, e, t, s); }
function YS(n, e, t, s) { return Bn(f.domElementContainer, n, null, e, t, s); }
function QS() { return $(f.domElementContainerEnd, [], null); }
function ZS(n, e, t, s) { let r = [d(n), e]; return t !== null && r.push(y(t)), $(f.domListener, r, s); }
function JS(n, e, t, s, r, i, a, o) { return kf(f.domTemplate, n, e, t, s, r, i, a, o); }
var dh = [f.pipeBind1, f.pipeBind2, f.pipeBind3, f.pipeBind4];
function KS(n, e, t) { if (t.length < 1 || t.length > dh.length)
    throw new Error("pipeBind() argument count out of bounds"); let s = dh[t.length - 1]; return y(s).callFn([d(n), d(e), ...t]); }
function e2(n, e, t) { return y(f.pipeBindV).callFn([d(n), d(e), t]); }
function t2(n, e, t) { let s = bf(n, e); return m2(p2, [], s, [], t); }
function n2(n, e) { return $(f.i18nExp, [n], e); }
function s2(n, e) { return $(f.i18nApply, [d(n)], e); }
function r2(n, e, t, s) { return zc(f.domProperty, n, e, t, s); }
function i2(n, e, t, s) { let r = [e]; t !== null && r.push(t); let i = n === "enter" ? f.animationEnter : f.animationLeave; return $(i, r, s); }
function a2(n, e, t, s) { let i = [e instanceof oe ? sr(e, s) : e]; t !== null && i.push(t); let a = n === "enter" ? f.animationEnter : f.animationLeave; return $(a, i, s); }
function o2(n, e, t, s) { let r = [e], i = n === "enter" ? f.animationEnterListener : f.animationLeaveListener; return $(i, r, s); }
function l2(n, e, t) { return $(f.syntheticHostProperty, [d(n), e], t); }
function c2(n, e, t) { return Gc(d2, [d(n), e], t, [], null); }
function u2(n, e) { return $(f.attachSourceLocations, [d(n), e], null); }
function bf(n, e) { if (n.length < 1 || e.length !== n.length - 1)
...
function sr(n, e) { let t = bf(n.strings, n.expressions); return Gc(f2, [], t, [], e); }
function $(n, e, t) { let s = y(n).callFn(e, t); return gt(new nt(s, t)); }
function h2(n, e, t) { let s = [n]; return e !== null && s.push(e), $(f.conditional, s, t); }
var p2 = { constant: [f.textInterpolate, f.textInterpolate1, f.textInterpolate2, f.textInterpolate3, f.textInterpolate4, f.textInterpolate5, f.textInterpolate6, f.textInterpolate7, f.textInterpolate8], variable: f.textInterpolateV, mapping: n => { if (n % 2 === 0)
        throw new Error("Expected odd number of arguments"); return (n - 1) / 2; } }, f2 = { constant: [f.interpolate, f.interpolate1, f.interpolate2, f.interpolate3, f.interpolate4, f.interpolate5, f.interpolate6, f.interpolate7, f.interpolate8], variable: f.interpolateV, mapping: n => { if (n % 2 === 0)
        throw new Error("Expected odd number of arguments"); return (n - 1) / 2; } }, d2 = { constant: [f.pureFunction0, f.pureFunction1, f.pureFunction2, f.pureFunction3, f.pureFunction4, f.pureFunction5, f.pureFunction6, f.pureFunction7, f.pureFunction8], variable: f.pureFunctionV, mapping: n => n };
function Gc(n, e, t, s, r) { let i = n.mapping(t.length), a = t.at(-1); if (s.length === 0 && t.length > 1 && a instanceof Ee && a.value === "" && t.pop(), i < n.constant.length)
...
function m2(n, e, t, s, r) { return gt(Gc(n, e, t, s, r).toStmt()); }
var g2 = new Map([["window", f.resolveWindow], ["document", f.resolveDocument], ["body", f.resolveBody]]), v2 = new Map([["class", "className"], ["for", "htmlFor"], ["formaction", "formAction"], ["innerHtml", "innerHTML"], ["readonly", "readOnly"], ["tabindex", "tabIndex"]]);
function w2(n) { for (let e of n.units)
    E2(e, e.create), Xc(e, e.update); }
function E2(n, e) { for (let t of e)
    switch (fe(t, Tf, X.None), t.kind) {
        case u.Text:
            w.replace(t, ES(t.handle.slot, t.initialValue, t.sourceSpan));
            break;
        case u.ElementStart:
            w.replace(t, n.job.mode === Oe.DomOnly ? zS(t.handle.slot, t.tag, t.attributes, t.localRefs, t.startSourceSpan) : KE(t.handle.slot, t.tag, t.attributes, t.localRefs, t.startSourceSpan));
            break;
        case u.Element:
            w.replace(t, n.job.mode === Oe.DomOnly ? jS(t.handle.slot, t.tag, t.attributes, t.localRefs, t.wholeSourceSpan) : JE(t.handle.slot, t.tag, t.attributes, t.localRefs, t.wholeSourceSpan));
            break;
        case u.ElementEnd:
            w.replace(t, n.job.mode === Oe.DomOnly ? GS(t.sourceSpan) : eS(t.sourceSpan));
            break;
        case u.ContainerStart:
            w.replace(t, n.job.mode === Oe.DomOnly ? XS(t.handle.slot, t.attributes, t.localRefs, t.startSourceSpan) : tS(t.handle.slot, t.attributes, t.localRefs, t.startSourceSpan));
            break;
        case u.Container:
            w.replace(t, n.job.mode === Oe.DomOnly ? YS(t.handle.slot, t.attributes, t.localRefs, t.wholeSourceSpan) : nS(t.handle.slot, t.attributes, t.localRefs, t.wholeSourceSpan));
            break;
        case u.ContainerEnd:
            w.replace(t, n.job.mode === Oe.DomOnly ? QS() : sS());
            break;
        case u.I18nStart:
            w.replace(t, _S(t.handle.slot, t.messageIndex, t.subTemplateIndex, t.sourceSpan));
            break;
        case u.I18nEnd:
            w.replace(t, MS(t.sourceSpan));
            break;
        case u.I18n:
            w.replace(t, BS(t.handle.slot, t.messageIndex, t.subTemplateIndex, t.sourceSpan));
            break;
        case u.I18nAttributes:
            if (t.i18nAttributesConfig === null)
                throw new Error("AssertionError: i18nAttributesConfig was not set");
            w.replace(t, RS(t.handle.slot, t.i18nAttributesConfig));
            break;
        case u.Template:
            if (!(n instanceof ut))
                throw new Error("AssertionError: must be compiling a component");
            ...
            w.replace(t, t.templateKind === Ue.Block || n.job.mode === Oe.DomOnly ? JS(t.handle.slot, D(s.fnName), s.decls, s.vars, t.tag, t.attributes, t.localRefs, t.startSourceSpan) : rS(t.handle.slot, D(s.fnName), s.decls, s.vars, t.tag, t.attributes, t.localRefs, t.startSourceSpan));
            break;
        case u.DisableBindings:
            w.replace(t, iS());
            break;
        case u.EnableBindings:
            ...
            break;
        case u.Pipe:
            w.replace(t, cS(t.handle.slot, t.name));
            break;
        case u.DeclareLet:
            w.replace(t, DS(t.handle.slot, t.sourceSpan));
            break;
        case u.AnimationString:
            w.replace(t, a2(t.animationKind, t.expression, t.sanitizer, t.sourceSpan));
            break;
        case u.Animation:
            let r = Di(n, t.handlerFnName, t.handlerOps, !1);
            w.replace(t, i2(t.animationKind, r, t.sanitizer, t.sourceSpan));
            break;
        case u.AnimationListener:
            let i = Di(n, t.handlerFnName, t.handlerOps, t.consumesDollarEvent);
            w.replace(t, o2(t.animationKind, i, null, t.sourceSpan));
            break;
        case u.Listener:
            let a = Di(n, t.handlerFnName, t.handlerOps, t.consumesDollarEvent), o = t.eventTarget ? g2.get(t.eventTarget) : null;
            if (o === void 0)
            ...
            w.replace(t, n.job.mode === Oe.DomOnly && !t.hostListener && !t.isLegacyAnimationListener ? ZS(t.name, a, o, t.sourceSpan) : oS(t.name, a, o, t.hostListener && t.isLegacyAnimationListener, t.sourceSpan));
            break;
        case u.TwoWayListener:
            w.replace(t, lS(t.name, Di(n, t.handlerFnName, t.handlerOps, !0), t.sourceSpan));
            break;
        case u.Variable:
        ...
        case u.Defer:
            ...
            w.replace(t, SS(t.handle.slot, t.mainSlot.slot, t.resolverFn, t.loadingSlot?.slot ?? null, t.placeholderSlot?.slot ?? null, t.errorSlot?.slot ?? null, t.loadingConfig, t.placeholderConfig, l, t.sourceSpan, t.flags));
            break;
        case u.DeferOn:
            let c = [];
            ...
            w.replace(t, yS(t.trigger.kind, c, t.modifier, t.sourceSpan));
            break;
        case u.ProjectionDef:
            w.replace(t, CS(t.def));
            break;
        case u.Projection:
            ...
            w.replace(t, AS(t.handle.slot, t.projectionSlotIndex, t.attributes, h, p, g, t.sourceSpan));
            break;
        case u.ConditionalCreate:
            if (!(n instanceof ut))
                throw new Error("AssertionError: must be compiling a component");
            ...
            w.replace(t, kS(t.handle.slot, D(v.fnName), v.decls, v.vars, t.tag, t.attributes, t.localRefs, t.startSourceSpan));
            break;
        case u.ConditionalBranchCreate:
            if (!(n instanceof ut))
                throw new Error("AssertionError: must be compiling a component");
            ...
            w.replace(t, bS(t.handle.slot, D(E.fnName), E.decls, E.vars, t.tag, t.attributes, t.localRefs, t.startSourceSpan));
            break;
        case u.RepeaterCreate:
            if (t.handle.slot === null)
            ...
            if (t.emptyView !== null) {
                ...
                T = V.fnName, A = V.decls, F = V.vars;
            }
            w.replace(t, TS(t.handle.slot, C.fnName, t.decls, t.vars, t.tag, t.attributes, x2(n, t), t.usesComponentInstance, T, A, F, t.emptyTag, t.emptyAttributes, t.wholeSourceSpan));
            break;
        case u.SourceLocation:
            let te = R(t.locations.map(({ targetSlot: V, offset: de, line: rr, column: dd }) => { if (V.slot === null)
                throw new Error("No slot was assigned for source location"); return R([d(V.slot), d(de), d(rr), d(dd)]); }));
            w.replace(t, u2(t.templatePath, te));
            break;
        case u.Statement: break;
        default: throw new Error(`AssertionError: Unsupported reification of create op ${u[t.kind]}`);
    } }
function Xc(n, e) { for (let t of e)
    switch (fe(t, Tf, X.None), t.kind) {
        case u.Advance:
            w.replace(t, fS(t.delta, t.sourceSpan));
            break;
        case u.Property:
            w.replace(t, n.job.mode === Oe.DomOnly && t.bindingKind !== b.LegacyAnimation && t.bindingKind !== b.Animation ? mh(t) : S2(t));
            break;
        case u.TwoWayProperty:
            w.replace(t, OS(t.name, t.expression, t.sanitizer, t.sourceSpan));
            break;
        case u.StyleProp:
            w.replace(t, qS(t.name, t.expression, t.unit, t.sourceSpan));
            break;
        case u.ClassProp:
            w.replace(t, US(t.name, t.expression, t.sourceSpan));
            break;
        case u.StyleMap:
            w.replace(t, HS(t.expression, t.sourceSpan));
            break;
        case u.ClassMap:
            w.replace(t, WS(t.expression, t.sourceSpan));
            break;
        case u.I18nExpression:
            w.replace(t, n2(t.expression, t.sourceSpan));
            break;
        case u.I18nApply:
            w.replace(t, s2(t.handle.slot, t.sourceSpan));
            break;
        case u.InterpolateText:
            w.replace(t, t2(t.interpolation.strings, t.interpolation.expressions, t.sourceSpan));
            break;
        case u.Attribute:
            w.replace(t, VS(t.name, t.expression, t.sanitizer, t.namespace, t.sourceSpan));
            break;
        case u.DomProperty:
            if (t.expression instanceof oe)
                throw new Error("not yet handled");
            t.bindingKind === b.LegacyAnimation || t.bindingKind === b.Animation ? w.replace(t, l2(t.name, t.expression, t.sourceSpan)) : w.replace(t, mh(t));
            break;
        case u.Variable:
            if (t.variable.name === null)
                throw new Error(`AssertionError: unnamed variable ${t.xref}`);
        ...
        case u.Conditional:
            ...
            w.replace(t, h2(t.processed, t.contextValue, t.sourceSpan));
            break;
        case u.Repeater:
            w.replace(t, IS(t.collection, t.sourceSpan));
            break;
        case u.DeferWhen:
            w.replace(t, NS(t.modifier, t.expr, t.sourceSpan));
            break;
...
function mh(n) { return r2(v2.get(n.name) ?? n.name, n.expression, n.sanitizer, n.sourceSpan); }
function S2(n) { return uf(n.name) ? FS(n.name, n.expression, n.sourceSpan) : $S(n.name, n.expression, n.sanitizer, n.sourceSpan); }
function Tf(n) { if (!Ht(n))
    return n; switch (n.kind) {
    case I.NextContext: return mS(n.steps);
    case I.Reference: return dS(n.targetSlot.slot + 1 + n.offset);
    ...
    case I.RestoreView:
        ...
        return vS(n.view);
    case I.ResetView: return wS(n.expr);
    case I.GetCurrentView: return gS();
    case I.ReadVariable:
        if (n.name === null)
    ...
    case I.PureFunctionExpr:
        ...
        return c2(n.varOffset, n.fn, n.args);
    ...
    case I.PipeBinding: return KS(n.targetSlot.slot, n.varOffset, n.args);
    case I.PipeBindingVariadic: return e2(n.targetSlot.slot, n.varOffset, n.args);
    case I.SlotLiteralExpr: return d(n.slot.slot);
    case I.ContextLetReference: return LS(n.targetSlot.slot);
    case I.StoreLet: return PS(n.value, n.sourceSpan);
...
function Di(n, e, t, s) { Xc(n, t); let r = []; for (let a of t) {
    if (a.kind !== u.Statement)
        throw new Error(`AssertionError: expected reified statements, but found op ${u[a.kind]}`);
    r.push(a.statement);
} let i = []; return s && i.push(new K("$event")), sn(i, r, void 0, void 0, e); }
function x2(n, e) { if (e.trackByFn !== null)
    return e.trackByFn; let t = [new K("$index"), new K("$item")], s; if (e.trackByOps === null)
...
function y2(n) { for (let e of n.units)
    for (let t of e.update)
        switch (t.kind) {
            ...
            case u.StyleProp:
            case u.StyleMap:
                t.expression instanceof li && w.remove(t);
                break;
        } }
...
function A2(n) { for (let e of n.units)
    for (let t of e.update) {
        if (t.kind !== u.Variable || t.variable.kind !== Se.Identifier || !(t.initializer instanceof ii))
            continue;
...
function T2(n) { for (let e of n.units)
    gh(e.create), gh(e.update); }
function gh(n) { for (let e of n)
    ...
    switch (o.kind) {
        ...
        case u.ElementStart:
            if (o.i18nPlaceholder !== void 0) {
                ...
                vh(o, i.i18nContext, i.i18nBlock, r), r && o.i18nPlaceholder.closeName && a.set(o.xref, r), r = void 0;
            }
            break;
        case u.ElementEnd:
            let l = s.get(o.xref);
            if (l && l.i18nPlaceholder !== void 0) {
                ...
                wh(l, i.i18nContext, i.i18nBlock, a.get(o.xref)), a.delete(o.xref);
            }
            break;
        case u.Projection:
            if (o.i18nPlaceholder !== void 0) {
                if (i === null)
                    throw Error("i18n tag placeholder should only occur inside an i18n block");
                vh(o, i.i18nContext, i.i18nBlock, r), wh(o, i.i18nContext, i.i18nBlock, r), r = void 0;
            }
...
function vh(n, e, t, s) { let { startName: r, closeName: i } = n.i18nPlaceholder, a = ne.ElementTag | ne.OpenTag, o = n.handle.slot; s !== void 0 && (a |= ne.TemplateTag, o = { element: o, template: s.handle.slot }), i || (a |= ne.CloseTag), Zs(e.params, r, o, t.subTemplateIndex, a); }
function wh(n, e, t, s) { let { closeName: r } = n.i18nPlaceholder; if (r) {
    let i = ne.ElementTag | ne.CloseTag, a = n.handle.slot;
    s !== void 0 && (i |= ne.TemplateTag, a = { element: a, template: s.handle.slot }), Zs(e.params, r, a, t.subTemplateIndex, i);
} }
function Pi(n, e, t, s, r, i, a) { let { startName: o, closeName: l } = s, c = ne.TemplateTag | ne.OpenTag; l || (c |= ne.CloseTag), a !== void 0 && Zs(r.params, o, a.handle.slot, i.subTemplateIndex, c), Zs(r.params, o, t, If(n, i, e), c); }
function Li(n, e, t, s, r, i, a) { let { closeName: o } = s, l = ne.TemplateTag | ne.CloseTag; o && (Zs(r.params, o, t, If(n, i, e), l), a !== void 0 && Zs(r.params, o, a.handle.slot, i.subTemplateIndex, l)); }
...
function N2(n) { let e = new Map, t = new Map, s = new Map; for (let a of n.units)
    ...
    for (let o of a.update)
        if (o.kind === u.I18nExpression) {
            ...
            D2(o, h, t, s), r.set(i(o), l + 1);
        } }
function D2(n, e, t, s) { if (n.i18nPlaceholder !== null) {
    let r = t.get(n.context), i = n.resolutionTime === si.Creation ? r.params : r.postprocessingParams, a = i.get(n.i18nPlaceholder) || [];
...
var L2 = new Map([[Z.HTML, f.sanitizeHtml], [Z.RESOURCE_URL, f.sanitizeResourceUrl], [Z.SCRIPT, f.sanitizeScript], [Z.STYLE, f.sanitizeStyle], [Z.URL, f.sanitizeUrl], [Z.ATTRIBUTE_NO_BINDING, f.validateAttribute]]), B2 = new Map([[Z.HTML, f.trustConstantHtml], [Z.RESOURCE_URL, f.trustConstantResourceUrl]]);
function M2(n) { for (let e of n.units) {
    if (n.kind !== _.Host) {
        for (let t of e.create)
            if (t.kind === u.ExtractedAttribute) {
                let s = B2.get(Eh(t.securityContext)) ?? null;
    ...
    for (let t of e.update)
        switch (t.kind) {
            ...
            case u.DomProperty:
                let s = null;
                Array.isArray(t.securityContext) && t.securityContext.length === 2 && t.securityContext.includes(Z.URL) && t.securityContext.includes(Z.RESOURCE_URL) ? s = f.sanitizeUrlOrResourceUrl : s = L2.get(Eh(t.securityContext)) ?? null, t.sanitizer = s !== null ? y(s) : null;
                break;
        }
} }
function Eh(n) { if (Array.isArray(n)) {
    if (n.length > 1)
        throw Error("AssertionError: Ambiguous security context");
    return n[0] || Z.NONE;
} return n; }
function R2(n) { for (let e of n.units) {
    e.create.prepend([fn(e.job.allocateXrefId(), { kind: Se.SavedView, name: null, view: e.xref }, new Al, lt.None)]);
    for (let t of e.create) {
        ...
        if (!s)
            for (let r of t.handlerOps)
                ye(r, i => { (i instanceof Ca || i instanceof ai) && (s = !0); });
        s && F2(e, t);
    }
} }
function F2(n, e) { e.handlerOps.prepend([fn(n.job.allocateXrefId(), { kind: Se.Context, name: null, view: n.xref }, new _a(n.xref), lt.None)]); for (let t of e.handlerOps)
    t.kind === u.Statement && t.statement instanceof xe && (t.statement.value = new _l(t.statement.value)); }
function $2(n) { let e = new Map; for (let t of n.units) {
    let s = 0;
...
function O2(n) { let e = new Set, t = new Map; for (let s of n.units)
    for (let r of s.ops())
        r.kind === u.DeclareLet && t.set(r.xref, r), ye(r, i => { i instanceof ai && e.add(i.target); }); for (let s of n.units)
    for (let r of s.update)
        fe(r, i => i instanceof ii && !e.has(i.target) ? (V2(i) || w.remove(t.get(i.target)), i.value) : i, X.None); }
function V2(n) { let e = !1; return k(n, t => ((t instanceof us || t instanceof oi) && (e = !0), t), X.None), e; }
function q2(n) { let e = new Set; for (let t of n.units)
    for (let s of t.ops())
...
function U2(n, e) { n.lhs instanceof ft && n.lhs.expr instanceof nn && e.add(n.lhs); }
function H2(n, e) { n.lhs instanceof ft && (Sh(n.lhs.expr) || n.lhs.expr instanceof bt) && e.add(n.lhs), n.rhs instanceof ft && (Sh(n.rhs.expr) || n.rhs.expr instanceof bt) && e.add(n.rhs); }
function W2(n, e) { n.lhs instanceof ft && n.lhs.expr instanceof W && n.lhs.expr.operator === x.NullishCoalesce && e.add(n.lhs); }
function Sh(n) { return n instanceof W && (n.operator === x.And || n.operator === x.Or); }
    ...
    for (let t of e.update)
        if (t.kind === u.Binding)
            switch (t.bindingKind) {
                ...
                case b.Property:
                case b.Template:
                    t.name === "style" ? w.replace(t, bg(t.target, t.expression, t.sourceSpan)) : t.name === "class" && w.replace(t, Tg(t.target, t.expression, t.sourceSpan));
                    break;
            } }
function z2(n) { for (let e of n.units)
    e.create.prepend(Ha(e.create)), e.update.prepend(Ha(e.update)); }
function Ha(n) { let e = 0, t = []; for (let s of n) {
    let r = new Map;
    ye(s, (c, h) => { h & X.InChildOperation || c instanceof Tn && r.set(c.xref, c); });
    let i = 0, a = new Set, o = new Set, l = new Map;
    ye(s, (c, h) => { h & X.InChildOperation || (c instanceof Wt ? (a.has(c.xref) || (a.add(c.xref), l.set(c.xref, `tmp_${e}_${i++}`)), xh(l, c)) : c instanceof Tn && (r.get(c.xref) === c && (o.add(c.xref), i--), xh(l, c))); }), t.push(...Array.from(new Set(l.values())).map(c => gt(new ce(c)))), e++, s.kind === u.Listener || s.kind === u.Animation || s.kind === u.AnimationListener || s.kind === u.TwoWayListener ? s.handlerOps.prepend(Ha(s.handlerOps)) : s.kind === u.RepeaterCreate && s.trackByOps !== null && s.trackByOps.prepend(Ha(s.trackByOps));
} return t; }
function xh(n, e) { let t = n.get(e.xref); if (t === void 0)
...
function G2(n) { for (let e of n.units)
    for (let t of e.create)
        if (t.kind === u.RepeaterCreate)
            if (t.track instanceof tt && t.track.name === "$index")
            ...
            else if (X2(n.root.xref, t.track))
                ...
                t.track = k(t.track, r => { if (r instanceof us || r instanceof oi)
...
function X2(n, e) { if (!(e instanceof Fe) || e.args.length === 0 || e.args.length > 2 || !(e.receiver instanceof We && e.receiver.receiver instanceof bn) || e.receiver.receiver.view !== n)
...
function Q2(n) { for (let e of n.units)
    for (let t of e.create)
        t.kind === u.TwoWayListener && fe(t, s => { if (!(s instanceof ka))
            ...
            return fh(r, i).or(r.set(i)); if (r instanceof en)
            return fh(r, i); throw new Error("Unsupported expression in two-way action binding."); }, X.InChildOperation); }
function Z2(n) { for (let e of n.units) {
    let t = 0;
    for (let s of e.ops())
        Eo(s) && (t += J2(s));
    for (let s of e.ops())
        ye(s, r => { Ht(r) && (n.compatibility === st.TemplateDefinitionBuilder && r instanceof cs || (Iu(r) && (r.varOffset = t), Eo(r) && (t += yh(r)))); });
    if (n.compatibility === st.TemplateDefinitionBuilder)
        for (let s of e.ops())
            ye(s, r => { !Ht(r) || !(r instanceof cs) || (Iu(r) && (r.varOffset = t), Eo(r) && (t += yh(r))); });
    e.vars = t;
} if (n instanceof ui)
    for (let e of n.units)
        for (let t of e.create) {
...
function J2(n) { let e; switch (n.kind) {
    case u.Attribute: return e = 1, n.expression instanceof oe && !K2(n.expression) && (e += n.expression.expressions.length), e;
    case u.Property:
...
function K2(n) { return !(n.expressions.length !== 1 || n.strings.length !== 2 || n.strings[0] !== "" || n.strings[1] !== ""); }
...
function Bi(n) { let e = new Map; for (let t of n)
    t.kind === u.Variable && t.flags & lt.AlwaysInline && (ye(t, s => { if (Ht(s) && Yc(s) !== ve.None)
...
function Mi(n, e) { let t = new Map, s = new Map, r = new Set, i = new Map; for (let c of n) {
    ...
    for (let g = c.next; g.kind !== u.ListEnd; g = g.next) {
        ...
        if (v.variablesUsed.has(l)) {
            if (e === st.TemplateDefinitionBuilder && !ix(c, g))
                break;
            if (rx(l, c.initializer, g, h.fences)) {
...
function tx(n) { let e = ve.None, t = new Set; return ye(n, s => { if (Ht(s))
    switch (s.kind) {
        case I.ReadVariable:
            t.add(s.xref);
            break;
...
function nx(n, e, t) { ye(n, (s, r) => { if (!Ht(s) || s.kind !== I.ReadVariable)
    return; let i = e.get(s.xref); i !== void 0 && (e.set(s.xref, i + 1), r & X.InChildOperation && t.add(s.xref)); }); }
function sx(n, e) { ye(n, t => { if (!Ht(t) || t.kind !== I.ReadVariable)
...
function Nf(n, e) { if (n & ve.ViewContextWrite) {
    ...
    return !1; return !0; }
function rx(n, e, t, s) { let r = !1, i = !0; return fe(t, (a, o) => { if (!Ht(a) || r || !i)
...
var ox = [{ kind: _.Tmpl, fn: OE }, { kind: _.Host, fn: nw }, { kind: _.Tmpl, fn: yE }, { kind: _.Tmpl, fn: zE }, { kind: _.Tmpl, fn: ax }, { kind: _.Both, fn: Cv }, { kind: _.Both, fn: j2 }, { kind: _.Both, fn: lv }, { kind: _.Both, fn: Ev }, { kind: _.Both, fn: iv }, { kind: _.Tmpl, fn: yv }, { kind: _.Both, fn: AE }, { kind: _.Tmpl, fn: y2 }, { kind: _.Both, fn: hv }, { kind: _.Both, fn: $E }, { kind: _.Tmpl, fn: pv }, { kind: _.Tmpl, fn: UE }, { kind: _.Tmpl, fn: Av }, { kind: _.Tmpl, fn: jE }, { kind: _.Both, fn: YE }, { kind: _.Tmpl, fn: Zv }, { kind: _.Tmpl, fn: Qv }, { kind: _.Tmpl, fn: Jv }, { kind: _.Tmpl, fn: R2 }, { kind: _.Both, fn: Kg }, { kind: _.Both, fn: T2 }, { kind: _.Tmpl, fn: Y2 }, { kind: _.Tmpl, fn: A2 }, { kind: _.Both, fn: P2 }, { kind: _.Tmpl, fn: _v }, { kind: _.Tmpl, fn: Q2 }, { kind: _.Tmpl, fn: G2 }, { kind: _.Both, fn: k2 }, { kind: _.Both, fn: M2 }, { kind: _.Tmpl, fn: SE }, { kind: _.Both, fn: Nv }, { kind: _.Both, fn: q2 }, { kind: _.Both, fn: z2 }, { kind: _.Both, fn: ex }, { kind: _.Both, fn: O2 }, { kind: _.Tmpl, fn: EE }, { kind: _.Tmpl, fn: xv }, { kind: _.Tmpl, fn: _2 }, { kind: _.Tmpl, fn: sv }, { kind: _.Tmpl, fn: tv }, { kind: _.Tmpl, fn: $2 }, { kind: _.Tmpl, fn: I2 }, { kind: _.Tmpl, fn: N2 }, { kind: _.Tmpl, fn: jv }, { kind: _.Tmpl, fn: dE }, { kind: _.Tmpl, fn: ew }, { kind: _.Both, fn: gv }, { kind: _.Tmpl, fn: C2 }, { kind: _.Both, fn: Z2 }, { kind: _.Tmpl, fn: Yv }, { kind: _.Both, fn: _E }, { kind: _.Tmpl, fn: b2 }, { kind: _.Tmpl, fn: TE }, { kind: _.Tmpl, fn: NE }, { kind: _.Tmpl, fn: Iv }, { kind: _.Tmpl, fn: rv }, { kind: _.Tmpl, fn: PE }, { kind: _.Both, fn: XE }, { kind: _.Both, fn: w2 }, { kind: _.Both, fn: uv }];
function Df(n, e) { for (let t of ox)
    (t.kind === e || t.kind === _.Both) && t.fn(n); }
function lx(n, e) { let t = Lf(n.root); return Pf(n.root, e), t; }
...
function Lf(n) { if (n.fnName === null)
    ...
    t.push(i.statement);
} let s = Wa(1, e), r = Wa(2, t); return sn([new K("rf"), new K("ctx")], [...s, ...r], void 0, void 0, n.fnName); }
function Wa(n, e) { return e.length === 0 ? [] : [xi(new W(x.BitwiseAnd, D("rf"), d(n)), e)]; }
function cx(n) { if (n.root.fnName === null)
    ...
    return null; let s = Wa(1, e), r = Wa(2, t); return sn([new K("rf"), new K("ctx")], [...s, ...r], void 0, void 0, n.root.fnName); }
var Bf = st.TemplateDefinitionBuilder, Qn = new Qs, Zn = "ng-template", ux = "animate.";
function ji(n) { return n instanceof Ie; }
function hx(n) { return ji(n) && n.nodes.length === 1 && n.nodes[0] instanceof _n; }
function px(n, e, t, s, r, i, a, o, l, c) { let h = new ui(n, t, Bf, s, r, i, a, o, l, c); return on(h.root, e), h; }
function fx(n, e, t) { let s = new Pa(n.componentName, t, Bf, Oe.DomOnly); for (let r of n.properties ?? []) {
    let i = b.Property;
    ...
    let a = e.calcPossibleSecurityContexts(n.componentSelector, r.name, i === b.Attribute).filter(o => o !== Z.NONE);
    dx(s, r, i, a);
} for (let [r, i] of Object.entries(n.attributes) ?? []) {
    let a = e.calcPossibleSecurityContexts(n.componentSelector, r, !0).filter(o => o !== Z.NONE);
    mx(s, r, i, a);
} for (let r of n.events ?? [])
    gx(s, r); return s; }
function dx(n, e, t, s) { let r, i = e.expression.ast; i instanceof yi ? r = new oe(i.strings, i.expressions.map(a => U(a, n, e.sourceSpan)), []) : r = U(i, n, e.sourceSpan), n.root.update.push(ls(n.root.xref, t, e.name, r, null, s, !1, !1, null, null, e.sourceSpan)); }
function mx(n, e, t, s) { let r = ls(n.root.xref, b.Attribute, e, t, null, s, !0, !1, null, null, t.sourceSpan); n.root.update.push(r); }
function gx(n, e) { let t; if (e.type === Be.Animation)
    t = sf(n.root.xref, new ke, e.name, null, gi(n.root, e.handler, e.handlerSpan), e.name.endsWith("enter") ? "enter" : "leave", e.targetOrPhase, !0, e.sourceSpan);
else {
    let [s, r] = e.type !== Be.LegacyAnimation ? [null, e.targetOrPhase] : [e.targetOrPhase, null];
    t = jc(n.root.xref, new ke, e.name, null, gi(n.root, e.handler, e.handlerSpan), s, r, !0, e.sourceSpan);
} n.root.create.push(t); }
function on(n, e) { for (let t of e)
    if (t instanceof Ot)
        vx(n, t);
...
function vx(n, e) { if (e.i18n !== void 0 && !(e.i18n instanceof Ie || e.i18n instanceof qt))
    throw Error(`Unhandled i18n metadata type for element: ${e.i18n.constructor.name}`); let t = n.job.allocateXrefId(), [s, r] = It(e.name), i = Mg(r, t, hf(s), e.i18n instanceof qt ? e.i18n : void 0, e.startSourceSpan, e.sourceSpan); n.create.push(i), Ix(n, i, e), Of(i, e); let a = null; e.i18n instanceof Ie && (a = n.job.allocateXrefId(), n.create.push(ho(a, e.i18n, void 0, e.startSourceSpan))), on(n, e.children); let o = Fg(t, e.endSourceSpan ?? e.startSourceSpan); n.create.push(o), a !== null && w.insertBefore(po(a, e.endSourceSpan ?? e.startSourceSpan), o); }
function wx(n, e) { if (e.i18n !== void 0 && !(e.i18n instanceof Ie || e.i18n instanceof qt))
    throw Error(`Unhandled i18n metadata type for template: ${e.i18n.constructor.name}`); let t = n.job.allocateView(n.xref), s = e.tagName, r = ""; e.tagName && ([r, s] = It(e.tagName)); let i = e.i18n instanceof qt ? e.i18n : void 0, a = hf(r), o = s === null ? "" : mv(s, a), l = Tx(e) ? Ue.NgTemplate : Ue.Structural, c = Kp(t.xref, l, s, o, a, i, e.startSourceSpan, e.sourceSpan); n.create.push(c), Nx(n, c, e, l), Of(c, e), on(t, e.children); for (let { name: h, value: p } of e.variables)
...
function Ex(n, e) { if (e.i18n !== void 0 && !(e.i18n instanceof qt))
    throw Error(`Unhandled i18n metadata type for element: ${e.i18n.constructor.name}`); let t = null; e.children.some(i => !(i instanceof oo) && (!(i instanceof Un) || i.value.trim().length > 0)) && (t = n.job.allocateView(n.xref), on(t, e.children)); let s = n.job.allocateXrefId(), r = Wg(s, e.selector, e.i18n, t?.xref ?? null, e.sourceSpan); for (let i of e.attributes) {
    let a = Qn.securityContext(e.name, i.name, !0);
    n.update.push(ls(r.xref, b.Attribute, i.name, d(i.value), null, a, !0, !1, null, Qt(i.i18n), i.sourceSpan));
} n.create.push(r); }
function Mf(n, e, t) { n.create.push(nf(n.job.allocateXrefId(), e.value, t, e.sourceSpan)); }
function Rf(n, e, t) { let s = e.value; if (s instanceof Xe && (s = s.ast), !(s instanceof yi))
    ...
    throw Error(`Unexpected number of i18n placeholders (${s.expressions.length}) for BoundText with ${s.expressions.length} expressions`); let i = n.job.allocateXrefId(); n.create.push(nf(i, "", t, e.sourceSpan)); let a = n.job.compatibility ? null : e.sourceSpan; n.update.push(yg(i, new oe(s.strings, s.expressions.map(o => U(o, n.job, a)), r), e.sourceSpan)); }
function Sx(n, e) { let t = null, s = []; for (let r = 0; r < e.branches.length; r++) {
    let i = e.branches[r], a = n.job.allocateView(n.xref), o = ja(n, a.xref, i);
    i.expressionAlias !== null && a.contextVariables.set(i.expressionAlias.name, lf);
    let l;
    if (i.i18n !== void 0) {
    ...
    let h = (r === 0 ? ef : tf)(a.xref, Ue.Block, o, "Conditional", Te.HTML, l, i.startSourceSpan, i.sourceSpan);
    n.create.push(h), t === null && (t = a.xref);
    let p = i.expression ? U(i.expression, n.job, null) : null, g = new Ta(p, h.xref, h.handle, i.expressionAlias);
    s.push(g), on(a, i.children);
} n.update.push(Qp(t, null, s, e.sourceSpan)); }
function xx(n, e) { if (e.cases.length === 0)
    ...
    let h = (r === 0 ? ef : tf)(a.xref, Ue.Block, o, "Case", Te.HTML, l, i.startSourceSpan, i.sourceSpan);
    n.create.push(h), t === null && (t = a.xref);
    let p = i.expression ? U(i.expression, n.job, e.startSourceSpan) : null, g = new Ta(p, h.xref, h.handle);
    s.push(g), on(a, i.children);
} n.update.push(Qp(t, U(e.expression, n.job, null), s, e.sourceSpan)); }
function Ri(n, e, t, s, r) { if (t !== void 0 && !(t instanceof Ut))
    throw Error("Unhandled i18n metadata type for defer block"); if (s === void 0)
    return null; let i = n.job.allocateView(n.xref); on(i, s); let a = Kp(i.xref, Ue.Block, null, `Defer${e}`, Te.HTML, t, r, r); return n.create.push(a), a; }
function yx(n, e) { let t = null; if (n.job.deferMeta.mode === 0) {
...
} let s = Ri(n, "", e.i18n, e.children, e.sourceSpan), r = Ri(n, "Loading", e.loading?.i18n, e.loading?.children, e.loading?.sourceSpan), i = Ri(n, "Placeholder", e.placeholder?.i18n, e.placeholder?.children, e.placeholder?.sourceSpan), a = Ri(n, "Error", e.error?.i18n, e.error?.children, e.error?.sourceSpan), o = n.job.allocateXrefId(), l = jg(o, s.xref, s.handle, t, n.job.allDeferrableDepsFn, e.sourceSpan); l.placeholderView = i?.xref ?? null, l.placeholderSlot = i?.handle ?? null, l.loadingSlot = r?.handle ?? null, l.errorSlot = a?.handle ?? null, l.placeholderMinimumTime = e.placeholder?.minimumTime ?? null, l.loadingMinimumTime = e.loading?.minimumTime ?? null, l.loadingAfterTime = e.loading?.afterTime ?? null, l.flags = Cx(e), n.create.push(l); let c = [], h = []; Ao("hydrate", e.hydrateTriggers, c, h, n, o), Ao("none", e.triggers, c, h, n, o), Ao("prefetch", e.prefetchTriggers, c, h, n, o), c.some(g => g.modifier === "none") || h.some(g => g.modifier === "none") || c.push(un(o, { kind: J.Idle }, "none", null)), n.create.push(c), n.update.push(h); }
function Cx(n) { return Object.keys(n.hydrateTriggers).length > 0 ? 1 : null; }
function Ao(n, e, t, s, r, i) { if (e.idle !== void 0) {
    let a = un(i, { kind: J.Idle }, n, e.idle.sourceSpan);
    t.push(a);
} if (e.immediate !== void 0) {
    let a = un(i, { kind: J.Immediate }, n, e.immediate.sourceSpan);
    t.push(a);
} if (e.timer !== void 0) {
    let a = un(i, { kind: J.Timer, delay: e.timer.delay }, n, e.timer.sourceSpan);
    t.push(a);
} if (e.hover !== void 0) {
    let a = un(i, { kind: J.Hover, targetName: e.hover.reference, targetXref: null, targetSlot: null, targetView: null, targetSlotViewSteps: null }, n, e.hover.sourceSpan);
    t.push(a);
} if (e.interaction !== void 0) {
    let a = un(i, { kind: J.Interaction, targetName: e.interaction.reference, targetXref: null, targetSlot: null, targetView: null, targetSlotViewSteps: null }, n, e.interaction.sourceSpan);
    t.push(a);
} if (e.viewport !== void 0) {
    let a = un(i, { kind: J.Viewport, targetName: e.viewport.reference, targetXref: null, targetSlot: null, targetView: null, targetSlotViewSteps: null }, n, e.viewport.sourceSpan);
    t.push(a);
} if (e.never !== void 0) {
    let a = un(i, { kind: J.Never }, n, e.never.sourceSpan);
    t.push(a);
} if (e.when !== void 0) {
    if (e.when.value instanceof yi)
        throw new Error("Unexpected interpolation in defer block when trigger");
    let a = Dg(i, U(e.when.value, r.job, e.when.sourceSpan), n, e.when.sourceSpan);
    s.push(a);
} }
function Ax(n, e) { if (e.i18n instanceof Ie && hx(e.i18n)) {
    let t = n.job.allocateXrefId();
    n.create.push(Xg(t, e.i18n, Cp(e.i18n).name, null));
...
function _x(n, e) { let t = n.job.allocateView(n.xref), s = `\u0275$index_${t.xref}`, r = `\u0275$count_${t.xref}`, i = new Set; t.contextVariables.set(e.item.name, e.item.value); for (let A of e.contextVariables)
    A.value === "$index" && i.add(A.name), A.name === "$index" ? t.contextVariables.set("$index", A.value).set(s, A.value) : A.name === "$count" ? t.contextVariables.set("$count", A.value).set(r, A.value) : t.aliases.add({ kind: Se.Alias, name: null, identifier: A.name, expression: kx(A, s, r) }); let a = me(e.trackBy.span, e.sourceSpan), o = U(e.trackBy, n.job, a); on(t, e.children); let l = null, c = null; e.empty !== null && (l = n.job.allocateView(n.xref), on(l, e.empty.children), c = ja(n, l.xref, e.empty)); let h = { $index: i, $implicit: e.item.name }; if (e.i18n !== void 0 && !(e.i18n instanceof Ut))
    throw Error("AssertionError: Unhandled i18n metadata type or @for"); if (e.empty?.i18n !== void 0 && !(e.empty.i18n instanceof Ut))
    throw Error("AssertionError: Unhandled i18n metadata type or @empty"); let p = e.i18n, g = e.empty?.i18n, v = ja(n, t.xref, e), E = Rg(t.xref, l?.xref ?? null, v, o, h, c, p, g, e.startSourceSpan, e.sourceSpan); n.create.push(E); let C = U(e.expression, n.job, me(e.expression.span, e.sourceSpan)), T = Ng(E.xref, E.handle, C, e.sourceSpan); n.update.push(T); }
function kx(n, e, t) { switch (n.value) {
...
function bx(n, e) { let t = n.job.allocateXrefId(); n.create.push(zg(t, e.name, e.sourceSpan)), n.update.push(Lg(t, e.name, U(e.value, n.job, e.valueSpan), e.sourceSpan)); }
function U(n, e, t) { if (n instanceof Xe)
    ...
    if (n instanceof bs)
        ...
        if (n instanceof sa) {
            ...
            return new Tt(s, void 0, me(n.span, t));
        }
        else {
            if (n instanceof na)
                return new dt(n.expressions.map(s => U(s, e, t)));
            if (n instanceof ea)
                return new bt(U(n.condition, e, t), U(n.trueExp, e, t), U(n.falseExp, e, t), void 0, me(n.span, t));
            if (n instanceof Fr)
            ...
            if (n instanceof $e)
                return new li(me(n.span, t));
            if (n instanceof Br)
                return up(U(n.expression, e, t), me(n.span, t));
            if (n instanceof Mr)
                return Js(U(n.expression, e, t));
            if (n instanceof Rr)
                return new Ar(U(n.expression, e, t), void 0, me(n.span, t));
            if (n instanceof Or)
                return Ch(n, e, t);
            if (n instanceof $r)
                return new Ps(U(n.tag, e, t), Ch(n.template, e, t), void 0, me(n.span, t));
            if (n instanceof Vr)
...
function Ch(n, e, t) { return new Bs(n.elements.map(s => new _r(s.text, me(s.span, t))), n.expressions.map(s => U(s, e, t)), me(n.span, t)); }
function Gl(n, e, t, s) { let r; return e instanceof yi ? r = new oe(e.strings, e.expressions.map(i => U(i, n, null)), Object.keys(Qt(t)?.placeholders ?? {})) : e instanceof se ? r = U(e, n, null) : r = d(e), r; }
var Ff = new Map([[G.Property, b.Property], [G.TwoWay, b.TwoWayProperty], [G.Attribute, b.Attribute], [G.Class, b.ClassName], [G.Style, b.StyleProperty], [G.LegacyAnimation, b.LegacyAnimation], [G.Animation, b.Animation]]);
function Tx(n) { return It(n.tagName ?? "")[1] === Zn; }
...
function Ix(n, e, t) { let s = new Array, r = new Set; for (let i of t.attributes) {
    let a = Qn.securityContext(t.name, i.name, !0);
    s.push(ls(e.xref, b.Attribute, i.name, Gl(n.job, i.value, i.i18n), null, a, !0, !1, null, Qt(i.i18n), i.sourceSpan)), i.i18n && r.add(i.name);
} for (let i of t.inputs)
    r.has(i.name) && console.error(`On component ${n.job.componentName}, the binding ${i.name} is both an i18n attribute and a property. You may want to remove the property binding. This will become a compilation error in future versions of Angular.`), s.push(ls(e.xref, Ff.get(i.type), i.name, Gl(n.job, vi(i.value), i.i18n), i.unit, i.securityContext, !1, !1, null, Qt(i.i18n) ?? null, i.sourceSpan)); n.create.push(s.filter(i => i?.kind === u.ExtractedAttribute)), n.update.push(s.filter(i => i?.kind === u.Binding)); for (let i of t.outputs) {
    if (i.type === Be.LegacyAnimation && i.phase === null)
        throw Error("Animation listener should have a phase");
    i.type === Be.TwoWay ? n.create.push(rf(e.xref, e.handle, i.name, e.tag, $f(n, i.handler, i.handlerSpan), i.sourceSpan)) : i.type === Be.Animation ? n.create.push(sf(e.xref, e.handle, i.name, e.tag, gi(n, i.handler, i.handlerSpan), i.name.endsWith("enter") ? "enter" : "leave", i.target, !1, i.sourceSpan)) : n.create.push(jc(e.xref, e.handle, i.name, e.tag, gi(n, i.handler, i.handlerSpan), i.phase, i.target, !1, i.sourceSpan));
} s.some(i => i?.i18nMessage) !== null && n.create.push(of(n.job.allocateXrefId(), new ke, e.xref)); }
function Nx(n, e, t, s) { let r = new Array; for (let i of t.templateAttrs)
    if (i instanceof Os) {
        let a = Qn.securityContext(Zn, i.name, !0);
        r.push(Fi(n, e.xref, G.Attribute, i.name, i.value, null, a, !0, s, Qt(i.i18n), i.sourceSpan));
    }
    else
        r.push(Fi(n, e.xref, i.type, i.name, vi(i.value), i.unit, i.securityContext, !0, s, Qt(i.i18n), i.sourceSpan)); for (let i of t.attributes) {
    let a = Qn.securityContext(Zn, i.name, !0);
    r.push(Fi(n, e.xref, G.Attribute, i.name, i.value, null, a, !1, s, Qt(i.i18n), i.sourceSpan));
} for (let i of t.inputs)
    r.push(Fi(n, e.xref, i.type, i.name, vi(i.value), i.unit, i.securityContext, !1, s, Qt(i.i18n), i.sourceSpan)); n.create.push(r.filter(i => i?.kind === u.ExtractedAttribute)), n.update.push(r.filter(i => i?.kind === u.Binding)); for (let i of t.outputs) {
    if (i.type === Be.LegacyAnimation && i.phase === null)
        throw Error("Animation listener should have a phase");
    if (s === Ue.NgTemplate && (i.type === Be.TwoWay ? n.create.push(rf(e.xref, e.handle, i.name, e.tag, $f(n, i.handler, i.handlerSpan), i.sourceSpan)) : n.create.push(jc(e.xref, e.handle, i.name, e.tag, gi(n, i.handler, i.handlerSpan), i.phase, i.target, !1, i.sourceSpan))), s === Ue.Structural && i.type !== Be.LegacyAnimation) {
        let a = Qn.securityContext(Zn, i.name, !1);
        n.create.push(ct(e.xref, b.Property, null, i.name, null, null, null, a));
    }
} r.some(i => i?.i18nMessage) !== null && n.create.push(of(n.job.allocateXrefId(), new ke, e.xref)); }
function Fi(n, e, t, s, r, i, a, o, l, c, h) { let p = typeof r == "string"; if (l === Ue.Structural) {
    if (!o)
        switch (t) {
            case G.Property:
            case G.Class:
            case G.Style: return ct(e, b.Property, null, s, null, null, c, a);
            case G.TwoWay: return ct(e, b.TwoWayProperty, null, s, null, null, c, a);
        }
    if (!p && (t === G.Attribute || t === G.LegacyAnimation || t === G.Animation))
        return null;
} let g = Ff.get(t); return l === Ue.NgTemplate && (t === G.Class || t === G.Style || t === G.Attribute && !p) && (g = b.Property), ls(e, g, s, Gl(n.job, r, c), i, a, p, o, l, c, h); }
function gi(n, e, t) { e = vi(e); let s = new Array, r = e instanceof Rs ? e.expressions : [e]; if (r.length === 0)
...
function $f(n, e, t) { e = vi(e); let s = new Array; if (e instanceof Rs)
...
function vi(n) { return n instanceof Xe ? n.ast : n; }
function Of(n, e) { Dx(n.localRefs); for (let { name: t, value: s } of e.references)
    n.localRefs.push({ name: t, target: s }); }
function Dx(n) { if (!Array.isArray(n))
...
function ja(n, e, t) { let s = null; for (let r of t.children)
    ...
    for (let i of s.attributes)
        if (!i.name.startsWith(ux)) {
            let a = Qn.securityContext(Zn, i.name, !0);
            n.update.push(ls(e, b.Attribute, i.name, d(i.value), null, a, !0, !1, null, Qt(i.i18n), i.sourceSpan));
        }
    for (let i of s.inputs)
        if (i.type !== G.LegacyAnimation && i.type !== G.Animation && i.type !== G.Attribute) {
            let a = Qn.securityContext(Zn, i.name, !0);
            n.create.push(ct(e, b.Property, null, i.name, null, null, null, a));
        }
...
var Vf = !1;
function WA(n) { Vf = n; }
function Px() { return Vf; }
function za(n, e) { return xi(D($c).bitwiseAnd(d(n), null), e); }
function Lx(n) { return (n.descendants ? 1 : 0) | (n.static ? 2 : 0) | (n.emitDistinctChangesOnly ? 4 : 0); }
function Bx(n, e) { if (Array.isArray(n.predicate)) {
    let t = [];
...
function qf(n, e, t, s) { let r = []; s !== void 0 && r.push(...s), n.isSignal && r.push(new We(D(Zr), n.propertyName)), r.push(Bx(n, e), d(Lx(n))), n.read && r.push(n.read); let i = n.isSignal ? t.signalBased : t.nonSignal; return y(i).callFn(r); }
var Qc = Symbol("queryAdvancePlaceholder");
function Uf(n) { let e = [], t = 0, s = () => { t > 0 && (e.unshift(y(f.queryAdvance).callFn(t === 1 ? [] : [d(t)]).toStmt()), t = 0); }; for (let r = n.length - 1; r >= 0; r--) {
    let i = n[r];
    i === Qc ? t++ : (s(), e.unshift(i));
} return s(), e; }
function Mx(n, e, t) { let s = [], r = [], i = Ap(o => r.push(o), Fc); n.forEach(o => { let l = qf(o, e, { signalBased: f.viewQuerySignal, nonSignal: f.viewQuery }); if (s.push(l.toStmt()), o.isSignal) {
    r.push(Qc);
    return;
} let c = i(), h = y(f.loadQuery).callFn([]), p = y(f.queryRefresh).callFn([c.set(h)]), g = D(Zr).prop(o.propertyName).set(o.first ? c.prop("first") : c); r.push(p.and(g).toStmt()); }); let a = t ? `${t}_Query` : null; return sn([new K($c, ro), new K(Zr, null)], [za(1, s), za(2, Uf(r))], qe, null, a); }
function Rx(n, e, t) { let s = [], r = [], i = Ap(o => r.push(o), Fc); for (let o of n) {
    if (s.push(qf(o, e, { nonSignal: f.contentQuery, signalBased: f.contentQuerySignal }, [D("dirIndex")]).toStmt()), o.isSignal) {
        r.push(Qc);
        continue;
    }
    let l = i(), c = y(f.loadQuery).callFn([]), h = y(f.queryRefresh).callFn([l.set(c)]), p = D(Zr).prop(o.propertyName).set(o.first ? l.prop("first") : l);
    r.push(h.and(p).toStmt());
} let a = t ? `${t}_ContentQueries` : null; return sn([new K($c, ro), new K(Zr, null), new K("dirIndex", null)], [za(1, s), za(2, Uf(r))], qe, null, a); }
var Ga = class extends mf {
    constructor() { super(ql); }
    parse(e, t, s) { return super.parse(e, t, s); }
}, $i = ".", Fx = "attr", _o = "animate", $x = "class", Ox = "style", Vx = "*", ko = "animate-", Xl = class {
    _exprParser;
    _interpolationConfig;
    _schemaRegistry;
    errors;
    ...
    parseInlineTemplateBinding(e, t, s, r, i, a, o, l) { let c = s.start.offset + Vx.length, h = this._parseTemplateBindings(e, t, s, c, r); for (let p of h) {
        let g = ln(s, p.sourceSpan), v = p.key.source, E = ln(s, p.key.span);
        if (p instanceof qr) {
            let C = p.value ? p.value.source : "$implicit", T = p.value ? ln(s, p.value.span) : void 0;
            o.push(new Jo(v, C, g, E, T));
        }
        else if (p.value) {
            let C = l ? g : s, T = ln(s, p.value.ast.sourceSpan);
            this._parsePropertyAst(v, p.value, !1, C, E, T, i, a);
        }
        else
    ...
    _parseTemplateBindings(e, t, s, r, i) { try {
        ...
        return a.errors.forEach(o => this.errors.push(o)), a.warnings.forEach(o => { this._reportError(o, s, dn.WARNING); }), a.templateBindings;
    }
    catch (a) {
        return this._reportError(`${a}`, s), [];
    } }
    parseLiteralAttr(e, t, s, r, i, a, o, l) { bo(e) ? (e = e.substring(1), l !== void 0 && (l = ln(l, new Ze(l.start.offset + 1, l.end.offset))), t && this._reportError('Assigning animation triggers via @prop="exp" attributes with an expression is invalid. Use property bindings (e.g. [@prop]="exp") or use an attribute without a value (e.g. @prop) instead.', s, dn.ERROR), this._parseLegacyAnimation(e, t, s, r, l, i, a, o)) : o.push(new ys(e, this._exprParser.wrapLiteralPrimitive(t, "", r), Lt.LITERAL_ATTR, s, l, i)); }
    parsePropertyBinding(e, t, s, r, i, a, o, l, c, h) { e.length === 0 && this._reportError("Property name is missing in binding", i); let p = !1; e.startsWith(ko) ? (p = !0, e = e.substring(ko.length), h !== void 0 && (h = ln(h, new Ze(h.start.offset + ko.length, h.end.offset)))) : bo(e) && (p = !0, e = e.substring(1), h !== void 0 && (h = ln(h, new Ze(h.start.offset + 1, h.end.offset)))), p ? this._parseLegacyAnimation(e, t, i, a, h, o, l, c) : e.startsWith(`${_o}${$i}`) ? this._parseAnimation(e, this.parseBinding(t, s, o || i, a), i, h, o, l, c) : this._parsePropertyAst(e, this.parseBinding(t, s, o || i, a), r, i, h, o, l, c); }
    ...
    createBoundElementProperty(e, t, s = !1, r = !0) { if (t.isLegacyAnimation)
        return new oa(t.name, G.LegacyAnimation, Z.NONE, t.expression, null, t.sourceSpan, t.keySpan, t.valueSpan); let i = null, a, o = null, l = t.name.split($i), c; if (l.length > 1)
        if (l[0] == Fx) {
            o = l.slice(1).join($i), s || this._validatePropertyOrAttributeName(o, t.sourceSpan, !0), c = To(this._schemaRegistry, e, o, !0);
            let h = o.indexOf(":");
            if (h > -1) {
            ...
            l[0] == $x ? (o = l[1], a = G.Class, c = [Z.NONE]) : l[0] == Ox ? (i = l.length > 2 ? l[2] : null, o = l[1], a = G.Style, c = [Z.STYLE]) : l[0] == _o && (o = t.name, a = G.Animation, c = [Z.NONE]); if (o === null) {
        let h = this._schemaRegistry.getMappedPropName(t.name);
        o = r ? h : t.name, c = To(this._schemaRegistry, e, h, !1), a = t.type === Lt.TWO_WAY ? G.TwoWay : G.Property, s || this._validatePropertyOrAttributeName(h, t.sourceSpan, !1);
    } return new oa(o, a, c[0], t.expression, i, t.sourceSpan, t.keySpan, t.valueSpan); }
    parseEvent(e, t, s, r, i, a, o, l) { e.length === 0 && this._reportError("Event name is missing in binding", r), bo(e) ? (e = e.slice(1), l !== void 0 && (l = ln(l, new Ze(l.start.offset + 1, l.end.offset))), this._parseLegacyAnimationEvent(e, t, r, i, o, l)) : this._parseRegularEvent(e, t, s, r, i, a, o, l); }
    calcPossibleSecurityContexts(e, t, s) { let r = this._schemaRegistry.getMappedPropName(t); return To(this._schemaRegistry, e, r, s); }
    ...
    _reportError(e, t, s = dn.ERROR) { this.errors.push(new N(t, e, s)); }
    _validatePropertyOrAttributeName(e, t, s) { let r = s ? this._schemaRegistry.validateAttribute(e) : this._schemaRegistry.validateProperty(e); r.error && this._reportError(r.msg, t, dn.ERROR); }
    _isAllowedAssignmentEvent(e) { return e instanceof Xe ? this._isAllowedAssignmentEvent(e.ast) : e instanceof Fr ? this._isAllowedAssignmentEvent(e.expression) : e instanceof Fs && e.args.length === 1 && e.receiver instanceof Jt && e.receiver.name === "$any" && e.receiver.receiver instanceof $t && !(e.receiver.receiver instanceof ss) ? this._isAllowedAssignmentEvent(e.args[0]) : (e instanceof Jt || e instanceof rs) && !Yl(e); }
};
function Yl(n) { return n instanceof Pr || n instanceof Lr ? !0 : n instanceof Vr ? Yl(n.expression) : n instanceof Jt || n instanceof rs || n instanceof Fs ? Yl(n.receiver) : !1; }
function bo(n) { return n[0] == "@"; }
function To(n, e, t, s) { let r, i = a => n.securityContext(a, t, s); return e === null ? r = n.allKnownElementNames().map(i) : (r = [], Jn.parse(e).forEach(a => { let o = a.element ? [a.element] : n.allKnownElementNames(), l = new Set(a.notSelectors.filter(h => h.isElementSelector()).map(h => h.element)), c = o.filter(h => !l.has(h)); r.push(...c.map(i)); })), r.length === 0 ? [Z.NONE] : Array.from(new Set(r)).sort(); }
function ln(n, e) { let t = e.start - n.start.offset, s = e.end - n.end.offset; return new L(n.start.moveBy(t), n.end.moveBy(s), n.fullStart.moveBy(t), n.details); }
function qx(n) { if (n == null || n.length === 0 || n[0] == "/")
    return !1; let e = n.match(Ux); return e === null || e[1] == "package" || e[1] == "asset"; }
var Ux = /^([^:/?#]+):/, Hx = "select", Wx = "link", jx = "rel", zx = "href", Gx = "stylesheet", Xx = "style", Yx = "script", Qx = "ngNonBindable", Zx = "ngProjectAs";
function Hf(n) { let e = null, t = null, s = null, r = !1, i = ""; n.attrs.forEach(l => { let c = l.name.toLowerCase(); c == Hx ? e = l.value : c == zx ? t = l.value : c == jx ? s = l.value : l.name == Qx ? r = !0 : l.name == Zx && l.value.length > 0 && (i = l.value); }), e = Jx(e); let a = n.name.toLowerCase(), o = Qe.OTHER; return Ko(a) ? o = Qe.NG_CONTENT : a == Xx ? o = Qe.STYLE : a == Yx ? o = Qe.SCRIPT : a == Wx && s == Gx && (o = Qe.STYLESHEET), new Ql(o, e, t, r, i); }
...
function Jx(n) { return n === null || n.length === 0 ? "*" : n; }
var Kx = /^\s*([0-9A-Za-z_$]*)\s+of\s+([\S\s]*)/, ey = /^track\s+([\S\s]*)/, ty = /^(as\s+)(.*)/, fo = /^else[^\S\r\n]+if/, ny = /^let\s+([\S\s]*)/, sy = /^[$A-Z_][0-9A-Z_$]*$/i, Ah = /(\s*)(\S+)(\s*)/, yr = new Set(["$index", "$first", "$last", "$even", "$odd", "$count"]);
function _h(n) { return n === "empty"; }
function kh(n) { return n === "else" || fo.test(n); }
function ry(n, e, t, s) { let r = uy(e), i = [], a = bh(n, r, s); a !== null && i.push(new Gn(a.expression, P(t, n.children, n.children), a.expressionAlias, n.sourceSpan, n.startSourceSpan, n.endSourceSpan, n.nameSpan, n.i18n)); for (let p of e)
    if (fo.test(p.name)) {
        let g = bh(p, r, s);
        if (g !== null) {
...
function iy(n, e, t, s) { let r = [], i = oy(n, r, s), a = null, o = null; for (let l of e)
    l.name === "empty" ? o !== null ? r.push(new N(l.sourceSpan, "@for loop can only have one @empty block")) : l.parameters.length > 0 ? r.push(new N(l.sourceSpan, "@empty block cannot have parameters")) : o = new Gr(P(t, l.children, l.children), l.sourceSpan, l.startSourceSpan, l.endSourceSpan, l.nameSpan, l.i18n) : r.push(new N(l.sourceSpan, `Unrecognized @for loop block "${l.name}"`)); if (i !== null)
    if (i.trackBy === null)
        ...
        ly(i.trackBy.expression, i.trackBy.keywordSpan, r), a = new Vs(i.itemName, i.expression, i.trackBy.expression, i.trackBy.keywordSpan, i.context, P(t, n.children, n.children), o, c, n.sourceSpan, n.startSourceSpan, l, n.nameSpan, n.i18n);
    } return { node: a, errors: r }; }
function ay(n, e, t) { let s = hy(n), r = n.parameters.length > 0 ? wi(n.parameters[0], t) : t.parseBinding("", !1, n.sourceSpan, 0), i = [], a = [], o = null; for (let l of n.children) {
    if (!(l instanceof at))
        continue;
    ...
    let c = l.name === "case" ? wi(l.parameters[0], t) : null, h = new zr(c, P(e, l.children, l.children), l.sourceSpan, l.startSourceSpan, l.endSourceSpan, l.nameSpan, l.i18n);
    c === null ? o = h : i.push(h);
...
function oy(n, e, t) { if (n.parameters.length === 0)
    return e.push(new N(n.startSourceSpan, "@for loop does not have an expression")), null; let [s, ...r] = n.parameters, i = py(s, e)?.match(Kx); if (!i || i[2].trim().length === 0)
    return e.push(new N(s.sourceSpan, 'Cannot parse expression. @for loop expression must match the pattern "<identifier> of <expression>"')), null; let [, a, o] = i; yr.has(a) && e.push(new N(s.sourceSpan, `@for loop item name cannot be one of ${Array.from(yr).join(", ")}.`)); let l = s.expression.split(" ")[0], c = new L(s.sourceSpan.start, s.sourceSpan.start.moveBy(l.length)), h = { itemName: new An(a, "$implicit", c, c), trackBy: null, expression: wi(s, t, o), context: Array.from(yr, p => { let g = new L(n.startSourceSpan.end, n.startSourceSpan.end); return new An(p, p, g, g); }) }; for (let p of r) {
    let g = p.expression.match(ny);
    if (g !== null) {
        let E = new L(p.sourceSpan.start.moveBy(g[0].length - g[1].length), p.sourceSpan.end);
        cy(p.sourceSpan, g[1], E, a, h.context, e);
        continue;
    }
    let v = p.expression.match(ey);
    if (v !== null) {
        if (h.trackBy !== null)
...
function ly(n, e, t) { let s = new Zl; n.ast.visit(s), s.hasPipe && t.push(new N(e, "Cannot use pipes in track expressions")); }
function cy(n, e, t, s, r, i) { let a = e.split(","), o = t.start; for (let l of a) {
    ...
    if (h.length === 0 || p.length === 0)
        ...
        i.push(new N(n, `Unknown "let" parameter variable "${p}". The allowed variables are: ${Array.from(yr).join(", ")}`));
    else if (h === s)
        ...
        let [, g, v] = c[0].match(Ah) ?? [], E = g !== void 0 && c.length === 2 ? new L(o.moveBy(g.length), o.moveBy(g.length + v.length)) : t, C;
        if (c.length === 2) {
            let [, A, F] = c[1].match(Ah) ?? [];
            C = A !== void 0 ? new L(o.moveBy(c[0].length + 1 + A.length), o.moveBy(c[0].length + 1 + A.length + F.length)) : void 0;
        }
        let T = new L(E.start, C?.end ?? E.end);
        r.push(new An(h, p, T, E, C));
    }
...
function hy(n) { let e = [], t = !1; if (n.parameters.length !== 1)
    ...
    if (!(s instanceof Nn || s instanceof an && s.value.trim().length === 0)) {
...
function wi(n, e, t) { let s, r; return typeof t == "string" ? (s = Math.max(0, n.expression.lastIndexOf(t)), r = s + t.length) : (s = 0, r = n.expression.length), e.parseBinding(n.expression.slice(s, r), !1, n.sourceSpan, n.sourceSpan.start.offset + s); }
function bh(n, e, t) { if (n.parameters.length === 0)
    return e.push(new N(n.startSourceSpan, "Conditional block does not have an expression")), null; let s = wi(n.parameters[0], t), r = null; for (let i = 1; i < n.parameters.length; i++) {
    let a = n.parameters[i], o = a.expression.match(ty);
    if (o === null)
...
function py(n, e) { let t = n.expression, s = /^\s$/, r = 0, i = 0, a = t.length - 1; for (let o = 0; o < t.length; o++) {
    let l = t[o];
    if (l === "(")
        i = o + 1, r++;
    else {
...
var Zl = class extends Ur {
    hasPipe = !1;
    visitPipe() { this.hasPipe = !0; }
}, fy = /^\d+\.?\d*(ms|s)?$/, dy = /^\s$/, Th = new Map([[yt, Le], [gn, Hn], [At, Pe]]), Ve = (function (n) { return n.IDLE = "idle", n.TIMER = "timer", n.INTERACTION = "interaction", n.IMMEDIATE = "immediate", n.HOVER = "hover", n.VIEWPORT = "viewport", n.NEVER = "never", n; })(Ve || {});
function my({ expression: n, sourceSpan: e }, t, s) { let r = n.indexOf("never"), i = new L(e.start.moveBy(r), e.start.moveBy(r + 5)), a = Zc(n, e), o = Jc(n, e); r === -1 ? s.push(new N(e, 'Could not find "never" keyword in expression')) : Kc("never", t, s, new sl(i, e, a, null, o)); }
function Io({ expression: n, sourceSpan: e }, t, s, r) { let i = n.indexOf("when"), a = new L(e.start.moveBy(i), e.start.moveBy(i + 4)), o = Zc(n, e), l = Jc(n, e); if (i === -1)
    r.push(new N(e, 'Could not find "when" keyword in expression'));
else {
    let c = Ei(n, i + 1), h = t.parseBinding(n.slice(c), !1, e, e.start.offset + c);
    Kc("when", s, r, new la(h, e, o, a, l));
} }
function No({ expression: n, sourceSpan: e }, t, s, r) { let i = n.indexOf("on"), a = new L(e.start.moveBy(i), e.start.moveBy(i + 2)), o = Zc(n, e), l = Jc(n, e); if (i === -1)
    s.push(new N(e, 'Could not find "on" keyword in expression'));
else {
    let c = Ei(n, i + 1);
    new Jl(n, c, e, t, s, n.startsWith("hydrate") ? Cy : yy, r, o, a, l).parse();
} }
function Zc(n, e) { return n.startsWith("prefetch") ? new L(e.start, e.start.moveBy(8)) : null; }
function Jc(n, e) { return n.startsWith("hydrate") ? new L(e.start, e.start.moveBy(7)) : null; }
var Jl = class {
    expression;
    start;
    span;
    ...
    index = 0;
    tokens;
    constructor(e, t, s, r, i, a, o, l, c, h) { this.expression = e, this.start = t, this.span = s, this.triggers = r, this.errors = i, this.validator = a, this.placeholder = o, this.prefetchSpan = l, this.onSourceSpan = c, this.hydrateSpan = h, this.tokens = new mi().tokenize(e.slice(t)); }
    ...
    consumeTrigger(e, t) { let s = this.span.start.moveBy(this.start + e.index - this.tokens[0].index), r = new L(s, s.moveBy(e.strValue.length)), i = s.moveBy(this.token().end - e.index), a = e.index === 0, o = a ? this.onSourceSpan : null, l = a ? this.prefetchSpan : null, c = a ? this.hydrateSpan : null, h = new L(a ? this.span.start : s, i); try {
        switch (e.toString()) {
            case Ve.IDLE:
                this.trackTrigger("idle", gy(t, r, h, l, o, c));
                break;
            case Ve.TIMER:
                this.trackTrigger("timer", vy(t, r, h, this.prefetchSpan, this.onSourceSpan, this.hydrateSpan));
                break;
            case Ve.INTERACTION:
                this.trackTrigger("interaction", Sy(t, r, h, this.prefetchSpan, this.onSourceSpan, this.hydrateSpan, this.validator));
                break;
            case Ve.IMMEDIATE:
                this.trackTrigger("immediate", wy(t, r, h, this.prefetchSpan, this.onSourceSpan, this.hydrateSpan));
                break;
            case Ve.HOVER:
                this.trackTrigger("hover", Ey(t, r, h, this.prefetchSpan, this.onSourceSpan, this.hydrateSpan, this.placeholder, this.validator));
                break;
            case Ve.VIEWPORT:
                this.trackTrigger("viewport", xy(t, r, h, this.prefetchSpan, this.onSourceSpan, this.hydrateSpan, this.validator));
                break;
    ...
    consumeParameters() { let e = []; if (!this.token().isCharacter(At))
        ...
        if (r.type === O.Character && Th.has(r.numValue) && t.push(Th.get(r.numValue)), t.length > 0 && r.isCharacter(t[t.length - 1]) && t.pop(), t.length === 0 && r.isCharacter(ht) && s.length > 0) {
    ...
    trackTrigger(e, t) { Kc(e, this.triggers, this.errors, t); }
...
function Kc(n, e, t, s) { e[n] ? t.push(new N(s.sourceSpan, `Duplicate "${n}" trigger is not allowed`)) : e[n] = s; }
function gy(n, e, t, s, r, i) { if (n.length > 0)
    throw new Error(`"${Ve.IDLE}" trigger cannot have parameters`); return new rl(e, t, s, r, i); }
function vy(n, e, t, s, r, i) { if (n.length !== 1)
...
function wy(n, e, t, s, r, i) { if (n.length > 0)
    throw new Error(`"${Ve.IMMEDIATE}" trigger cannot have parameters`); return new il(e, t, s, r, i); }
function Ey(n, e, t, s, r, i, a, o) { return o(Ve.HOVER, n), new ca(n[0] ?? null, e, t, s, r, i); }
function Sy(n, e, t, s, r, i, a) { return a(Ve.INTERACTION, n), new ua(n[0] ?? null, e, t, s, r, i); }
function xy(n, e, t, s, r, i, a) { return a(Ve.VIEWPORT, n), new ha(n[0] ?? null, e, t, s, r, i); }
function yy(n, e) { if (e.length > 1)
    throw new Error(`"${n}" trigger can only have zero or one parameters`); }
function Cy(n, e) { if (e.length > 0)
    throw new Error(`Hydration trigger "${n}" cannot have parameters`); }
function Ei(n, e = 0) { let t = !1; for (let s = e; s < n.length; s++)
    if (dy.test(n[s]))
        t = !0;
    else if (t)
        return s; return -1; }
function Xa(n) { let e = n.match(fy); if (!e)
    return null; let [t, s] = e; return parseFloat(t) * (s === "s" ? 1e3 : 1); }
var Ay = /^prefetch\s+when\s/, _y = /^prefetch\s+on\s/, ky = /^hydrate\s+when\s/, by = /^hydrate\s+on\s/, Ty = /^hydrate\s+never(\s*)$/, Wf = /^minimum\s/, Iy = /^after\s/, Ny = /^when\s/, Dy = /^on\s/;
function Kl(n) { return n === "placeholder" || n === "loading" || n === "error"; }
function Py(n, e, t, s) { let r = [], { placeholder: i, loading: a, error: o } = Ly(e, r, t), { triggers: l, prefetchTriggers: c, hydrateTriggers: h } = Fy(n, s, r, i), p = n.endSourceSpan, g = n.sourceSpan.end; if (e.length > 0) {
    let C = e[e.length - 1];
...
function Ly(n, e, t) { let s = null, r = null, i = null; for (let a of n)
    try {
        if (!Kl(a.name)) {
        ...
        switch (a.name) {
            case "placeholder":
                s !== null ? e.push(new N(a.startSourceSpan, "@defer block can only have one @placeholder block")) : s = By(a, t);
                break;
            case "loading":
                r !== null ? e.push(new N(a.startSourceSpan, "@defer block can only have one @loading block")) : r = My(a, t);
                break;
            case "error":
                i !== null ? e.push(new N(a.startSourceSpan, "@defer block can only have one @error block")) : i = Ry(a, t);
                break;
        }
    }
    catch (o) {
...
function By(n, e) { let t = null; for (let s of n.parameters)
    if (Wf.test(s.expression)) {
        if (t != null)
            throw new Error('@placeholder block can only have one "minimum" parameter');
        let r = Xa(s.expression.slice(Ei(s.expression)));
        if (r === null)
            throw new Error('Could not parse time value of parameter "minimum"');
        t = r;
    }
    else
        throw new Error(`Unrecognized parameter in @placeholder block: "${s.expression}"`); return new Hr(P(e, n.children, n.children), t, n.nameSpan, n.sourceSpan, n.startSourceSpan, n.endSourceSpan, n.i18n); }
function My(n, e) { let t = null, s = null; for (let r of n.parameters)
    if (Iy.test(r.expression)) {
        if (t != null)
            throw new Error('@loading block can only have one "after" parameter');
        let i = Xa(r.expression.slice(Ei(r.expression)));
        if (i === null)
        ...
        throw new Error(`Unrecognized parameter in @loading block: "${r.expression}"`); return new Wr(P(e, n.children, n.children), t, s, n.nameSpan, n.sourceSpan, n.startSourceSpan, n.endSourceSpan, n.i18n); }
function Ry(n, e) { if (n.parameters.length > 0)
    throw new Error("@error block cannot have parameters"); return new jr(P(e, n.children, n.children), n.nameSpan, n.sourceSpan, n.startSourceSpan, n.endSourceSpan, n.i18n); }
function Fy(n, e, t, s) { let r = {}, i = {}, a = {}; for (let o of n.parameters)
    Ny.test(o.expression) ? Io(o, e, r, t) : Dy.test(o.expression) ? No(o, r, t, s) : Ay.test(o.expression) ? Io(o, e, i, t) : _y.test(o.expression) ? No(o, i, t, s) : ky.test(o.expression) ? Io(o, e, a, t) : by.test(o.expression) ? No(o, a, t, s) : Ty.test(o.expression) ? my(o, a, t) : t.push(new N(o.sourceSpan, "Unrecognized trigger")); return a.never && Object.keys(a).length > 1 && t.push(new N(n.startSourceSpan, "Cannot specify additional `hydrate` triggers if `hydrate never` is present")), { triggers: r, prefetchTriggers: i, hydrateTriggers: a }; }
var $y = /^(?:(bind-)|(let-)|(ref-|#)|(on-)|(bindon-)|(@))(.*)$/, Ih = 1, Nh = 2, Dh = 3, Ph = 4, Lh = 5, Oy = 6, ur = 7, cn = { BANANA_BOX: { start: "[(", end: ")]" }, PROPERTY: { start: "[", end: "]" }, EVENT: { start: "(", end: ")" } }, Do = "*", Vy = new Set(["link", "style", "script", "ng-template", "ng-container", "ng-content"]), qy = new Set(["ngProjectAs", "ngNonBindable"]);
function Uy(n, e, t) { let s = new ec(e, t), r = P(s, n, n), i = e.errors.concat(s.errors), a = { nodes: r, errors: i, styleUrls: s.styleUrls, styles: s.styles, ngContentSelectors: s.ngContentSelectors }; return t.collectCommentNodes && (a.commentNodes = s.commentNodes), a; }
var ec = class {
    bindingParser;
    options;
    errors = [];
    ...
    visitElement(e) { let t = ji(e.i18n); t && (this.inI18nBlock && this.reportError("Cannot mark an element as translatable inside of a translatable section. Please remove the nested i18n marker.", e.sourceSpan), this.inI18nBlock = !0); let s = Hf(e); if (s.type === Qe.SCRIPT)
    ...
    else if (s.type === Qe.STYLESHEET && qx(s.hrefAttr))
        return this.styleUrls.push(s.hrefAttr), null; let r = hm(e.name), { attributes: i, boundEvents: a, references: o, variables: l, templateVariables: c, elementHasInlineTemplate: h, parsedProperties: p, templateParsedProperties: g, i18nAttrsMeta: v } = this.prepareAttributes(e.attrs, r), E = this.extractDirectives(e), C; s.nonBindable ? C = P(Bh, e.children).flat(1 / 0) : C = P(this, e.children, e.children); let T; if (s.type === Qe.NG_CONTENT) {
        let A = s.selectAttr, F = e.attrs.map(te => this.visitAttribute(te));
        T = new qs(A, F, C, e.isSelfClosing, e.sourceSpan, e.startSourceSpan, e.endSourceSpan, e.i18n), this.ngContentSelectors.push(A);
    }
    else if (r) {
        let A = this.categorizePropertyAttributes(e.name, p, v);
        T = new Ke(e.name, i, A.bound, a, E, [], C, o, l, e.isSelfClosing, e.sourceSpan, e.startSourceSpan, e.endSourceSpan, e.i18n);
    }
    else {
        let A = this.categorizePropertyAttributes(e.name, p, v);
        ...
        T = new Ot(e.name, i, A.bound, a, E, C, o, e.isSelfClosing, e.sourceSpan, e.startSourceSpan, e.endSourceSpan, e.isVoid, e.i18n);
    } return h && (T = this.wrapInTemplate(T, g, c, v, r, t)), t && (this.inI18nBlock = !1), T; }
    ...
    visitExpansion(e) { if (!e.i18n)
        ...
        r[i] = this._visitTextWithInterpolation(a.text, a.sourceSpan, null); }), new Ep(s, r, e.sourceSpan, t); }
    ...
    visitComponent(e) { let t = ji(e.i18n); if (t && (this.inI18nBlock && this.reportError("Cannot mark a component as translatable inside of a translatable section. Please remove the nested i18n marker.", e.sourceSpan), this.inI18nBlock = !0), e.tagName !== null && Vy.has(e.tagName))
        return this.reportError(`Tag name "${e.tagName}" cannot be used as a component tag`, e.startSourceSpan), null; let { attributes: s, boundEvents: r, references: i, templateVariables: a, elementHasInlineTemplate: o, parsedProperties: l, templateParsedProperties: c, i18nAttrsMeta: h } = this.prepareAttributes(e.attrs, !1); this.validateSelectorlessReferences(i); let p = this.extractDirectives(e), g; e.attrs.find(C => C.name === "ngNonBindable") ? g = P(Bh, e.children).flat(1 / 0) : g = P(this, e.children, e.children); let v = this.categorizePropertyAttributes(e.tagName, l, h), E = new wr(e.componentName, e.tagName, e.fullName, s, v.bound, r, p, g, i, e.isSelfClosing, e.sourceSpan, e.startSourceSpan, e.endSourceSpan, e.i18n); return o && (E = this.wrapInTemplate(E, c, a, h, !1, t)), t && (this.inI18nBlock = !1), E; }
    ...
    visitBlock(e, t) { let s = Array.isArray(t) ? t.indexOf(e) : -1; if (s === -1)
        ...
        case "defer":
            r = Py(e, this.findConnectedBlocks(s, t, Kl), this, this.bindingParser);
            break;
        case "switch":
            r = ay(e, this, this.bindingParser);
            break;
        case "for":
            r = iy(e, this.findConnectedBlocks(s, t, _h), this, this.bindingParser);
            break;
        case "if":
            r = ry(e, this.findConnectedBlocks(s, t, kh), this, this.bindingParser);
            break;
        default:
            let i;
            Kl(e.name) ? (i = `@${e.name} block can only be used after an @defer block.`, this.processedNodes.add(e)) : _h(e.name) ? (i = `@${e.name} block can only be used after an @for block.`, this.processedNodes.add(e)) : kh(e.name) ? (i = `@${e.name} block can only be used after an @if or @else if block.`, this.processedNodes.add(e)) : i = `Unrecognized block @${e.name}.`, r = { node: new da(e.name, e.sourceSpan, e.nameSpan), errors: [new N(e.sourceSpan, i)] };
            break;
    } return this.errors.push(...r.errors), r.node; }
    findConnectedBlocks(e, t, s) { let r = []; for (let i = e + 1; i < t.length; i++) {
        let a = t[i];
        if (!(a instanceof Nn)) {
            if (a instanceof an && a.value.trim().length === 0) {
    ...
    prepareAttributes(e, t) { let s = [], r = [], i = [], a = [], o = [], l = {}, c = [], h = [], p = !1; for (let g of e) {
        ...
        if (g.i18n && (l[g.name] = g.i18n), E.startsWith(Do)) {
            ...
            let T = g.value, A = E.substring(Do.length), F = [], te = g.valueSpan ? g.valueSpan.fullStart.offset : g.sourceSpan.fullStart.offset + g.name.length;
            this.bindingParser.parseInlineTemplateBinding(A, T, g.sourceSpan, te, [], c, F, !0), h.push(...F.map(V => new An(V.name, V.value, V.sourceSpan, V.keySpan, V.valueSpan)));
        }
        else
    ...
    parseAttribute(e, t, s, r, i, a, o) { let l = Mh(t.name), c = t.value, h = t.sourceSpan, p = t.valueSpan ? t.valueSpan.fullStart.offset : h.fullStart.offset; function g(A, F, te) { let V = t.name.length - l.length, de = A.start.moveBy(F.length + V), rr = de.moveBy(te.length); return new L(de, rr, de, te); } let v = l.match($y); if (v) {
        if (v[Ih] != null) {
            let A = v[ur], F = g(h, v[Ih], A);
            this.bindingParser.parsePropertyBinding(A, c, !1, !1, h, p, t.valueSpan, s, r, F);
        }
        else if (v[Nh])
            if (e) {
                let A = v[ur], F = g(h, v[Nh], A);
                this.parseVariable(A, c, h, F, t.valueSpan, a);
            }
            else
                this.reportError('"let-" is only supported on ng-template elements.', h);
        else if (v[Dh]) {
            let A = v[ur], F = g(h, v[Dh], A);
            this.parseReference(A, c, h, F, t.valueSpan, o);
        }
        else if (v[Ph]) {
            let A = [], F = v[ur], te = g(h, v[Ph], F);
            this.bindingParser.parseEvent(F, c, !1, h, t.valueSpan || h, s, A, te), Po(A, i);
        }
        else if (v[Lh]) {
            let A = v[ur], F = g(h, v[Lh], A);
        ...
        return !0;
    } let E = null; if (l.startsWith(cn.BANANA_BOX.start) ? E = cn.BANANA_BOX : l.startsWith(cn.PROPERTY.start) ? E = cn.PROPERTY : l.startsWith(cn.EVENT.start) && (E = cn.EVENT), E !== null && l.endsWith(E.end) && l.length > E.start.length + E.end.length) {
        let A = l.substring(E.start.length, l.length - E.end.length), F = g(h, E.start, A);
        if (E.start === cn.BANANA_BOX.start)
            this.bindingParser.parsePropertyBinding(A, c, !1, !0, h, p, t.valueSpan, s, r, F), this.parseAssignmentEvent(A, c, h, t.valueSpan, s, i, F, p);
        else if (E.start === cn.PROPERTY.start)
            this.bindingParser.parsePropertyBinding(A, c, !1, !1, h, p, t.valueSpan, s, r, F);
        else {
            let te = [];
            this.bindingParser.parseEvent(A, c, !1, h, t.valueSpan || h, s, te, F), Po(te, i);
        }
        return !0;
    ...
    extractDirectives(e) { let t = e instanceof Ce ? e.tagName : e.name, s = [], r = new Set; for (let i of e.directives) {
        ...
        for (let v of i.attrs)
            v.name.startsWith(Do) ? (a = !0, this.reportError(`Shorthand template syntax "${v.name}" is not supported inside a directive context`, v.sourceSpan)) : qy.has(v.name) && (a = !0, this.reportError(`Attribute "${v.name}" is not supported in a directive context`, v.sourceSpan));
        ...
        a || (r.add(i.name), s.push(new wp(i.name, o, g, c, h, i.sourceSpan, i.startSourceSpan, i.endSourceSpan, void 0)));
    } return s; }
    ...
    parseVariable(e, t, s, r, i, a) { e.indexOf("-") > -1 ? this.reportError('"-" is not allowed in variable names', s) : e.length === 0 && this.reportError("Variable does not have a name", s), a.push(new An(e, t, s, r, i)); }
    parseReference(e, t, s, r, i, a) { e.indexOf("-") > -1 ? this.reportError('"-" is not allowed in reference names', s) : e.length === 0 ? this.reportError("Reference does not have a name", s) : a.some(o => o.name === e) && this.reportError(`Reference "#${e}" is defined more than once`, s), a.push(new Xr(e, t, s, r, i)); }
    ...
    reportError(e, t, s = dn.ERROR) { this.errors.push(new N(t, e, s)); }
}, tc = class {
...
function Mh(n) { return /^data-/i.test(n) ? n.substring(5) : n; }
function Po(n, e) { e.push(...n.map(t => nl.fromParsedEvent(t))); }
function Hy(n) { return n.children.length !== 1 || !(n.children[0] instanceof an) ? null : n.children[0].value; }
var Wy = [" ", `
`, "\r", "	"];
function jf(n, e, t = {}) { let { interpolationConfig: s, preserveWhitespaces: r, enableI18nLegacyMessageIdFormat: i } = t, a = t.enableSelectorless ?? !1, o = Ya(s, a), c = new Ga().parse(n, e, ue(S({ leadingTriviaChars: Wy }, t), { tokenizeExpansionForms: !0, tokenizeBlocks: t.enableBlockSyntax ?? !0, tokenizeLet: t.enableLetSyntax ?? !0, selectorlessEnabled: a })); if (!t.alwaysAttemptHtmlToR3AstConversion && c.errors && c.errors.length > 0) {
    ...
    return t.collectCommentNodes && (de.commentNodes = []), de;
} h = v.rootNodes, r || (h = P(new di(!0, void 0, !1), h), g.hasI18nMeta && (h = P(new Oa(s, !1, void 0, void 0, !0, p), h))); let { nodes: E, errors: C, styleUrls: T, styles: A, ngContentSelectors: F, commentNodes: te } = Uy(h, o, { collectCommentNodes: !!t.collectCommentNodes }); C.push(...c.errors, ...v.errors); let V = { interpolationConfig: s, preserveWhitespaces: r, errors: C.length > 0 ? C : null, nodes: E, styleUrls: T, styles: A, ngContentSelectors: F }; return t.collectCommentNodes && (V.commentNodes = te), V; }
var jy = new Qs;
function Ya(n = ot, e = !1) { return new Xl(new $a(new mi, e), n, jy, []); }
var Qa = "%COMP%", nc = `_nghost-${Qa}`, sc = `_ngcontent-${Qa}`;
function zf(n, e, t) { let s = new ae, r = so(n.selector); return s.set("type", n.type.value), r.length > 0 && s.set("selectors", Me(r)), n.queries.length > 0 && s.set("contentQueries", Rx(n.queries, e, n.name)), n.viewQueries.length && s.set("viewQuery", Mx(n.viewQueries, e, n.name)), s.set("hostBindings", Zy(n.host, n.typeSourceSpan, t, e, n.selector || "", n.name, s)), s.set("inputs", dl(n.inputs, !0)), s.set("outputs", dl(n.outputs)), n.exportAs !== null && s.set("exportAs", R(n.exportAs.map(i => d(i)))), n.isStandalone === !1 && s.set("standalone", d(!1)), n.isSignal && s.set("signals", d(!0)), s; }
function Gf(n, e) { let t = [], s = e.providers, r = e.viewProviders; if (s || r) {
    let i = [s || new dt([])];
    r && i.push(r), t.push(y(f.ProvidersFeature).callFn(i));
} if (e.hostDirectives?.length && t.push(y(f.HostDirectivesFeature).callFn([nC(e.hostDirectives)])), e.usesInheritance && t.push(y(f.InheritDefinitionFeature)), e.fullInheritance && t.push(y(f.CopyDefinitionFeature)), e.lifecycle.usesOnChanges && t.push(y(f.NgOnChangesFeature)), "externalStyles" in e && e.externalStyles?.length) {
    let i = e.externalStyles.map(a => d(a));
    t.push(y(f.ExternalStylesFeature).callFn([R(i)]));
} t.length && n.set("features", R(t)); }
function zy(n, e, t) { let s = zf(n, e, t); Gf(s, n); let r = y(f.defineDirective).callFn([s.toLiteralMap()], void 0, !0), i = Qf(n); return { expression: r, type: i, statements: [] }; }
function Gy(n, e, t) { let s = zf(n, e, t); Gf(s, n); let r = n.selector && Jn.parse(n.selector), i = r && r[0]; if (i) {
    let E = i.getAttrs();
    ...
    let C = (n.encapsulation == xt.Emulated ? tC(n.styles, sc, nc) : n.styles).reduce((T, A) => (A.trim().length > 0 && T.push(e.getConstLiteral(d(A))), T), []);
    C.length > 0 && (p = !0, s.set("styles", R(C)));
} !p && n.encapsulation === xt.Emulated && (n.encapsulation = xt.None), n.encapsulation !== xt.Emulated && s.set("encapsulation", d(n.encapsulation)), n.animations !== null && s.set("data", he([{ key: "animation", value: n.animations, quoted: !1 }])), n.changeDetection !== null && (typeof n.changeDetection == "number" && n.changeDetection !== Si.Default ? s.set("changeDetection", d(n.changeDetection)) : typeof n.changeDetection == "object" && s.set("changeDetection", n.changeDetection)); let g = y(f.defineComponent).callFn([s.toLiteralMap()], void 0, !0), v = Xf(n); return { expression: g, type: v, statements: [] }; }
...
function Yf(n) { let e = n.selector !== null ? n.selector.replace(/\n/g, "") : null; return [ao(n.type.type, n.typeArgumentCount), e !== null ? Yy(e) : kt, n.exportAs !== null ? ic(n.exportAs) : kt, we(Qy(n)), we(rc(n.outputs)), ic(n.queries.map(t => t.propertyName))]; }
function Qy(n) { return he(Object.keys(n.inputs).map(e => { let t = n.inputs[e], s = [{ key: "alias", value: d(t.bindingPropertyName), quoted: !0 }, { key: "required", value: d(t.required), quoted: !0 }]; return t.isSignal && s.push({ key: "isSignal", value: d(t.isSignal), quoted: !0 }), { key: e, value: he(s), quoted: !0 }; })); }
...
function Zy(n, e, t, s, r, i, a) { let o = t.createBoundHostProperties(n.properties, e), l = t.createDirectiveHostEventAsts(n.listeners, e); n.specialAttributes.styleAttr && (n.attributes.style = d(n.specialAttributes.styleAttr)), n.specialAttributes.classAttr && (n.attributes.class = d(n.specialAttributes.classAttr)); let c = fx({ componentName: i, componentSelector: r, properties: o, events: l, attributes: n.attributes }, t, s); Df(c, _.Host), a.set("hostAttrs", c.root.attributes); let h = c.root.vars; return h !== null && h > 0 && a.set("hostVars", d(h)), cx(c); }
var Jy = /^(?:\[([^\]]+)\])|(?:\(([^\)]+)\))$/;
function Ky(n) { let e = {}, t = {}, s = {}, r = {}; for (let i of Object.keys(n)) {
    let a = n[i], o = i.match(Jy);
    if (o === null)
        switch (i) {
            case "class":
                if (typeof a != "string")
...
function eC(n, e) { let t = Ya(); return t.createDirectiveHostEventAsts(n.listeners, e), t.createBoundHostProperties(n.properties, e), t.errors; }
function tC(n, e, t) { let s = new xa; return n.map(r => s.shimCssText(r, e, t)); }
function jA(n, e) { let t = new xa, s = e ? sc.replace(Qa, e) : sc, r = e ? nc.replace(Qa, e) : nc; return t.shimCssText(n, s, r); }
...
function nC(n) { let e = [], t = !1; for (let s of n) {
...
function zA(n) { let e = []; if (n.mode === 0)
    for (let t of n.dependencies)
        if (t.isDeferrable) {
            let s = ie([new K("m", He)], D("m").prop(t.isDefaultImport ? "default" : t.symbolName)), r = new es(t.importPath).prop("then").callFn([s]);
            e.push(r);
        }
        else
    ...
    for (let { symbolName: t, importPath: s, isDefaultImport: r } of n.dependencies) {
        let i = ie([new K("m", He)], D("m").prop(r ? "default" : t)), a = new es(s).prop("then").callFn([i]);
        e.push(a);
    } return ie([], R(e)); }
var ac = class extends Ur {
...
function Rh(n, e) { let t = new Set(e); return n.filter(s => !t.has(s)); }
function GA(n, e) { let t = new Cr; for (let c of e) {
...
} let s = jf(n, ""), i = new Ja(t).bind({ template: s.nodes }), a = i.getEagerlyUsedDirectives().map(c => c.selector), o = i.getUsedDirectives().map(c => c.selector), l = i.getEagerlyUsedPipes(); return { directives: { regular: a, deferCandidates: Rh(o, a) }, pipes: { regular: l, deferCandidates: Rh(i.getUsedPipes(), l) } }; }
var Ja = class {
    directiveMatcher;
    ...
    bind(e) { if (!e.template && !e.host)
        ...
        sC(E, o), oc.apply(e.template, this.directiveMatcher, t, s, r, i, a), eo.applyWithScope(e.template, E, l, c, h, p, g, v);
    ...
    ingest(e) { e instanceof Ke ? (e.variables.forEach(t => this.visitVariable(t)), e.children.forEach(t => t.visit(this))) : e instanceof Gn ? (e.expressionAlias !== null && this.visitVariable(e.expressionAlias), e.children.forEach(t => t.visit(this))) : e instanceof Vs ? (this.visitVariable(e.item), e.contextVariables.forEach(t => this.visitVariable(t)), e.children.forEach(t => t.visit(this))) : e instanceof zr || e instanceof Gr || e instanceof is || e instanceof jr || e instanceof Hr || e instanceof Wr || e instanceof qs ? e.children.forEach(t => t.visit(this)) : e instanceof Yr || e.forEach(t => t.visit(this)); }
    ...
    visitElementOrTemplate(e) { if (this.directiveMatcher instanceof Cr) {
        let t = [], s = Am(e);
    ...
    ingest(e) { if (e instanceof Ke)
        ...
        e instanceof zr || e instanceof Gr || e instanceof jr || e instanceof Hr || e instanceof Wr || e instanceof qs ? (e.children.forEach(t => t.visit(this)), this.nestingLevel.set(e, this.level)) : e instanceof Yr ? this.nestingLevel.set(e, 0) : e.forEach(this.visitNode); }
    ...
    getDeferredTriggerTarget(e, t) { if (!(t instanceof ua) && !(t instanceof ha) && !(t instanceof ca))
        ...
        return i;
    } let r = this.findEntityInScope(e, s); if (r instanceof Xr && this.getDefinitionNodeOfSymbol(r) !== e) {
        let i = this.getReferenceTarget(r);
        if (i !== null)
            return this.referenceTargetToElement(i);
    } if (e.placeholder !== null) {
        let i = this.findEntityInScope(e.placeholder, s), a = i instanceof Xr ? this.getReferenceTarget(i) : null;
        if (a !== null)
    ...
    referenceTargetToElement(e) { return e instanceof Ot ? e : e instanceof Ke || e.node instanceof wr || e.node instanceof wp || e.node instanceof Yr ? null : this.referenceTargetToElement(e.node); }
};
function sC(n, e) { let t = new Map; function s(i) { if (t.has(i.rootNode))
...
var cc = class {
    ...
    compilePipe(e, t, s) { let r = { name: s.name, type: ge(s.type), typeArgumentCount: 0, deps: null, pipeName: s.pipeName, pure: s.pure, isStandalone: s.isStandalone }, i = _u(r); return this.jitExpression(i.expression, e, t, []); }
    compilePipeDeclaration(e, t, s) { let r = SC(s), i = _u(r); return this.jitExpression(i.expression, e, t, []); }
    compileInjectable(e, t, s) { let { expression: r, statements: i } = mu({ name: s.name, type: ge(s.type), typeArgumentCount: s.typeArgumentCount, providedIn: Uh(s.providedIn), useClass: ws(s, "useClass"), useFactory: qh(s, "useFactory"), useValue: ws(s, "useValue"), useExisting: ws(s, "useExisting"), deps: s.deps?.map(td) }, !0); return this.jitExpression(r, e, t, i); }
    compileInjectableDeclaration(e, t, s) { let { expression: r, statements: i } = mu({ name: s.type.name, type: ge(s.type), typeArgumentCount: 0, providedIn: Uh(s.providedIn), useClass: ws(s, "useClass"), useFactory: qh(s, "useFactory"), useValue: ws(s, "useValue"), useExisting: ws(s, "useExisting"), deps: s.deps?.map(Hh) }, !0); return this.jitExpression(r, e, t, i); }
    compileInjector(e, t, s) { let r = { name: s.name, type: ge(s.type), providers: s.providers && s.providers.length > 0 ? new H(s.providers) : null, imports: s.imports.map(a => new H(a)) }, i = Au(r); return this.jitExpression(i.expression, e, t, []); }
    compileInjectorDeclaration(e, t, s) { let r = xC(s), i = Au(r); return this.jitExpression(i.expression, e, t, []); }
    ...
    compileDirective(e, t, s) { let r = Oh(s); return this.compileDirectiveFromMeta(e, t, r); }
    ...
    compileDirectiveFromMeta(e, t, s) { let r = new Zi, i = Ya(), a = zy(s, r, i); return this.jitExpression(a.expression, e, t, r.statements); }
    compileComponent(e, t, s) { let { template: r, interpolation: i, defer: a } = ed(s.template, s.name, t, s.preserveWhitespaces, s.interpolation, void 0), o = ue(S(S({}, s), Oh(s)), { selector: s.selector || this.elementSchemaRegistry.getDefaultComponentElementName(), template: r, declarations: s.declarations.map(oC), declarationListEmitMode: 0, defer: a, styles: [...s.styles, ...r.styles], encapsulation: s.encapsulation, interpolation: i, changeDetection: s.changeDetection ?? null, animations: s.animations != null ? new H(s.animations) : null, viewProviders: s.viewProviders != null ? new H(s.viewProviders) : null, relativeContextFilePath: "", i18nUseExternalIds: !0, relativeTemplatePath: null }), l = `ng:///${s.name}.js`; return this.compileComponentFromMeta(e, l, o); }
    compileComponentDeclaration(e, t, s) { let r = this.createParseSourceSpan("Component", s.type.name, t), i = aC(s, r, t); return this.compileComponentFromMeta(e, t, i); }
    compileComponentFromMeta(e, t, s) { let r = new Zi, i = Ya(s.interpolation), a = Gy(s, r, i); return this.jitExpression(a.expression, e, t, r.statements); }
    compileFactory(e, t, s) { let r = $n({ name: s.name, type: ge(s.type), typeArgumentCount: s.typeArgumentCount, deps: uC(s.deps), target: s.target }); return this.jitExpression(r.expression, e, t, r.statements); }
    compileFactoryDeclaration(e, t, s) { let r = $n({ name: s.type.name, type: ge(s.type), typeArgumentCount: 0, deps: Array.isArray(s.deps) ? s.deps.map(Hh) : s.deps, target: s.target }); return this.jitExpression(r.expression, e, t, r.statements); }
...
function Fh(n) { return ue(S({}, n), { isSignal: n.isSignal, predicate: Jf(n.predicate), read: n.read ? new H(n.read) : null, static: n.static, emitDistinctChangesOnly: n.emitDistinctChangesOnly }); }
function $h(n) { return { propertyName: n.propertyName, first: n.first ?? !1, predicate: Jf(n.predicate), descendants: n.descendants ?? !1, read: n.read ? new H(n.read) : null, static: n.static ?? !1, emitDistinctChangesOnly: n.emitDistinctChangesOnly ?? !0, isSignal: !!n.isSignal }; }
function Jf(n) { return Array.isArray(n) ? n : Nc(new H(n), 1); }
function Oh(n) { let e = EC(n.inputs || []), t = Bo(n.outputs || []), s = n.propMetadata, r = {}, i = {}; for (let o in s)
    s.hasOwnProperty(o) && s[o].forEach(l => { mC(l) ? r[o] = { bindingPropertyName: l.alias || o, classPropertyName: o, required: l.required || !1, isSignal: !!l.isSignal, transformFunction: l.transform != null ? new H(l.transform) : null } : gC(l) && (i[o] = l.alias || o); }); let a = n.hostDirectives?.length ? n.hostDirectives.map(o => typeof o == "function" ? { directive: ge(o), inputs: null, outputs: null, isForwardReference: !1 } : { directive: ge(o.directive), isForwardReference: !1, inputs: o.inputs ? Bo(o.inputs) : null, outputs: o.outputs ? Bo(o.outputs) : null }) : null; return ue(S({}, n), { typeArgumentCount: 0, typeSourceSpan: n.typeSourceSpan, type: ge(n.type), deps: null, host: S({}, pC(n.propMetadata, n.typeSourceSpan, n.host)), inputs: S(S({}, e), r), outputs: S(S({}, t), i), queries: n.queries.map(Fh), providers: n.providers != null ? new H(n.providers) : null, viewQueries: n.viewQueries.map(Fh), fullInheritance: !1, hostDirectives: a }); }
function Kf(n, e) { let t = n.hostDirectives?.length ? n.hostDirectives.map(s => ({ directive: ge(s.directive), isForwardReference: !1, inputs: s.inputs ? Vh(s.inputs) : null, outputs: s.outputs ? Vh(s.outputs) : null })) : null; return { name: n.type.name, type: ge(n.type), typeSourceSpan: e, selector: n.selector ?? null, inputs: n.inputs ? vC(n.inputs) : {}, outputs: n.outputs ?? {}, host: rC(n.host), queries: (n.queries ?? []).map($h), viewQueries: (n.viewQueries ?? []).map($h), providers: n.providers !== void 0 ? new H(n.providers) : null, exportAs: n.exportAs ?? null, usesInheritance: n.usesInheritance ?? !1, lifecycle: { usesOnChanges: n.usesOnChanges ?? !1 }, deps: null, typeArgumentCount: 0, fullInheritance: !1, isStandalone: n.isStandalone ?? mp(n.version), isSignal: n.isSignal ?? !1, hostDirectives: t }; }
function rC(n = {}) { return { attributes: iC(n.attributes ?? {}), listeners: n.listeners ?? {}, properties: n.properties ?? {}, specialAttributes: { classAttr: n.classAttribute, styleAttr: n.styleAttribute } }; }
function Vh(n) { let e = null; for (let t = 1; t < n.length; t += 2)
    e = e || {}, e[n[t - 1]] = n[t]; return e; }
function iC(n) { let e = {}; for (let t of Object.keys(n))
    e[t] = new H(n[t]); return e; }
function aC(n, e, t) { let { template: s, interpolation: r, defer: i } = ed(n.template, n.type.name, t, n.preserveWhitespaces ?? !1, n.interpolation, n.deferBlockDependencies), a = []; if (n.dependencies)
    ...
    (n.components || n.directives || n.pipes) && (n.components && a.push(...n.components.map(l => Lo(l, !0))), n.directives && a.push(...n.directives.map(l => Lo(l))), n.pipes && a.push(...lC(n.pipes))); let o = a.some(({ kind: l }) => l === Kt.Directive || l === Kt.NgModule); return ue(S({}, Kf(n, e)), { template: s, styles: n.styles ?? [], declarations: a, viewProviders: n.viewProviders !== void 0 ? new H(n.viewProviders) : null, animations: n.animations !== void 0 ? new H(n.animations) : null, defer: i, changeDetection: n.changeDetection ?? Si.Default, encapsulation: n.encapsulation ?? xt.Emulated, interpolation: r, declarationListEmitMode: 2, relativeContextFilePath: "", i18nUseExternalIds: !0, relativeTemplatePath: null, hasDirectiveDependencies: o }); }
function oC(n) { return ue(S({}, n), { type: new H(n.type) }); }
...
function lC(n) { return n ? Object.keys(n).map(e => ({ kind: Kt.Pipe, name: e, type: new H(n[e]) })) : []; }
function cC(n) { return { kind: Kt.Pipe, name: n.name, type: new H(n.type) }; }
...
} let c = new Ja(null).bind({ template: o.nodes }); return { template: o, interpolation: a, defer: hC(c, i) }; }
function ws(n, e) { if (n.hasOwnProperty(e))
    return Nc(new H(n[e]), 0); }
function qh(n, e) { if (n.hasOwnProperty(e))
    return new H(n[e]); }
function Uh(n) { let e = typeof n == "function" ? new H(n) : new Ee(n ?? null); return Nc(e, 0); }
function uC(n) { return n == null ? null : n.map(td); }
...
function Hh(n) { let e = n.attribute ?? !1, t = n.token === null ? null : new H(n.token); return nd(t, e, n.host ?? !1, n.optional ?? !1, n.self ?? !1, n.skipSelf ?? !1); }
...
`));
    for (let i in n)
        n.hasOwnProperty(i) && n[i].forEach(a => { fC(a) ? s.properties[a.hostPropertyName || i] = rm("this", i) : dC(a) && (s.listeners[a.eventName || i] = `${i}(${(a.args || []).join(",")})`); });
    return s;
}
function fC(n) { return n.ngMetadataName === "HostBinding"; }
function dC(n) { return n.ngMetadataName === "HostListener"; }
function mC(n) { return n.ngMetadataName === "Input"; }
function gC(n) { return n.ngMetadataName === "Output"; }
function vC(n) { return Object.keys(n).reduce((e, t) => { let s = n[t]; return typeof s == "string" || Array.isArray(s) ? e[t] = wC(s) : e[t] = { bindingPropertyName: s.publicName, classPropertyName: t, transformFunction: s.transformFunction !== null ? new H(s.transformFunction) : null, required: s.isRequired, isSignal: s.isSignal }, e; }, {}); }
function wC(n) { return typeof n == "string" ? { bindingPropertyName: n, classPropertyName: n, transformFunction: null, required: !1, isSignal: !1 } : { bindingPropertyName: n[0], classPropertyName: n[1], transformFunction: n[2] ? new H(n[2]) : null, required: !1, isSignal: !1 }; }
function EC(n) { return n.reduce((e, t) => { if (typeof t == "string") {
    let [s, r] = sd(t);
...
function SC(n) { return { name: n.type.name, type: ge(n.type), typeArgumentCount: 0, pipeName: n.name, deps: null, pure: n.pure ?? !0, isStandalone: n.isStandalone ?? mp(n.version) }; }
function xC(n) { return { name: n.type.name, type: ge(n.type), providers: n.providers !== void 0 && n.providers.length > 0 ? new H(n.providers) : null, imports: n.imports !== void 0 ? n.imports.map(e => new H(e)) : [] }; }
function XA(n) { let e = n.ng || (n.ng = {}); e.\u0275compilerFacade = new uc; }
var Wh = class {
    defaultEncapsulation;
    preserveWhitespaces;
    strictInjectionParameters;
    constructor({ defaultEncapsulation: e = xt.Emulated, preserveWhitespaces: t, strictInjectionParameters: s } = {}) { this.defaultEncapsulation = e, this.preserveWhitespaces = yC(Xd(t)), this.strictInjectionParameters = s === !0; }
};
function yC(n, e = !1) { return n === null ? e : n; }
var rd = "i18n", hr = "i18n-", CC = /^i18n:?/, AC = "|", _C = "@@", jh = !1;
function kC(n, e, t, s, r) { return new to(t, s, r).extract(n, e); }
function bC(n, e, t, s, r) { return new to(s, r).merge(n, e, t); }
var hc = class {
    messages;
    errors;
    ...
    visitExpansionCase(e, t) { let s = P(this, e.expression, t); if (this._mode === Pt.Merge)
        return new hi(e.value, s, e.sourceSpan, e.valueSourceSpan, e.expSourceSpan); }
    visitExpansion(e, t) { this._mayBeAddBlockChildren(e); let s = this._inIcu; this._inIcu || (this._isInTranslatableSection && this._addMessage([e]), this._inIcu = !0); let r = P(this, e.cases, t); return this._mode === Pt.Merge && (e = new vn(e.switchValue, e.type, r, e.sourceSpan, e.switchValueSourceSpan)), this._inIcu = s, e; }
    visitComment(e, t) { let s = TC(e); if (s && this._isInTranslatableSection) {
        this._reportError(e, "Could not start a block inside a translatable section");
        return;
    } let r = IC(e); if (r && !this._inI18nBlock) {
        ...
        if (this._inI18nBlock) {
            ...
            this._inI18nBlock = !0, this._blockStartDepth = this._depth, this._blockChildren = [], this._blockMeaningAndDesc = e.value.replace(CC, "").trim(), this._openTranslatableSection(e);
        }
    } }
    ...
    visitComponent(e, t) { return this._visitElementLike(e, t); }
    visitDirective(e, t) { throw new Error("unreachable code"); }
    _init(e, t) { this._mode = e, this._inI18nBlock = !1, this._inI18nNode = !1, this._depth = 0, this._inIcu = !1, this._msgCountAtSectionStart = void 0, this._errors = [], this._messages = [], this._inImplicitNode = !1, this._createI18nMessage = yf(t, kp, !this._preserveSignificantWhitespace, this._preserveSignificantWhitespace); }
    _visitElementLike(e, t) { this._mayBeAddBlockChildren(e), this._depth++; let s = this._inI18nNode, r = this._inImplicitNode, i = [], a, o = e instanceof Ce ? e.tagName : e.name, l = NC(e), c = l ? l.value : "", h = this._implicitTags.some(g => o === g) && !this._inIcu && !this._isInTranslatableSection, p = !r && h; if (this._inImplicitNode = r || h, !this._isInTranslatableSection && !this._inIcu) {
        if (l || p) {
            this._inI18nNode = !0;
    ...
    _visitAttributesOf(e) { let t = {}, s = this._implicitAttrs[e instanceof Ce ? e.tagName || "" : e.name] || []; e.attrs.filter(r => r instanceof wn && r.name.startsWith(hr)).forEach(r => { t[r.name.slice(hr.length)] = r.value; }), e.attrs.forEach(r => { r.name in t ? this._addMessage([r], t[r.name]) : s.some(i => r.name === i) && this._addMessage([r]); }); }
    _addMessage(e, t) { if (e.length == 0 || this._isEmptyAttributeValue(e) || this._isPlaceholderOnlyAttributeValue(e) || this._isPlaceholderOnlyMessage(e))
        return null; let { meaning: s, description: r, id: i } = zh(t), a = this._createI18nMessage(e, s, r, i); return this._messages.push(a), a; }
    _isEmptyAttributeValue(e) { return Gh(e) ? e[0].value.trim() === "" : !1; }
    _isPlaceholderOnlyAttributeValue(e) { if (!Gh(e))
    ...
    _isPlaceholderOnlyMessage(e) { if (!DC(e))
    ...
    _translateAttributes(e) { let t = {}, s = []; return e.attrs.forEach(r => { r.name.startsWith(hr) && (t[r.name.slice(hr.length)] = zh(r.value)); }), e.attrs.forEach(r => { if (!(r.name === rd || r.name.startsWith(hr)))
        if (r.value && r.value != "" && t.hasOwnProperty(r.name)) {
            ...
            if (c)
                if (c.length == 0)
                    s.push(new wn(r.name, "", r.sourceSpan, void 0, void 0, void 0, void 0));
                else if (c[0] instanceof an) {
                    let h = c[0].value;
                    s.push(new wn(r.name, h, r.sourceSpan, void 0, void 0, void 0, void 0));
                }
                else
...
function TC(n) { return !!(n instanceof Nn && n.value && n.value.startsWith("i18n")); }
function IC(n) { return !!(n instanceof Nn && n.value && n.value === "/i18n"); }
function NC(n) { return n.attrs.find(e => e instanceof wn && e.name === rd) || null; }
function zh(n) { if (!n)
    return { meaning: "", description: "", id: "" }; let e = n.indexOf(_C), t = n.indexOf(AC), [s, r] = e > -1 ? [n.slice(0, e), n.slice(e + 2)] : [n, ""], [i, a] = t > -1 ? [s.slice(0, t), s.slice(t + 1)] : ["", s]; return { meaning: i, description: a, id: r.trim() }; }
function DC(n) { return n.length === 1 && n[0] instanceof an; }
function Gh(n) { return n.length === 1 && n[0] instanceof wn; }
var pc = class {
    closedByParent = !1;
...
function LC(n) { return PC; }
var Dn = class extends mf {
    constructor() { super(LC); }
    parse(e, t, s = {}) { return super.parse(e, t, ue(S({}, s), { tokenizeBlocks: !1, tokenizeLet: !1, selectorlessEnabled: !1 })); }
}, BC = "1.2", MC = "urn:oasis:names:tc:xliff:document:1.2", RC = "en", zt = "x", FC = "mrk", $C = "file", id = "source", OC = "seg-source", VC = "alt-trans", qC = "target", fc = "trans-unit", UC = "context-group", Xh = "context", dc = class extends Us {
    write(e, t) { let s = new HC, r = []; e.forEach(l => { let c = []; l.sources.forEach(p => { let g = new M(UC, { purpose: "location" }); g.children.push(new j(10), new M(Xh, { "context-type": "sourcefile" }, [new Q(p.filePath)]), new j(10), new M(Xh, { "context-type": "linenumber" }, [new Q(`${p.startLine}`)]), new j(8)), c.push(new j(8), g); }); let h = new M(fc, { id: l.id, datatype: "html" }); h.children.push(new j(8), new M(id, {}, s.serialize(l.nodes)), ...c), l.description && h.children.push(new j(8), new M("note", { priority: "1", from: "description" }, [new Q(l.description)])), l.meaning && h.children.push(new j(8), new M("note", { priority: "1", from: "meaning" }, [new Q(l.meaning)])), h.children.push(new j(6)), r.push(new j(6), h); }); let i = new M("body", {}, [...r, new j(4)]), a = new M("file", { "source-language": t || RC, datatype: "plaintext", original: "ng2.template" }, [new j(4), i, new j(2)]), o = new M("xliff", { version: BC, xmlns: MC }, [new j(2), a, new j]); return Lc([new Qr({ version: "1.0", encoding: "UTF-8" }), new j, o, new j]); }
    load(e, t) {
        let s = new mc, { locale: r, msgIdToHtml: i, errors: a } = s.parse(e, t), o = {}, l = new WC;
...
`)}`);
    ...
    digest(e) { return tp(e); }
}, HC = class {
    visitText(e, t) { return [new Q(e.value)]; }
    visitContainer(e, t) { let s = []; return e.children.forEach(r => s.push(...r.visit(this))), s; }
    visitIcu(e, t) { let s = [new Q(`{${e.expressionPlaceholder}, ${e.type}, `)]; return Object.keys(e.cases).forEach(r => { s.push(new Q(`${r} {`), ...e.cases[r].visit(this), new Q("} ")); }), s.push(new Q("}")), s; }
    visitTagPlaceholder(e, t) { let s = jC(e.tag); if (e.isVoid)
    ...
    } return e.name === FC ? [].concat(...P(this, e.children)) : (this._addError(e, "Unexpected tag"), null); }
    visitExpansion(e, t) { let s = {}; return P(this, e.cases).forEach(r => { s[r.value] = new et(r.nodes, e.sourceSpan); }), new _n(e.switchValue, e.type, s, e.sourceSpan); }
...
function jC(n) { switch (n.toLowerCase()) {
    case "br": return "lb";
    case "img": return "image";
    default: return `x-${n}`;
} }
var zC = "2.0", GC = "urn:oasis:names:tc:xliff:document:2.0", XC = "en", jn = "ph", gc = "pc", YC = "mrk", ad = "xliff", od = "source", QC = "target", vc = "unit", wc = class extends Us {
    write(e, t) { let s = new Ec, r = []; e.forEach(o => { let l = new M(vc, { id: o.id }), c = new M("notes"); (o.description || o.meaning) && (o.description && c.children.push(new j(8), new M("note", { category: "description" }, [new Q(o.description)])), o.meaning && c.children.push(new j(8), new M("note", { category: "meaning" }, [new Q(o.meaning)]))), o.sources.forEach(p => { c.children.push(new j(8), new M("note", { category: "location" }, [new Q(`${p.filePath}:${p.startLine}${p.endLine !== p.startLine ? "," + p.endLine : ""}`)])); }), c.children.push(new j(6)), l.children.push(new j(6), c); let h = new M("segment"); h.children.push(new j(8), new M(od, {}, s.serialize(o.nodes)), new j(6)), l.children.push(new j(6), h, new j(4)), r.push(new j(4), l); }); let i = new M("file", { original: "ng.template", id: "ngi18n" }, [...r, new j(2)]), a = new M(ad, { version: zC, xmlns: GC, srcLang: t || XC }, [new j(2), i, new j]); return Lc([new Qr({ version: "1.0", encoding: "UTF-8" }), new j, a, new j]); }
    load(e, t) {
        let s = new Sc, { locale: r, msgIdToHtml: i, errors: a } = s.parse(e, t), o = {}, l = new ZC;
        if (Object.keys(i).forEach(c => { let { i18nNodes: h, errors: p } = l.convert(i[c], t); a.push(...p), o[c] = h; }), a.length)
...
`)}`);
    ...
    visitElement(e, t) { switch (e.name) {
        ...
        case gc:
            ...
            break;
        case YC: return [].concat(...P(this, e.children));
...
var Yh = "translationbundle", Qh = "translation", Zh = "ph", xc = class extends Us {
...
function KC(n, e, t) { Object.defineProperty(n, e, { configurable: !0, enumerable: !0, get: function () { let s = t(); return Object.defineProperty(n, e, { enumerable: !0, value: s }), s; }, set: s => { throw new Error("Could not overwrite an XTB translation"); } }); }
var yc = class {
    _bundleDepth;
    _errors;
    _msgIdToHtml;
    ...
    visitElement(e, t) { switch (e.name) {
        case Yh:
            this._bundleDepth++, this._bundleDepth > 1 && this._addError(e, `<${Yh}> elements can not be nested`);
        ...
        case Qh:
            ...
            if (!r)
                this._addError(e, `<${Qh}> misses the "id" attribute`);
            else {
                let i = r.value;
    ...
    visitExpansion(e, t) { let s = {}; return P(this, e.cases).forEach(r => { s[r.value] = new et(r.nodes, e.sourceSpan); }), new _n(e.switchValue, e.type, s, e.sourceSpan); }
    visitExpansionCase(e, t) { return { value: e.value, nodes: P(this, e.expression) }; }
    visitElement(e, t) { if (e.name === Zh) {
        let s = e.attrs.find(r => r.name === "name");
        if (s)
            return new pt("", s.value, e.sourceSpan);
        this._addError(e, `<${Zh}> misses the "name" attribute`);
    }
    else
...
`));
    ...
    constructor(e, t, s, r = Ns.Warning, i) { if (this._htmlParser = e, t) {
        ...
        this._translationBundle = new no({}, null, tp, void 0, r, i); }
    parse(e, t, s = {}) { let r = s.interpolationConfig || ot, i = this._htmlParser.parse(e, t, S({ interpolationConfig: r }, s)); return i.errors.length ? new Ys(i.rootNodes, i.errors) : bC(i.rootNodes, this._translationBundle, r, [], {}); }
};
function eA(n) { switch (n = (n || "xlf").toLowerCase(), n) {
...
var Kh = class {
    ...
    updateFromTemplate(e, t, s) { let r = this._htmlParser.parse(e, t, { tokenizeExpansionForms: !0, interpolationConfig: s }); if (r.errors.length)
        return r.errors; let i = this._preserveWhitespace ? r.rootNodes : wt(new di(!1), r.rootNodes), a = kC(i, s, this._implicitTags, this._implicitAttrs, this._preserveWhitespace); return a.errors.length ? a.errors : (this._messages.push(...a.messages), []); }
    ...
    visitIcuPlaceholder(e, t) { return new kn(e.value, t.toPublicName(e.name), e.sourceSpan); }
};
function tA(n) { let e = ld(n); return ie([], [Nr(e).toStmt()]).callFn([]); }
function ld(n) { return y(f.setClassMetadata).callFn([n.type, n.decorators, n.ctorParameters ?? d(null), n.propDecorators ?? d(null)]); }
function JA(n, e) { return e === null || e.length === 0 ? tA(n) : cd(n, e.map(t => new K(t.symbolName, He)), ud(e)); }
function KA(n, e, t) { return cd(n, t.map(s => new K(s, He)), e); }
function cd(n, e, t) { let s = ld(n), r = ie(e, [s.toStmt()]), i = y(f.setClassMetadataAsync).callFn([n.type, t, r]); return ie([], [Nr(i).toStmt()]).callFn([]); }
function ud(n) { let e = n.map(({ symbolName: t, importPath: s, isDefaultImport: r }) => { let i = ie([new K("m", He)], D("m").prop(r ? "default" : t)); return new es(s).prop("then").callFn([i]); }); return ie([], R(e)); }
var nA = "12.0.0", sA = "18.0.0";
function rA(n) { let e = new ae; return e.set("minVersion", d(nA)), e.set("version", d("20.3.18")), e.set("ngImport", y(f.core)), e.set("type", n.type), e.set("decorators", n.decorators), e.set("ctorParameters", n.ctorParameters), e.set("propDecorators", n.propDecorators), y(f.declareClassMetadata).callFn([e.toLiteralMap()]); }
function e_(n, e) { if (e === null || e.length === 0)
    return rA(n); let t = new ae, s = new ae; return s.set("decorators", n.decorators), s.set("ctorParameters", n.ctorParameters ?? d(null)), s.set("propDecorators", n.propDecorators ?? d(null)), t.set("minVersion", d(sA)), t.set("version", d("20.3.18")), t.set("ngImport", y(f.core)), t.set("type", n.type), t.set("resolveDeferredDeps", ud(e)), t.set("resolveMetadata", ie(e.map(r => new K(r.symbolName, He)), s.toLiteralMap())), y(f.declareClassMetadataAsync).callFn([t.toLiteralMap()]); }
function vr(n, e) { return n === null || n.length === 0 ? null : R(n.map(t => e(t))); }
function Mo(n, e) { let t = Object.keys(n).map(s => { let r = n[s]; return { key: s, value: e(r), quoted: !0 }; }); return t.length > 0 ? he(t) : null; }
function iA(n) { return n === "invalid" ? d("invalid") : n === null ? d(null) : R(n.map(hd)); }
...
function t_(n) { let e = pd(n), t = y(f.declareDirective).callFn([e.toLiteralMap()]), s = Qf(n); return { expression: t, type: s, statements: [] }; }
function pd(n) { let e = new ae, t = aA(n); return e.set("minVersion", d(t)), e.set("version", d("20.3.18")), e.set("type", n.type.value), n.isStandalone !== void 0 && e.set("isStandalone", d(n.isStandalone)), n.isSignal && e.set("isSignal", d(n.isSignal)), n.selector !== null && e.set("selector", d(n.selector)), e.set("inputs", fd(n) ? cA(n.inputs) : uA(n.inputs)), e.set("outputs", dl(n.outputs)), e.set("host", oA(n.host)), e.set("providers", n.providers), n.queries.length > 0 && e.set("queries", R(n.queries.map(ep))), n.viewQueries.length > 0 && e.set("viewQueries", R(n.viewQueries.map(ep))), n.exportAs !== null && e.set("exportAs", Me(n.exportAs)), n.usesInheritance && e.set("usesInheritance", d(!0)), n.lifecycle.usesOnChanges && e.set("usesOnChanges", d(!0)), n.hostDirectives?.length && e.set("hostDirectives", lA(n.hostDirectives)), e.set("ngImport", y(f.core)), e; }
function aA(n) { let e = "14.0.0"; return Object.values(n.inputs).some(s => s.transformFunction !== null) && (e = "16.1.0"), fd(n) && (e = "17.1.0"), (n.queries.some(s => s.isSignal) || n.viewQueries.some(s => s.isSignal)) && (e = "17.2.0"), e; }
function fd(n) { return Object.values(n.inputs).some(e => e.isSignal); }
function ep(n) { let e = new ae; return e.set("propertyName", d(n.propertyName)), n.first && e.set("first", d(!0)), e.set("predicate", Array.isArray(n.predicate) ? Me(n.predicate) : xs(n.predicate)), n.emitDistinctChangesOnly || e.set("emitDistinctChangesOnly", d(!1)), n.descendants && e.set("descendants", d(!0)), e.set("read", n.read), n.static && e.set("static", d(!0)), n.isSignal && e.set("isSignal", d(!0)), e.toLiteralMap(); }
...
function lA(n) { let e = n.map(t => { let s = [{ key: "directive", value: t.isForwardReference ? Dc(t.directive.type) : t.directive.type, quoted: !1 }], r = t.inputs ? Za(t.inputs) : null, i = t.outputs ? Za(t.outputs) : null; return r && s.push({ key: "inputs", value: r, quoted: !1 }), i && s.push({ key: "outputs", value: i, quoted: !1 }), he(s); }); return R(e); }
function cA(n) { let e = Object.getOwnPropertyNames(n); return e.length === 0 ? null : he(e.map(t => { let s = n[t]; return { key: t, quoted: Rc.test(t), value: he([{ key: "classPropertyName", quoted: !1, value: Me(s.classPropertyName) }, { key: "publicName", quoted: !1, value: Me(s.bindingPropertyName) }, { key: "isSignal", quoted: !1, value: Me(s.isSignal) }, { key: "isRequired", quoted: !1, value: Me(s.required) }, { key: "transformFunction", quoted: !1, value: s.transformFunction ?? xn }]) }; })); }
function uA(n) { let e = Object.getOwnPropertyNames(n); return e.length === 0 ? null : he(e.map(t => { let s = n[t], r = s.bindingPropertyName, i = r !== t, a; if (i || s.transformFunction !== null) {
    let o = [Me(r), Me(t)];
    s.transformFunction !== null && o.push(s.transformFunction), a = R(o);
}
else
    a = Me(r); return { key: t, quoted: Rc.test(t), value: a }; })); }
function n_(n, e, t) { let s = hA(n, e, t), r = y(f.declareComponent).callFn([s.toLiteralMap()]), i = Xf(n); return { expression: r, type: i, statements: [] }; }
function hA(n, e, t) { let s = pd(n), r = new kc; if (z(r, e.nodes), s.set("template", pA(e, t)), t.isInline && s.set("isInline", d(!0)), r.hasBlocks && s.set("minVersion", d("17.0.0")), s.set("styles", vr(n.styles, d)), s.set("dependencies", dA(n)), s.set("viewProviders", n.viewProviders), s.set("animations", n.animations), n.changeDetection !== null) {
    if (typeof n.changeDetection == "object")
        throw new Error("Impossible state! Change detection flag is not resolved!");
    s.set("changeDetection", y(f.ChangeDetectionStrategy).prop(Si[n.changeDetection]));
...
function pA(n, e) { if (e.inlineTemplateLiteralExpression !== null)
    return e.inlineTemplateLiteralExpression; if (e.isInline)
    return d(e.content, null, null); let t = e.content, s = new ti(t, e.sourceUrl), r = new os(s, 0, 0, 0), i = fA(s, t), a = new L(r, i); return d(t, null, a); }
function fA(n, e) {
...
function dA(n) { let e = n.declarationListEmitMode !== 0 ? Dc : t => t; if (n.declarationListEmitMode === 3)
    throw new Error("Unsupported emit mode"); return vr(n.declarations, t => { switch (t.kind) {
    case Kt.Directive:
        let s = new ae;
        return s.set("kind", d(t.isComponent ? "component" : "directive")), s.set("type", e(t.type)), s.set("selector", d(t.selector)), s.set("inputs", vr(t.inputs, d)), s.set("outputs", vr(t.outputs, d)), s.set("exportAs", vr(t.exportAs, d)), s.toLiteralMap();
    case Kt.Pipe:
        let r = new ae;
...
function s_(n) { let e = new ae; return e.set("minVersion", d(mA)), e.set("version", d("20.3.18")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), e.set("deps", iA(n.deps)), e.set("target", y(f.FactoryTarget).prop(Bt[n.target])), { expression: y(f.declareFactory).callFn([e.toLiteralMap()]), statements: [], type: vp(n) }; }
var gA = "12.0.0";
function r_(n) { let e = vA(n), t = y(f.declareInjectable).callFn([e.toLiteralMap()]), s = _p(n); return { expression: t, type: s, statements: [] }; }
function vA(n) { let e = new ae; if (e.set("minVersion", d(gA)), e.set("version", d("20.3.18")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), n.providedIn !== void 0) {
...
var wA = "12.0.0";
function i_(n) { let e = EA(n), t = y(f.declareInjector).callFn([e.toLiteralMap()]), s = Vp(n); return { expression: t, type: s, statements: [] }; }
function EA(n) { let e = new ae; return e.set("minVersion", d(wA)), e.set("version", d("20.3.18")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), e.set("providers", n.providers), n.imports.length > 0 && e.set("imports", R(n.imports)), e; }
var SA = "14.0.0";
function a_(n) { let e = xA(n), t = y(f.declareNgModule).callFn([e.toLiteralMap()]), s = qp(n); return { expression: t, type: s, statements: [] }; }
function xA(n) { let e = new ae; if (n.kind === Yt.Local)
    throw new Error("Invalid path! Local compilation mode should not get into the partial compilation path"); return e.set("minVersion", d(SA)), e.set("version", d("20.3.18")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), n.bootstrap.length > 0 && e.set("bootstrap", Ct(n.bootstrap, n.containsForwardDecls)), n.declarations.length > 0 && e.set("declarations", Ct(n.declarations, n.containsForwardDecls)), n.imports.length > 0 && e.set("imports", Ct(n.imports, n.containsForwardDecls)), n.exports.length > 0 && e.set("exports", Ct(n.exports, n.containsForwardDecls)), n.schemas !== null && n.schemas.length > 0 && e.set("schemas", R(n.schemas.map(t => t.value))), n.id !== null && e.set("id", n.id), e; }
var yA = "14.0.0";
function o_(n) { let e = CA(n), t = y(f.declarePipe).callFn([e.toLiteralMap()]), s = Up(n); return { expression: t, type: s, statements: [] }; }
function CA(n) { let e = new ae; return e.set("minVersion", d(yA)), e.set("version", d("20.3.18")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), n.isStandalone !== void 0 && e.set("isStandalone", d(n.isStandalone)), e.set("name", d(n.pipeName ?? n.name)), n.pure === !1 && e.set("pure", d(n.pure)), e; }
function l_(n) { let e = { className: n.className }; n.filePath && (e.filePath = n.filePath, e.lineNumber = n.lineNumber), n.forbidOrphanRendering && (e.forbidOrphanRendering = d(!0)); let t = y(f.setClassDebugInfo).callFn([n.type, La(e)]); return ie([], [Nr(t).toStmt()]).callFn([]); }
function c_(n) { let i = `${n.className}_HmrLoad`, a = n.namespaceDependencies.map(T => new tn({ moduleName: T.moduleName, name: null })), o = D("m").prop("default"), l = y(f.replaceMetadata).callFn([n.type, o, R(a), R(n.localDependencies.map(T => T.runtimeRepresentation)), D("import").prop("meta"), D("id")]), c = ie([new K("m")], o.and(l)), h = y(f.getReplaceMetadataURL).callFn([D("id"), D("t"), D("import").prop("meta").prop("url")]), p = new Cn(i, [new K("t")], [new es(h, null, "@vite-ignore").prop("then").callFn([c]).toStmt()], null, le.Final), g = ie([new K("d")], D("d").prop("id").identical(D("id")).and(D(i).callFn([D("d").prop("timestamp")]))), v = D(i).callFn([D("Date").prop("now").callFn([])]), E = D("import").prop("meta").prop("hot"), C = E.clone().prop("on").callFn([d("angular:component-update"), g]); return ie([], [new ce("id", d(encodeURIComponent(`${n.filePath}@${n.className}`)), null, le.Final), p, Nr(v).toStmt(), Nr(E.and(C)).toStmt()]).callFn([]); }
function u_(n, e, t) { let s = "\u0275\u0275namespaces", r = [t.className, s].map(a => new K(a, He)), i = []; for (let a of t.localDependencies)
    r.push(new K(a.name)); for (let a = 0; a < t.namespaceDependencies.length; a++)
    ...
    if (a.initializer !== null) {
        ...
        for (let o of a.statements)
            i.push(o);
    } return new Cn(`${t.className}_UpdateMetadata`, r, i, null, le.Final); }
var h_ = new zo("20.3.18");
export { se as AST, Dr as ASTWithName, Xe as ASTWithSource, Ze as AbsoluteSourceSpan, qo as ArrayType, Sn as ArrowFunctionExpr, wn as Attribute, Ne as Binary, x as BinaryOperator, W as BinaryOperatorExpr, ta as BindingPipe, qi as BindingPipeType, G as BindingType, at as Block, Ma as BlockParameter, oa as BoundElementProperty, _t as BuiltinType, jt as BuiltinTypeName, $o as CUSTOM_ELEMENTS_SCHEMA, Fs as Call, Rs as Chain, Si as ChangeDetectionStrategy, ac as CombinedRecursiveAstVisitor, jo as CommaExpr, Nn as Comment, Wh as CompilerConfig, uc as CompilerFacadeImpl, Ce as Component, ea as Conditional, bt as ConditionalExpr, Zi as ConstantPool, Jn as CssSelector, ot as DEFAULT_INTERPOLATION_CONFIG, He as DYNAMIC_TYPE, Cn as DeclareFunctionStmt, ce as DeclareVarStmt, Ba as Directive, Qs as DomElementSchemaRegistry, es as DynamicImportExpr, Ii as EOF, De as Element, Vl as ElementSchemaRegistry, Yo as EmitterVisitorContext, $e as EmptyExpr, vn as Expansion, hi as ExpansionCase, Y as Expression, Zo as ExpressionBinding, nt as ExpressionStatement, Je as ExpressionType, tn as ExternalExpr, Wo as ExternalReference, Bt as FactoryTarget, Zt as FunctionExpr, Ga as HtmlParser, q as HtmlTagDefinition, Jh as I18NHtmlParser, Ir as IfStmt, $t as ImplicitReceiver, Ls as InstantiateExpr, yi as Interpolation, ga as InterpolationConfig, Fe as InvokeFunctionExpr, Tr as JSDocComment, wl as JitEvaluator, rs as KeyedRead, br as LeadingComment, Ra as LetDeclaration, mi as Lexer, na as LiteralArray, dt as LiteralArrayExpr, Ee as LiteralExpr, sa as LiteralMap, Tt as LiteralMapExpr, Ge as LiteralPrimitive, kr as LocalizedString, Uo as MapType, Kh as MessageBundle, kt as NONE_TYPE, Oo as NO_ERRORS_SCHEMA, rn as NodeWithI18n, Fr as NonNullAssert, Ms as NotExpr, ft as ParenthesizedExpr, Vr as ParenthesizedExpression, N as ParseError, dn as ParseErrorLevel, os as ParseLocation, ti as ParseSourceFile, L as ParseSourceSpan, ns as ParseSpan, Ys as ParseTreeResult, aa as ParsedEvent, Be as ParsedEventType, ys as ParsedProperty, Lt as ParsedPropertyType, Jo as ParsedVariable, $a as Parser, Br as PrefixNot, Jt as PropertyRead, f as R3Identifiers, Yt as R3NgModuleMetadataKind, Sa as R3SelectorScopeMode, Ja as R3TargetBinder, Kt as R3TemplateDependencyKind, Ft as ReadKeyExpr, We as ReadPropExpr, tt as ReadVarExpr, Ur as RecursiveAstVisitor, Uu as RecursiveVisitor, cc as ResourceLoader, xe as ReturnStatement, qw as SCHEMA, eh as SECURITY_SCHEMA, io as STRING_TYPE, ra as SafeCall, Lr as SafeKeyedRead, Pr as SafePropertyRead, Fo as SelectorContext, Ro as SelectorListContext, Cr as SelectorMatcher, zi as SelectorlessMatcher, Us as Serializer, Rl as SplitInterpolation, yn as Statement, le as StmtModifier, Sr as StringToken, Yn as StringTokenKind, Mt as TagContentType, $r as TaggedTemplateLiteral, Ps as TaggedTemplateLiteralExpr, Fl as TemplateBindingParseResult, Or as TemplateLiteral, ia as TemplateLiteralElement, _r as TemplateLiteralElementExpr, Bs as TemplateLiteralExpr, an as Text, ss as ThisReceiver, mt as TmplAstBlockNode, tl as TmplAstBoundAttribute, la as TmplAstBoundDeferredTrigger, nl as TmplAstBoundEvent, $s as TmplAstBoundText, wr as TmplAstComponent, qs as TmplAstContent, is as TmplAstDeferredBlock, jr as TmplAstDeferredBlockError, Wr as TmplAstDeferredBlockLoading, Hr as TmplAstDeferredBlockPlaceholder, Vt as TmplAstDeferredTrigger, wp as TmplAstDirective, Ot as TmplAstElement, Vs as TmplAstForLoopBlock, Gr as TmplAstForLoopBlockEmpty, Yr as TmplAstHostElement, ca as TmplAstHoverDeferredTrigger, Ep as TmplAstIcu, rl as TmplAstIdleDeferredTrigger, fa as TmplAstIfBlock, Gn as TmplAstIfBlockBranch, il as TmplAstImmediateDeferredTrigger, ua as TmplAstInteractionDeferredTrigger, Pc as TmplAstLetDeclaration, sl as TmplAstNeverDeferredTrigger, pm as TmplAstRecursiveVisitor, Xr as TmplAstReference, pa as TmplAstSwitchBlock, zr as TmplAstSwitchBlockCase, Ke as TmplAstTemplate, Un as TmplAstText, Os as TmplAstTextAttribute, al as TmplAstTimerDeferredTrigger, da as TmplAstUnknownBlock, An as TmplAstVariable, ha as TmplAstViewportDeferredTrigger, Nt as Token, O as TokenType, Yi as TransplantedType, pe as TreeError, En as Type, Ic as TypeModifier, Kn as TypeofExpr, Mr as TypeofExpression, bs as Unary, Ds as UnaryOperator, nn as UnaryOperatorExpr, h_ as VERSION, qr as VariableBinding, zo as Version, xt as ViewEncapsulation, Ar as VoidExpr, Rr as VoidExpression, H as WrappedNodeExpr, dc as Xliff, wc as Xliff2, hl as Xmb, Dn as XmlParser, xc as Xtb, xf as _ATTR_TO_PROP, l_ as compileClassDebugInfo, tA as compileClassMetadata, JA as compileComponentClassMetadata, e_ as compileComponentDeclareClassMetadata, Gy as compileComponentFromMetadata, rA as compileDeclareClassMetadata, n_ as compileDeclareComponentFromMetadata, t_ as compileDeclareDirectiveFromMetadata, s_ as compileDeclareFactoryFunction, r_ as compileDeclareInjectableFromMetadata, i_ as compileDeclareInjectorFromMetadata, a_ as compileDeclareNgModuleFromMetadata, o_ as compileDeclarePipeFromMetadata, zA as compileDeferResolverFunction, zy as compileDirectiveFromMetadata, $n as compileFactoryFunction, c_ as compileHmrInitializer, u_ as compileHmrUpdateCallback, mu as compileInjectable, Au as compileInjector, Wm as compileNgModule, KA as compileOpaqueAsyncClassMetadata, _u as compilePipeFromMetadata, rp as computeMsgId, AA as core, Am as createCssSelectorFromNode, _p as createInjectableType, Nc as createMayBeForwardRefExpression, Nr as devOnlyGuardedExpression, md as emitDistinctChangesOnlyDefaultValue, jA as encapsulateStyle, bA as escapeRegExp, GA as findMatchingDirectivesAndPipes, ql as getHtmlTagDefinition, el as getNsPrefix, rm as getSafePropertyAccessString, Vm as identifierName, fu as isNgContainer, Ko as isNgContent, hm as isNgTemplate, cp as jsDocComment, Bd as leadingComment, d as literal, he as literalMap, Ya as makeBindingParser, Ui as mergeNsAndName, kA as outputAst, Ky as parseHostBindings, jf as parseTemplate, yC as preserveWhitespacesDefault, XA as publishFacade, $m as r3JitTypeSourceSpan, On as sanitizeIdentifier, WA as setEnableTemplateSourceLocations, It as splitNsName, z as tmplAstVisitAll, eC as verifyHostBindings, P as visitAll };
